                 ...
                 const RpToonPaint *paint )
{
    ...
    */
    ...
    if (!VideoCardSupportsMultitexture && multiTexture != NULL)
    {
        ...
        RwD3D9GetRenderState(D3DRS_ZWRITEENABLE, &zWriteEnable);
        ...
        _rwD3D9RenderStateDestBlend(dstBlend);
                   ...
                   const RpToonPaint *paint )
{
    ...
    psConstants[0].x = D3D9CameraSpaceLightmatrix._11;
    psConstants[0].y = D3D9CameraSpaceLightmatrix._21;
    psConstants[0].z = D3D9CameraSpaceLightmatrix._31;
         ...
         mesh->material->texture != NULL )
    {
        ...
        {
            psConstants[1].x = (RwReal)(color->red) * COLORSCALAR;
            psConstants[1].y = (RwReal)(color->green) * COLORSCALAR;
            psConstants[1].z = (RwReal)(color->blue) * COLORSCALAR;
            psConstants[1].w = (RwReal)(color->alpha) * COLORSCALAR;

            RwD3D9SetPixelShader(D3D9ToonPixelShader);
            RwD3D9SetPixelShaderConstant(0, psConstants, 2);
        }
        else
        {
            RwD3D9SetPixelShader(D3D9ToonPixelShaderNoColor);
            RwD3D9SetPixelShaderConstant(0, psConstants, 1);
        }
    }
    else
    {
...
_rpToonPipelinesCreate(void)
{
    ...
    {
        RwDebugSendMessage(rwDEBUGMESSAGE, "Toon plugin", "Device supports vertex shaders version 1_1 and using them.")
