...
#if !defined(_XTP_EXCLUDE_MARKUP)
#include "Markup/Includes.h"          // _XTP_INCLUDE_MARKUP
#endif
...
#include "Chart/Includes.h"           // _XTP_INCLUDE_CHART
#endif

#if !defined(_XTP_EXCLUDE_FLOWGRAPH)
#include "FlowGraph/Includes.h"       // _XTP_INCLUDE_FLOWGRAPH
#endif
