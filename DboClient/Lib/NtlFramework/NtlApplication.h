...
const TCHAR kMainWindowName[]      = _T("Dragon Ball Online Universe Revelations");
...
protected:
	...
	RwInt32			m_iScreenWidth;		// 실제 스크린 넓이
	RwInt32			m_iScreenHeight;	// 실제 스크린 높이
	RwInt32			m_iUserWidth;		// 유저가 선택한 넓이
	RwInt32			m_iUserHeight;		// 유저가 선택한 높이
