...
void CNtlFSMVehicleActAgent::ServerConditionUpdateAnalysis( RwUInt8 byServerState, DWORD uiCondition )
{
	CNtlFSMCharActAgent::ServerConditionUpdateAnalysis( byServerState, uiCondition );
}
