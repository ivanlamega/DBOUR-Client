...
RwBool CNtlSLEventHandler::Create(void)
{
    ...
    RegisterMsg (g_EventActionMapScouterUse, "g_EventActionScouteruse", "");
	...
	RegisterMsg (g_EventSobAttacked, "g_EventSobAttack", "SNtlEventSobAttacked");
	...
	RegisterMsg (g_EventSobBuffRefreshAll, "g_EventSobBuffRefreshAll", "SNtlEventSobBuffRefreshAll");
	...
	RegisterMsg (g_EventPartyCharmActivity, "g_EventPartyCharmActivity", "SNtlEventPartyCharmActivity");
	...
	RegisterMsg(g_EventPrivateShopBusinessRequestRes, "g_EventPrivateShopBusinessRequestRes", "SNtlEventPrivateShopBusinessRequestRes");
	RegisterMsg(g_EventPrivateShopBusinessRequestNfy, "g_EventPrivateShopBusinessRequestNfy", "SNtlEventPrivateShopBusinessRequestNfy");
	RegisterMsg(g_EventPrivateShopBusinessConsentReq, "g_EventPrivateShopBusinessConsentReq", "SNtlEventPrivateShopBusinessConsentReq");
	RegisterMsg(g_EventPrivateShopBusinessConsentNfy, "g_EventPrivateShopBusinessConsentNfy", "SNtlEventPrivateShopBusinessConsentNfy");
	RegisterMsg(g_EventPrivateShopBusinessWaittimeOutNfy, "g_EventPrivateShopBusinessWaittimeOutNfy", "SNtlEventPrivateShopBusinessWaittimeOutNfy");
	RegisterMsg(g_EventPrivateShopBusinessPricefluctuationsRes, "g_EventPrivateShopBusinessPricefluctuationsRes", "SNtlEventPrivateShopBusinessPricefluctuationsRes");
	RegisterMsg(g_EventPrivateShopBusinessPricefluctuationsNfy, "g_EventPrivateShopBusinessPricefluctuationsNfy", "SNtlEventPrivateShopBusinessPricefluctuationsNfy");
	RegisterMsg(g_EventPrivateShopBusinessImmediateItemBuyingRes, "g_EventPrivateShopBusinessImmediateItemBuyingRes", "SNtlEventPrivateShopBusinessImmediateItemBuyingRes");
	RegisterMsg(g_EventPrivateShopBusinessImmediateItemBuyingNfy, "g_EventPrivateShopBusinessImmediateItemBuyingNfy", "SNtlEventPrivateShopBusinessImmediateItemBuyingNfy");
	RegisterMsg(g_EventPrivateShopBusinessCancleRes, "g_EventPrivateShopBusinessCancleRes", "SNtlEventPrivateShopBusinessCancleRes");
	RegisterMsg(g_EventPrivateShopBusinessCancleNfy, "g_EventPrivateShopBusinessCancleNfy", "SNtlEventPrivateShopBusinessCancleNfy");

	RegisterMsg(g_EventChatMessagePrivateShopBusiness, "g_EventChatMessagePrivateShopBusiness", "SNtlEventChatMessagePrivateShopBusiness");
	
	// TMQ
	RegisterMsg (g_EventTMQBoard, "g_EventTMQBoard", "SNtlEventTMQBoard");
	RegisterMsg (g_EventTMQBoardNotify, "g_EventTMQBoardNotify", "SNtlEventTMQBoardNotify");
	...
	RegisterMsg (g_EventSobTargetInfoUpdate, "g_EventSobTargetInfoUpdateStr", "SNtlEventSobTargetInfoUpdate");
	...
	RegisterMsg (g_EventTrigObjScouterDir_CreateSTObj, "g_EventTrigObjScouterDir_CreateSTObjStr", "SNtlEventTrigObjScouterDir_CreateSTObj");
	RegisterMsg (g_EventTrigObjScouterDir_DeleteSTObj, "g_EventTrigObjScouterDir_DeleteSTObjStr", "SNtlEventTrigObjScouterDir_DeleteSTObj");
	...
	RegisterMsg(g_EventTSOpenBattleStart, "g_EventTSOpenBattleStart", "SNtlEventTSOpenBattleStart");
	RegisterMsg(g_EventTSOpenBattleEnd, "g_EventTSOpenBattleEnd", "SNtlEventTSOpenBattleEnd");
    ...
    // Portal System
    RegisterMsg(g_EventPortalStartRes, "g_EventPortalStartRes", "SNtlEventPortalStartRes");
	...
	// Hoipoi Machine
	RegisterMsg(g_EventHoipoiMixItemMachineDel, "g_EventHoipoiMixItemMachineDel", "");
	...
	RegisterMsg(g_EventHoipoiMixJobSetRes, "g_EventHoipoiMixJobSetRes", "SNtlEventHoipoiMixJobSetRes" );
	RegisterMsg(g_EventHoipoiMixJobResetRes, "g_EventHoipoiMixJobResetRes", "SNtlEventHoipoiMixJobResetRes" );
	...
	RegisterMsg(g_EventMyNameplateChanged, "g_EventMyNameplateChanged", "SNtlEventMyNameplateMode");
	RegisterMsg(g_EventOtherNameplateChanged, "g_EventOtherNameplateChanged", "SNtlEventOtherNameplateMode");
...
void CNtlSLEventHandler::Destroy(void)
{
    ...
    UnRegisterMsg (g_EventActionMapScouterUse);
	...
	UnRegisterMsg (g_EventPartyCharmActivity);
	...
	// PrivateShop Business
	UnRegisterMsg(g_EventPrivateShopBusinessRequestRes);
	UnRegisterMsg(g_EventPrivateShopBusinessRequestNfy);
	UnRegisterMsg(g_EventPrivateShopBusinessConsentReq);
	UnRegisterMsg(g_EventPrivateShopBusinessConsentNfy);
	UnRegisterMsg(g_EventPrivateShopBusinessWaittimeOutNfy);
	UnRegisterMsg(g_EventPrivateShopBusinessPricefluctuationsRes);
	UnRegisterMsg(g_EventPrivateShopBusinessPricefluctuationsNfy);
	UnRegisterMsg(g_EventPrivateShopBusinessImmediateItemBuyingRes);
	UnRegisterMsg(g_EventPrivateShopBusinessImmediateItemBuyingNfy);
	UnRegisterMsg(g_EventPrivateShopBusinessCancleRes);
	UnRegisterMsg(g_EventPrivateShopBusinessCancleNfy);

	UnRegisterMsg(g_EventChatMessagePrivateShopBusiness);

	UnRegisterMsg (g_EventTMQBoard);
	UnRegisterMsg (g_EventTMQBoardNotify);
	...
	// trigger => client event
	UnRegisterMsg (g_EventTrigObjScouterDir_CreateSTObj);
	UnRegisterMsg (g_EventTrigObjScouterDir_DeleteSTObj);
	...
	UnRegisterMsg(g_EventTSOpenBattleStart);
	UnRegisterMsg(g_EventTSOpenBattleEnd);
    ...
    // Portal 
    UnRegisterMsg(g_EventPortalStartRes);
	...
	// HoipoiMix Machine
	UnRegisterMsg(g_EventHoipoiMixItemMachineDel);
	...
	UnRegisterMsg(g_EventHoipoiMixJobSetRes);
	UnRegisterMsg(g_EventHoipoiMixJobResetRes);
	...
	UnRegisterMsg(g_EventMyNameplateChanged);
	UnRegisterMsg(g_EventOtherNameplateChanged);
