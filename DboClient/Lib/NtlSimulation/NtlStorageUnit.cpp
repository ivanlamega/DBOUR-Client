...
bool CNtlStorageUnit::Create( eNTL_STORAGE_TYPE eType )
{
	...
	case eNTL_STORAGE_ACCOUNT:
		INSERT_DEFAULT_VALUE(m_mapStorageData,dSTORAGE_ACCOUNT_CONTRACT);
		break;
	...
	case eNTL_STORAGE_GAMEINFO:
		...
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_GAMEINFO_MY_NAMEPLATE);
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_GAMEINFO_OTHER_NAMEPLATE);
		break;
...
bool CNtlStorageUnit::Reset()
{
	...
	{
	case eNTL_STORAGE_ACCOUNT:
		CHANGE_RESET_VALUE(dSTORAGE_ACCOUNT_CONTRACT);
		return true;
	case eNTL_STORAGE_GRAPHIC:
	...
	case eNTL_STORAGE_GAMEINFO:
		...
		CHANGE_RESET_VALUE(dSTORAGE_GAMEINFO_MY_NAMEPLATE);
		CHANGE_RESET_VALUE(dSTORAGE_GAMEINFO_OTHER_NAMEPLATE);
		return true;
	case eNTL_STORAGE_ETC:
