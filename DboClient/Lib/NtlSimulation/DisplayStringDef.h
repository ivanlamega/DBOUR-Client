...
enum EDispStingType
{
	...
	DST_SCOUTER_SUCCESS_FIND_HIDDEN_OBJECT,		// 숨겨진 물체를 %d개 찾았습니다(스카우터로 숨겨진 물체 찾기 기능을 ㎱?때)
	DST_SCOUTER_NOT_EXIST_HIDDEN_OBJECT,		// 근처에 숨겨진 물체가 없습니다(스카우터로 숨겨진 물체 찾기 기능을 ㎱?때)
	...
	DST_ITEM_CAN_NOT_USE_NO_DOJO_SCRAMBLE_SEAL,		// ÀÎÀå Á¦¾î±â´Â µµÀå ÀïÅ»Àü ÁøÇàÁß ÀÎÀå¿¡¸¸ »ç¿ëÇÒ ¼ö ÀÖ½À´Ï´Ù(ÀÎÀå Á¦¾î±â¸¦ ÀÎÀåÀÌ ¾Æ´Ñ °Í¿¡ ¾²·Á°í ÇÒ ¶§)
	...
	DST_DOJO_SUCCESS_ESTABLISHMENT,			// %s의 도장을 설립하였습니다(유파원에게 도장이 설립瑛습?알린다)
	...
	// 심의등급 표시
	DST_DELIBERATION_RANK_MESSAGE_1,			// 국가별 심의등급 표시 문구
	DST_DELIBERATION_RANK_MESSAGE_2,				// °ÔÀÓÀ» 2½Ã°£ ÀÌ¿ëÇß½À´Ï´Ù. Áö³ªÄ£ °ÔÀÓ ÇÃ·¹ÀÌ´Â °Ç°­À» ÇØÄ¥ ¼ö ÀÖ½À´Ï´Ù.
	DST_DELIBERATION_RANK_MESSAGE_3,				// °ÔÀÓÀ» 3½Ã°£ ÀÌ¿ëÇß½À´Ï´Ù. °Ç°­À» À§ÇØ¼­ Àá½Ã ½¬¾ú´Ù ÇÏ¼¼¿ä
	DST_DELIBERATION_RANK_MESSAGE_4,				// °ÔÀÓÀ» 4½Ã°£ ÀÌ¿ëÇß½À´Ï´Ù. Áö³ªÄ£ °ÔÀÓ ÇÃ·¹ÀÌ´Â °Ç°­À» ÇØÄ¥ ¼ö ÀÖ½À´Ï´Ù.
	DST_DELIBERATION_RANK_MESSAGE_5,				// °ÔÀÓÀ» 5½Ã°£ ÀÌ¿ëÇß½À´Ï´Ù. Áö³ªÄ£ °ÔÀÓ ÇÃ·¹ÀÌ´Â °Ç°­À» ÇØÄ¥ ¼ö ÀÖ½À´Ï´Ù.
	DST_DELIBERATION_RANK_MESSAGE_WARING_1,			// Àå½Ã°£ »ç¿ëÀº ÇÇºÎ¹Ì¿ë¿¡ ÇØ·Ó½À´Ï´Ù

	// 퀵슬롯
	DST_QUICKSLOT_IS_LOCK,					// 퀵슬롯이 잠김상태입니다. 

	// Ã¤ÆÃ
	DST_CHAT_CAN_SEND_WHISPER_TO_ME,			// ÀÚ±â ÀÚ½Å¿¡°Ô ±Ó¼Ó¸»À» º¸³¾ ¼ö ¾ø½À´Ï´Ù(ÀÚ±â ÀÚ½Å¿¡°Ô ±Ó¼Ó¸»À» ÇÏ·Á ÇÒ ¶§)
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Stats Page
	DST_STATUS_STATS_LPREGEN,
	DST_STATUS_STATS_LPREGENSIT,
	DST_STATUS_STATS_LPREGENBAT,
	DST_STATUS_STATS_EPREGEN,
	DST_STATUS_STATS_EPREGENSIT,
	DST_STATUS_STATS_EPREGENBAT,
	DST_STATUS_STATS_RPREGEN,
	DST_STATUS_STATS_RPDEGEN,
	DST_STATUS_STATS_PHYSCRIT,
	DST_STATUS_STATS_PHYSOFF,
	DST_STATUS_STATS_PHYSDEF,
	DST_STATUS_STATS_ENGCRIT,
	DST_STATUS_STATS_ENGOFF,
	DST_STATUS_STATS_ENGDEF,
	DST_STATUS_STATS_HITRATE,
	DST_STATUS_STATS_DODGERATE,
	DST_STATUS_STATS_BLOCKRATE,
	DST_STATUS_STATS_RUNSPEED,
	DST_STATUS_STATS_CURSESUCCESS,
	DST_STATUS_STATS_CURSETOLERANCE,
	DST_STATUS_STATS_CTCHANGEPERCENT,
	DST_STATUS_STATS_COOLCHANGEPERCENT,
	DST_STATUS_STATS_KEEPPERCENT,
	DST_STATUS_STATS_DOTPERCENT,
	DST_STATUS_STATS_DOTABSOLUTE,
	DST_STATUS_STATS_REQEPPERCENT,
	DST_STATUS_STATS_HONOROFF,
	DST_STATUS_STATS_HONORDEF,
	DST_STATUS_STATS_STRANGEOFF,
	DST_STATUS_STATS_STRANGEDEF,
	DST_STATUS_STATS_WILDOFF,
	DST_STATUS_STATS_WILDDEF,
	DST_STATUS_STATS_ELENGANCEOFF,
	DST_STATUS_STATS_ELEGANCEDEF,
	DST_STATUS_STATS_FUNNYOFF,
	DST_STATUS_STATS_FUNNYDEF,
	DST_STATUS_STATS_PARATOLERANCE,
	DST_STATUS_STATS_TERRORTOLERANCE,
	DST_STATUS_STATS_CONFUSETOLERANCE,
	DST_STATUS_STATS_STONETOLERANCE,
	DST_STATUS_STATS_CANDYTOLERANCE,
	DST_STATUS_STATS_PARAKEEPDOWN,
	DST_STATUS_STATS_TERRORKEEPDOWN,
	DST_STATUS_STATS_CONFUSEKEEPDOWN,
	DST_STATUS_STATS_STONEKEEPDOWN,
	DST_STATUS_STATS_CANDYKEEPDOWN,
	DST_STATUS_STATS_BLEEDKEEPDOWN,
	DST_STATUS_STATS_POISONKEEPDOWN,
	DST_STATUS_STATS_STOMACHEKEEPDOWN,
	DST_STATUS_STATS_CRITBLOCKRATE,
	DST_STATUS_STATS_GUARDRATE,
	DST_STATUS_STATS_SKILLDAMBLOCK,
	DST_STATUS_STATS_CURSEBLOCKRATE,
	DST_STATUS_STATS_KNOCKBACKBLOCKRATE,
	DST_STATUS_STATS_HTBBLOCKRATE,
	DST_STATUS_STATS_SITLPBONUS,
	DST_STATUS_STATS_SITEPBONUS,
	DST_STATUS_STATS_PHYSCRITBONUS,
	DST_STATUS_STATS_ENERGYCRITBONUS,
	DST_STATUS_STATS_ITEMUPBONUS,
	DST_STATUS_STATS_ITEMBREAKBONUS,
	//End Page
	...
	DST_EQUIP_SLOT_TYPE_QUEST,			// 도복
	DST_EQUIP_SLOT_TYPE_NECKLACE,		// 목걸이
	DST_EQUIP_SLOT_TYPE_EARRING,		// 귀걸이
	DST_EQUIP_SLOT_TYPE_RING,			// 반지	
	DST_EQUIP_SLOT_TYPE_HAIR,			// Hair
	DST_EQUIP_SLOT_TYPE_ACCESSORY_1,	// Mask
	DST_EQUIP_SLOT_TYPE_ACCESSORY_2,	// Richness
	DST_EQUIP_SLOT_TYPE_ACCESSORY_3,	// Backpack
	...
	// Lobby
	DST_LOBBY_CHARACTER_LIST,				// Character List Title
	DST_LOBBY_CHARACTER_MAKE,				// 캐릭터 만들기
	DST_LOBBY_CHARACTER_CUSTOMISATION,		// Character Customisation (Creation)
	...
	DST_LOBBY_CHARACTER_INFO,				// Character Information Window title
	...
	DST_LOBBY_CHAR_LEVEL2,					// Character Level under the name (right windows, char select)
	...
	DST_STATUS_DETAIL_STATS								// Detail Status Gui
