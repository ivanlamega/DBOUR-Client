...
// Key ID Defines
// Rule : KEY ID는 순서대로 증가하거나 마지막으로 Define된 ID보다 큰 값을 사용한다.
// 절대 중간에 삽입 삭제를 하지 않고 추가하지 않는다. 안 쓰게 된 DEFINE은 그냥 주석으로 안 쓴다고 달아둔다.
//----------------------------------------------------------------------------------------
...
#define dSTORAGE_ACCOUNT_CONTRACT				1001		// 약관의 정보
...
#define dSTORAGE_GAMEINFO_MY_NAMEPLATE			5003	// 스카우터 표시
#define dSTORAGE_GAMEINFO_OTHER_NAMEPLATE		5004	// 스카우터 표시
