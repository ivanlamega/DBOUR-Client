...
#define NTL_VID_DECAL_SKILL_RANGE_DMG       "GME_ATTACK_RANGE"  ///< 범위 스킬의 범위를 표시하는 데칼 (반지름이 1)
#define NTL_VID_DECAL_SKILL_RANGE_HEAL      "GME_HEAL_RANGE"  ///< 범위 스킬의 범위를 표시하는 데칼 (반지름이 1)
...
#define NTL_VID_GUARD_SUCCESS				"GME_Guard_Success"

#define NTL_VID_BLOCKING_DEFENCE			"TXT_Guard_Normal"
...
// Super Saiyan Blue Effect
#define NTL_VID_SUPER_SAIYAN_BLUE_SMALL          "HUM_Super_Saiyan_Blue"
#define NTL_VID_SUPER_SAIYAN_BLUE_BIG            "HUM_Super_Saiyan_Blue_02"
...
//Common powerup aura
#define DBONU_VID_AURA_COMMON				"GME_AURA_COMMON"
