...
#define NTL_FSMSID_FAINTING			40
#define NTL_FSMSID_DIE				41
...
#define NTL_FSMSID_SCOUTER          47                          ///< 스카우터 사용 상태
#define NTL_FSMSID_ONBUS            48                          ///< 버스 탑승 상태
#define NTL_FSMSID_ONVEHICLE        49                          ///< 탈것 탑승 상태
#define NTL_FSMSID_TURNING          50                          ///< 버스가 회전하는 상태
#define NTL_FSMSID_SEQUELA          51                          ///< 초사이야인 변신 휴유증 상태
#define NTL_FSMSID_SPIN_ATTACK      52                          ///< 회전 공격중인 상태
#define NTL_FSMSID_PUSHING          53                          ///< 회전 공격을 당해서 Pushing 상태
#define NTL_FSMSID_RIDEONOFF        54                          ///< 탈것에 타거나 내리는 상태
#define NTL_FSMSID_KEEPING_EFFECT   55                          ///< 스킬 Action Loop 상태
#define NTL_FSMID_AIR_MOVE			56
...
#define NTL_FSMSN_SCOUTER           "State_Scouter"
...
#define NTL_FSMSF_NOT_MOVE				0x00000001	// 마우스 이동 불가능.
#define NTL_FSMSF_NOT_ATTACK_STATE		0x00000002	// 공격 상태 전환 불가능.
#define NTL_FSMSF_NOT_HURT_STATE		0x00000004	// hurt 상태 전환 불가능.
#define NTL_FSMSF_NOT_JUMP				0x00000008	// 점프 불가능.
#define NTL_FSMSF_NOT_SKILLUSE			0x00000010	// skill 사용 불가능.
#define NTL_FSMSF_NOT_SOCIALUSE			0x00000020	// social action 사용 불가능.			
#define NTL_FSMSF_NOT_SIT				0x00000040	// sit/stand를 사용할 수 없다.
#define NTL_FSMSF_NOT_CAHNGE_HEADING	0x00000080	// heading을 change 할 수 없다.
#define NTL_FSMSF_NOT_ADJUSTMOVE		0x00000100	// 이동 보정 불가능...
#define NTL_FSMSF_NOT_STATECHANGE		0x00000200	// 상태를 전이할 수 없다.
#define NTL_FSMSF_NOT_ATTACK_CAN		0x00000400	// 공격할 수 없다.
#define NTL_FSMSF_NOT_HURT_CAN			0x00000800	// 피격 받을 수 없다.
#define NTL_FSMSF_NOT_RUNJUMP			0x00001000	// run jump 할 수 없다.
#define NTL_FSMSF_NOT_INPUT				0x00002000	// input에 관련된 event를 처리할 수 없다.
#define NTL_FSMSF_NOT_GROUNDMOVE		0x00004000	// world 높이를 따라서 이동하지 않는다.
