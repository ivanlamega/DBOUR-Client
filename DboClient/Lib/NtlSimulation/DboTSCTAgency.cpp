...
SGET_QUEST_INFO* CDboTSCTAgency::GetQuestInfoList( eEVENT_GEN_TYPE eEvtGenType, RwUInt32 uiOwnerId, void* pParameter /*= NULL*/ )
{
	...
	case eEVENT_GEN_TYPE_CLICK_OBJECT:
		{
			...
			if ( pObjTable )
			{
				...
				if ( pTblData )
				{
					m_TriggerInfo.dwType = pTblData->wFunction;
				}
			}
		}
		break;
	...
	for ( ; itCPT != m_defCurTList.end(); ++itCPT )
	{
		...
		else if ( eEVENT_GEN_TYPE_ITEMIDENTITY == eEvtGenType )	bCan = pTCtrl->CanProgressFreeBattle();
...
{
	OUT_QMSG_6( "[Trigger] User -> GameServer : Confirm in progress [%u,%u,%u,%u,%u,%u]", tId, tcCurId, tcNextId, uiParam, byEventType, uiEventData );
...
{
	OUT_QMSG_3( "[Trigger] GameServer -> User : Confirm in progress [%u,%u,%u]", tId, tcCurId, tcNextId );
...
{
	OUT_QMSG_4( "[Trigger] GameServer -> User : Update TS state message in progress [%u, %u, %u, %u]", tId, byType, wTSState, uiParam );
...
{
	OUT_QMSG_4( "[Trigger] User -> GameServer : Update TS state message in progress [%u, %u, %u, %u]", tId, byType, wTSState, uiParam );
...
{
	OUT_QMSG_1( "[Trigger] GameServer -> User : Update TS Event in progress [%u]", eID );
...
{
	OUT_QMSG_3( "[Trigger] User -> Trigger : Do trigger message in progress [%u, %u, %u]", sQuestInfo.sKey.tID, eEvtGenType, uiOwnerId );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show proposal dialog message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_2( "[Trigger] User -> Trigger : Show proposal dialog message in progress [%u, %u]", sKey.tID, bAccept );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show reward dialog message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_3( "[Trigger] User -> Trigger : Show reward dialog message in progress [%u, %u, %u]", sKey.tID, nSelIdx, bCancel );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show user selection dialog message in progress [%u]", sKey.tID );
	...
	default:
		{
			CNtlTSLog::Log( "Trigger user select window type mismatch. Info[%u,%u]. [%s]", sKey.tID, sKey.tcID, TS_CODE_TRACE() );
...
{
	OUT_QMSG_3( "[Trigger] User -> Trigger : Show user selection dialog message in progress [%u, %u, %u]", sKey.tID, tcSelId, bCancel );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show narration dialog message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_2( "[Trigger] User -> Trigger : Show narration dialog message in progress [%u, %u]", sKey.tID, bCancel );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show unified narration dialog message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_2( "[Trigger] User -> Trigger : Show unified narration dialog message in progress [%u, %u]", sKey.tID, bCancel );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show npc conversation message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Show npc conversation message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Camera message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Camera message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show object conversation message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Show object conversation message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Hint message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Hint message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Open Window message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Open Window message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : PC conversation message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Teleport Mudosa message in progress [%u]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Teleport Mudosa message in progress [%u]", sKey.tID );
