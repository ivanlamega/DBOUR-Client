...
RWS::CEventId g_EventActionMapScouterUse;           // 스카우터 사용
...
//////////////////////////////////////////////////////////////////////////
RWS::CEventId g_EventHoipoiMixItemMachineDel;		///< 믹스 머신 삭제
...
RWS::CEventId g_EventHoipoiMixJobSetRes;			///< 잡 셋팅 ( 호이포이 믹스 )
RWS::CEventId g_EventHoipoiMixJobResetRes;			///< 잡 리셋 ( 호이포이 믹스 )
...
RWS::CEventId g_EventPartyCharmActivity;
...
// WhoList Event
//_____________________________
RWS::CEventId g_EventWhoInfo;
RWS::CEventId g_EventWhoInfoChange;
RWS::CEventId g_EventWhoInfoNotify;           ///< UI를 업데이트 하기 위한 이벤트 (데이터->UI)
...
// 흥정
RWS::CEventId g_EventPrivateShopBusinessRequestRes;				// 흥청 요청 결과
RWS::CEventId g_EventPrivateShopBusinessRequestNfy;				  
RWS::CEventId g_EventPrivateShopBusinessConsentReq;				// 흥정 수락 여부
RWS::CEventId g_EventPrivateShopBusinessConsentNfy;
RWS::CEventId g_EventPrivateShopBusinessWaittimeOutNfy;			// 흥정 대기 타임 아웃
RWS::CEventId g_EventPrivateShopBusinessPricefluctuationsRes;	// 흥정 가격 변동
RWS::CEventId g_EventPrivateShopBusinessPricefluctuationsNfy;
RWS::CEventId g_EventPrivateShopBusinessImmediateItemBuyingRes;	// 즉시 구매
RWS::CEventId g_EventPrivateShopBusinessImmediateItemBuyingNfy;
RWS::CEventId g_EventPrivateShopBusinessCancleRes;				// 흥정 취소
RWS::CEventId g_EventPrivateShopBusinessCancleNfy;
RWS::CEventId g_EventChatMessagePrivateShopBusiness;			// 흥정 채팅

//-----------------------------
// TMQ
//_____________________________

RWS::CEventId g_EventTMQBoard;
RWS::CEventId g_EventTMQBoardNotify;
...
RWS::CEventId g_EventTrigObjScouterDir_CreateSTObj;			// 스카우터 트리거 오브젝트 생성
RWS::CEventId g_EventTrigObjScouterDir_DeleteSTObj;			// 스카우터 트리거 오브젝트 제거
...
RWS::CEventId g_EventTSOpenBattleStart;
RWS::CEventId g_EventTSOpenBattleEnd;
...
// Portal System
//////////////////////////////////////////////////////////////////////////
RWS::CEventId g_EventPortalStartRes;         ///< 포탈 NPC를 클릭했을때의 응답
...
RWS::CEventId g_EventMyNameplateChanged;
RWS::CEventId g_EventOtherNameplateChanged;
//////////////////////////////////////////////////////////////////////////
// Mob 관련 Event
