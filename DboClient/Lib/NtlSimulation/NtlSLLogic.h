...
RwBool      Logic_CanCharging(CNtlSobActor* pActor);                ///< 기모으기가 가능한가?
...
// 넷창고인지 검사 후 넷창고라면 이동가능한지 검사. 아닌 경우는 이동가능.
...
//////////////////////////////////////////////////////////////////////////
// 컨디션 처리 관련
RwBool      Logic_IsCondition(CNtlSobActor* pActor, RwUInt32 uiConditon);         ///< 해당 컨디션이 있는지 확인한다.
