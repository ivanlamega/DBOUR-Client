...
public:
	...
	*/
	...
	static void SysMsg(SERIAL_HANDLE hSerialId, RwUInt32 uiMsg, RwBool bServerMsg = TRUE);
	...
	static void FormatSysMsg(SERIAL_HANDLE hSerialId, RwUInt32 uiMsg, RwBool bServerMsg, ... );
	...
	*/
	...
	static void ActionMapScouterUse();
	...
	*/
	...
	static void InputChagneHeading(RwBool bSmoothing, RwReal fDeltaAngle, RwBool& bSuccess);
	static RwBool SobTargetSelect(SERIAL_HANDLE hSerialId);
	...
	static void* SobWorldItemCreate(RwUInt32 uiClassId, SERIAL_HANDLE hSerialId, RwV3d vLoc, RwInt32 eObjType, void* pBrief, void* pState );
	...
	static void* SobBuffCreate(RwUInt32 uiClassId, SERIAL_HANDLE hSerialId, RwUInt8 byBuffType, RwUInt32 uiTblId, RwUInt32 uiRemainTime, RwUInt32 uiKeepTime, RwReal* apEffectValue );
	...
	static void SobDirectionFloat(SERIAL_HANDLE hSerialId, RwUInt8 byMoveFlags, RwV3d vDir);
	...
	static void SobItemUpgrade(RwUInt8 byBattleAttribute, RwUInt8 byStoneStack, RwUInt8 byItemGrade, 
								RwUInt8 byItemPlace, RwUInt8 byItemPos, RwUInt8 byStonePlace, RwUInt8 byStonePos, RwBool bItemDestroy);
	...
	static void SobJump(SERIAL_HANDLE hSerialId, RwUInt8 byMoveFlags, RwV3d vDir, RwV3d vJumpDir);
	...
	static void SobBuffAdd(SERIAL_HANDLE hSerialId, RwUInt8 byBuffType, RwUInt32 uiTblId, RwUInt32 uiRemainTime, RwUInt32 uiKeepTime, RwReal* afEffectValue);
	static void SobBuffDrop(SERIAL_HANDLE hSerialId, RwUInt8 byBuffType, RwUInt32 uiTblId);
	static void SobBuffRefreshAll(SERIAL_HANDLE hSerial, RwUInt8 byCount, sBUFF_INFO* pBuffInfo);

	static void SobFakeBuffAdd(SERIAL_HANDLE hSerialId, RwUInt8 byBuffType, RwUInt32 uiTblId, RwUInt32 uiRemainTime, RwUInt32 uiKeepTime, RwReal* afEffectValue);
	static void SobFakeBuffDrop(SERIAL_HANDLE hSerialId, RwUInt8 byBuffType, RwUInt32 uiTblId);
	...
	static void SobServerUpdateCondition(SERIAL_HANDLE hSerialId, DWORD dwCondition);
	...
	static void PartyMemberAdd(SERIAL_HANDLE hSerial, WCHAR* pwcName, RwUInt8 byRace = 0, RwUInt8 byClass = 0, RwUInt8 byLevel = 0,
		RwUInt32 wCurLP = 0, RwUInt32 wMaxLP = 0, RwUInt32 wCurEP = 0, RwUInt32 wMaxEP = 0, RwUInt32 uiWorldTableIndex = 0xffffffff, RwUInt32 uiWorldID = 0xffffffff,
	...
	static void PartyCharmActivity(RwUInt32 uiMessage, RwUInt8 byIndex, RwUInt32 uiTableIndex = INVALID_SERIAL_ID, RwReal fRemainTime = 0.f);
	...
	static void PrivateShopBusinessRequestRes(RwUInt16 wResultCode, RwUInt8 byPrivateShopInventorySlotPos, RwUInt8 byItemState );
	static void PrivateShopBusinessRequestNfy(RwUInt8 byPrivateShopInventorySlotPos, RwUInt8 byItemState );
	static void PrivateShopBusinessConsentReq(SERIAL_HANDLE hVisitorID, RwUInt8 byPrivateShopInventorySlotPos );
	static void PrivateShopBusinessConsentNfy(SERIAL_HANDLE hOwner, RwUInt8 byPrivateShopInventorySlotPos );
	static void PrivateShopBusinessWaittimeOutNfy(SERIAL_HANDLE hOwner, RwUInt8 byPrivateShopInventorySlotPos );
	static void PrivateShopBusinessPricefluctuationsRes(RwUInt16 wResultCode, RwUInt8 byPrivateShopInventorySlotPos, RwUInt32 dwBeforeZenny, RwUInt32 dwAfterZenny );
	static void PrivateShopBusinessPricefluctuationsNfy(SERIAL_HANDLE hOwner, RwUInt8 byPrivateShopInventorySlotPos, RwUInt32 dwBeforeZenny, RwUInt32 dwAfterZenny );
	static void PrivateShopBusinessImmediateItemBuyingRes(RwUInt16 wResultCode, sPRIVATESHOP_ITEM_DATA* pPrivateShopItemData );
	static void PrivateShopBusinessImmediateItemBuyingNfy(SERIAL_HANDLE hPrivateShopOwner, sPRIVATESHOP_ITEM_DATA* pPrivateShopItemData );
	static void PrivateShopBusinessCancleRes(RwUInt16 wResultCode, RwUInt8 byCancleType, RwUInt8 byPrivateShopInventorySlotPos );
	static void PrivateShopBusinessCancleNfy(SERIAL_HANDLE hOWner, RwUInt8 byCancleType, RwUInt8 byPrivateShopInventorySlotPos );

	static void ChatMessagePrivateShopBusiness(WCHAR* pwchSenderCharName, RwUInt16 wMessageLengthInUnicode, WCHAR* pwcMessage );

	//---------------------------------------------------------
	// TMQ
	static void SLTMQBoard(RwUInt32 uiEventType, RwUInt32 uiTargetHandle = 0xffffffff, RwUInt32 uiValue = 0xffffffff, void* pExData = NULL);
	static void SLTMQBoardNotify(RwUInt32 uiEventType, RwUInt32 uiTargetHandle = 0xffffffff, RwUInt32 uiValue = 0xffffffff, void* pExData = NULL);
	...
	static void SLDirection_Nfy(RwBool bCreate, RwV3d vLoc);                ///< 방향 지시 시스템을 생성한다.
	...
	//---------------------------------------------------------
	// 정보 얻어오기
	static void SobGetState(SERIAL_HANDLE hSerialId, RwUInt8& byServerState, RwUInt8& byClientState);
	...
	static void QuestProposalDialog_Req( sTS_KEY& sTSKey,
		...
		const sREWARD_INFO* psSelectReward );	// 퀘스트 보상 정보 - 선택 보상
	...
	static void TSOpenBattleStart(SERIAL_HANDLE hSource);
	static void TSOpenBattleEnd(SERIAL_HANDLE hSource);
	...
	//---------------------------------------------------------
	// 트리거 오브젝트 스카우터 연출 관련
	static void TrigObjScouterDir_CreateSTObj( SERIAL_HANDLE hSerial );

	static void TrigObjScouterDir_DeleteSTObj( SERIAL_HANDLE hSerial );

	static void ScouterEvent(RwInt32 iType, RwUInt32 uiSerailID = 0, RwInt32 iUserData2 = 0, RwInt32 iUserData3 = 0);
	...
	// Portal System
	static void PortalStartRes(WORD wResultCode, RwUInt32 hNPCSerialID);
	static void PortalInfoRes(BYTE byCount, PORTALID* paPortalID);
	static void PortalAddRes(WORD wResultCode, PORTALID portalID);
	static void PortalRes(WORD wResultCode, BYTE byPoint);
	...
	static void FriendInfo(sFRIEND_INFO* pInfo, RwBool bIsFirst);
	...
	static void SobVehicleStart( SERIAL_HANDLE hDriver, const RwV3d& vSpawnPos, SERIAL_HANDLE hVehicleItem, TBLIDX tblVehicleItem );
	...
	// Hoipoi Item Machine
	static void HoipoiMixItemMachineMake( RwUInt8 byPlace, RwUInt8 byPos);
	static void HoipoiMixItemMachineDel(void);
	static void HoipoiMixRecipeReg( TBLIDX idxRecipeTbl );
	static void HoipoiMixItemRecipeInfo( RwUInt8 byCount, void* pRecipeData );
	static void HoipoiMixItemMakeExp( RwUInt32 dwCurExp, RwUInt8 byCurLevel );
	static void HoipoiMixInfoUpdate( RwUInt8 byType, RwUInt32 dwData );
	static void HoipoiMixJobSetRes( SERIAL_HANDLE hNpcHandle, RwUInt8 byRecipeType );
	static void HoipoiMixJobResetRes( SERIAL_HANDLE hNpcHandle, RwUInt8 byRecipeType );
	...
	static void MyNameplateMode(SERIAL_HANDLE hSerialID);
	static void OtherNameplateMode(SERIAL_HANDLE hSerialID);
