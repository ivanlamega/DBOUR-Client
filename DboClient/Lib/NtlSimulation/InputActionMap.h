...
private:
	...
	CNtlCallbackParam0 *m_pCallSitAndStand;			///< 앉아 일어서
...
public:
	...
	template <class Callbackclass>
	void LinkSitAndStand(Callbackclass *cbclass,int (Callbackclass::*callback)(void));
	...
	//Flying - SanGawku
	template <class Callbackclass>
	void LinkAirUp(Callbackclass *cbclass,int ( Callbackclass::*callback)(unsigned int uiMoveFalgs));
	void UnLinkAirUp(void);

	template <class Callbackclass>
	void LinkAirDown(Callbackclass *cbclass, int (Callbackclass::*callback)(unsigned int uiMoveFalgs));
	void UnLinkAirDown(void);

	template <class Callbackclass>
	void LinkAirFreeDown(Callbackclass *cbclass, int (Callbackclass::*callback)(unsigned int uiMoveFalgs));
	void UnLinkAirFreeDown(void);

	template <class Callbackclass>
	void LinkAirFastDown(Callbackclass *cbclass, int (Callbackclass::*callback)(unsigned int uiMoveFalgs));
	void UnLinkAirFastDown(void);

	template <class Callbackclass>
	void LinkAirBehavior(Callbackclass *cbclass, int (Callbackclass::*callback)(unsigned int uiMoveFalgs));
...
template <class Callbackclass>
void CInputActionMap::LinkSitAndStand(Callbackclass *cbclass,int (Callbackclass::*callback)(void))
{
	NTL_PRE(m_pCallSitAndStand == 0);
	m_pCallSitAndStand = NTL_NEW CNtlCallbackWidget0<Callbackclass> (cbclass,callback);
}
...
//Air/Fly - SanGawku
template <class Callbackclass>
void CInputActionMap::LinkAirUp(Callbackclass *cbclass, int (Callbackclass::*callback)(unsigned int uiMoveFalgs))
{
	NTL_PRE(m_pCallAirUp == 0);
	m_pCallAirUp = NTL_NEW CNtlCallbackWidget1<Callbackclass>(cbclass, callback);
}
template <class Callbackclass>
void CInputActionMap::LinkAirDown(Callbackclass *cbclass, int (Callbackclass::*callback)(unsigned int uiMoveFalgs))
{
	NTL_PRE(m_pCallAirDown == 0);
	m_pCallAirDown = NTL_NEW CNtlCallbackWidget1<Callbackclass>(cbclass, callback);
}
template <class Callbackclass>
void CInputActionMap::LinkAirFreeDown(Callbackclass *cbclass, int (Callbackclass::*callback)(unsigned int uiMoveFalgs))
{
	NTL_PRE(m_pCallAirFreeDown == 0);
	m_pCallAirFreeDown = NTL_NEW CNtlCallbackWidget1<Callbackclass>(cbclass, callback);
}
template <class Callbackclass>
void CInputActionMap::LinkAirFastDown(Callbackclass *cbclass, int (Callbackclass::*callback)(unsigned int uiMoveFalgs))
{
	NTL_PRE(m_pCallAirFastDown == 0);
	m_pCallAirFastDown = NTL_NEW CNtlCallbackWidget1<Callbackclass>(cbclass, callback);
}

template <class Callbackclass>
void CInputActionMap::LinkAirBehavior(Callbackclass *cbclass, int (Callbackclass::*callback)(unsigned int uiMoveFalgs))
{
	NTL_PRE(m_pCallAirBehavior == 0);
	m_pCallAirBehavior = NTL_NEW CNtlCallbackWidget1<Callbackclass>(cbclass, callback);
}
