...
#include "..\..\DboClient\Client\Main\DboEventGenerator.h"
...
RwBool CNtlSobManager::Create(void)
{
	...
	LinkMsg(g_EventActionMapSkillUse, 0);

	LinkMsg(g_EventSobTargetSelect, 0);
	LinkMsg(g_EventSobTargetSelectRelease, 0);
	LinkMsg(g_EventSobAttackMarkRelease, 0);
    LinkMsg(g_EventSobTargetMarkSelect, 0);
    LinkMsg(g_EventSobTargetMarkRelease, 0);
	LinkMsg(g_EventSobGotFocus, 0);
	LinkMsg(g_EventSobLostFocus, 0);
	LinkMsg(g_EventSobAttackSelect, 0);
	LinkMsg(g_EventSobCreate, 0);
	LinkMsg(g_EventSobDelete, 0);
	LinkMsg(g_EventSobSummonPetSpawnSync, 0);
	LinkMsg(g_EventSobMove, 0);
    LinkMsg(g_EventSobMoveSync);
	LinkMsg(g_EventSobSecondDestMove, 0);
	LinkMsg(g_EventSobSplineMove, 0);
	LinkMsg(g_EventSobAdjustMovePosition, 0);
	LinkMsg(g_EventSobDash, 0);
	LinkMsg(g_EventSobFollowMove, 0);
	LinkMsg(g_EventSobMoveStop, 0);
	LinkMsg(g_EventSobDirectionFloat, 0);
	LinkMsg(g_EventSobAdjustMove, 0);
	LinkMsg(g_EventSobStanding, 0);
	LinkMsg(g_EventSobFightingMode, 0);
	LinkMsg(g_EventSobAttack, 0);
    LinkMsg(g_EventSobSendAttackEnd, 0);
	LinkMsg(g_EventSobAttacked, 0);
	LinkMsg(g_EventSobPetBeginAttack, 0);
	LinkMsg(g_EventSobHit, 0);
	LinkMsg(g_EventSobAttackFollow, 0);	
	LinkMsg(g_EventSobJump, 0);
	LinkMsg(g_EventSobJumpDirection, 0);
	LinkMsg(g_EventSobJumpEnd, 0);
	LinkMsg(g_EventSobSit, 0);
	LinkMsg(g_EventSobPrivateShop, 0);
	LinkMsg(g_EventPrivateShopState, 0);
	LinkMsg(g_EventSobConvertClass, 0);
    LinkMsg(g_EventSobChangeAdult, 0);
	LinkMsg(g_EventSobDirectPlay, 0);
	LinkMsg(g_EventSobAnimPlay, 0);
	...
	LinkMsg(g_EventSobItemAdd, 0);
	LinkMsg(g_EventSobItemDelete, 0);
	LinkMsg(g_EventSobItemMove, 0);
	LinkMsg(g_EventSobItemStackMove, 0);
	LinkMsg(g_EventSobEquipChange, 0);
	LinkMsg(g_EventSobItemUpdate, 0);
	LinkMsg(g_EventSobItemUseAction, 0);
	LinkMsg(g_EventSobItemCancel, 0);
	LinkMsg(g_EventSobItemUseResFailed, 0 );
	LinkMsg(g_EventSobItemCasting, 0);

	LinkMsg(g_EventChangeGuildName, 0);
	LinkMsg(g_EventChangeGuildEmblem, 0);
	
	LinkMsg(g_EventSobQuestItemAdd, 0);
	LinkMsg(g_EventSobQuestItemDelete, 0);
	LinkMsg(g_EventSobQuestItemMove, 0);
	LinkMsg(g_EventSobQuestItemUpdate, 0);

	LinkMsg(g_EventQuestMark, 0);

	LinkMsg(g_EventSobSkillCancel, 0);
	LinkMsg(g_EventSobSkillAffectingCancel, 0);
	LinkMsg(g_EventSobSkillCasting, 0);
	LinkMsg(g_EventSobSkillAction, 0);
	LinkMsg(g_EventSobSkillActioned, 0);
	LinkMsg(g_EventSobSkillAdd, 0);
	LinkMsg(g_EventSobSkillUpgrade, 0);
	LinkMsg(g_EventSobHTBSkillAdd, 0);
	LinkMsg(g_EventSobHTBSkillAction, 0);
	LinkMsg(g_EventSobSocialAction, 0);
    LinkMsg(g_EventBotCaution_Nfy, NULL);
    LinkMsg(g_EventBotHelpMe_Nfy, NULL);
	
	LinkMsg(g_EventSobBuffAdd, 0);
	LinkMsg(g_EventSobBuffDrop, 0);
	LinkMsg(g_EventSobBuffRefreshAll, 0);

	LinkMsg(g_EventSobStateTransition, 0);
	LinkMsg(g_EventSobServerUpdateState, 0);
	LinkMsg(g_EventSobServerUpdateCondition, 0);
    LinkMsg(g_EventSobServerUpdateAspect, NULL);
	LinkMsg(g_EventSobFainting, 0);
    LinkMsg(g_EventSobUpdateLPStatusNfy, NULL);

	LinkMsg(g_EventSobGetState, 0);
	LinkMsg(g_EventSobGetFightingMode, 0);

	LinkMsg(g_EventShowPlayerName, 0);
	LinkMsg(g_EventAnimEnd, 0);
	LinkMsg(g_EventAnimHit, 0);    
	LinkMsg(g_EventAnimFootStep, 0);
	LinkMsg(g_EventWeightTime, 0);
	LinkMsg(g_EventAnimDirect, 0);
	LinkMsg(g_EventSubWeaponActive, 0);
	LinkMsg(g_EventSubWeaponDeActive, 0);
	LinkMsg(g_EventSummon, 0);
	LinkMsg(g_EventAlpha, 0);
	LinkMsg(g_EventTriDoodads, 0);
    ...
    LinkMsg(g_EventCreateEventObject, 0);
	LinkMsg(g_EventThreadLoadingComplete, 0);
    LinkMsg(g_EventCreateWorld);
    LinkMsg(g_EventSobCondConfused, NULL);
    LinkMsg(g_EventSobCondTerror, NULL);
	LinkMsg(g_EventGambleAniStart, NULL);
	LinkMsg(g_EventChangeNickName, NULL);
    ...
    //////////////////////////////////////////////////////////////////////////
    // Sob 객체에 바로 넘기지 않고, 처리한후 넘기는 이벤트들
    ...
    m_mapEventFunc[g_EventScouter.Get_pEventId()] = &CNtlSobManager::SobScouterEventHandler;
	...
	m_mapEventFunc[g_EventChangeNickName.Get_pEventId()] = &CNtlSobManager::ChangeNickName;
		...
		for(RwInt32 i = 0; i < 4; i++)
		{
			...
			if(pSobGroup)
			{
				...
				for(it = mapObject.begin(); it != mapObject.end(); ++it)
				{
					...
					RwV2dSub(&v2dSub, &v2dSobPos, &v2dCamPos);
...
void CNtlSobManager::RemoveAllObjects(SERIAL_HANDLE myHandle)
{
	NTL_FUNCTION("CNtlSobManager::RemoveAllObject");
	MapObject::iterator it;
	for(it = m_mapObject.begin(); it != m_mapObject.end();)  
	{
		// Get the sob object
		CNtlSob *pObj = (CNtlSob *)(*it).second;
		++it; // Lets move first
		// get the sob object serial
		RwUInt32 uiSerialId = pObj->GetSerialID();
		RwUInt32 uiClassId = pObj->GetClassID();
		if ((uiClassId == SLCLASS_AVATAR )|| (uiClassId == SLCLASS_MONSTER )|| (uiClassId == SLCLASS_NPC) ||
			(uiClassId == SLCLASS_WORLD_ITEM) || (uiClassId == SLCLASS_PLAYER))
		{
			if (uiSerialId != myHandle)
			{
#ifndef dNTL_WORLD_TOOL_MODE
  			CDboEventGenerator::CharObjDelete(pObj->GetSerialID());
			CNtlSLEventGenerator::SobDelete(pObj->GetSerialID());
#endif // !DeleteAll
			}
			// this case SHOULD be only us
		}
	}
}
...
void CNtlSobManager::SobCreateEventHandler(RWS::CMsg &pMsg)
{
    ...
    else if(pSobCreate->uiClassId == SLCLASS_AVATAR)
    {
        ...
        // Max Rp Stock
        Logic_SetRpStockMax(pSobObj, GetNtlSLGlobal()->GetAvatarInfo()->byMaxRpStock);
    }
...
void CNtlSobManager::SobScouterEventHandler( RWS::CMsg& pMsg ) 
{
    SDboEventScouter* pData = (SDboEventScouter*)pMsg.pData;
    if(pData->iType == SCOUTER_EVENT_ENTER ||
       pData->iType == SCOUTER_EVENT_EXIT ||
       pData->iType == SCOUTER_EVENT_EXIT_AFTER_OUT_OF_ORDER ||
       pData->iType == SCOUTER_EVENT_NFY_ENTER ||
       pData->iType == SCOUTER_EVENT_NFY_EXIT ||
       pData->iType == SCOUTER_EVENT_NFY_BROKEN        
       )
    {
        CNtlSob* pSob = GetSobObject(pData->uiUserData);
        if(pSob)
        {            
            pSob->HandleEvents(pMsg);
        }   
...
{
    // 아무것도 하지 않고 Sob 오브젝트에 이벤트를 넘겨준다.
