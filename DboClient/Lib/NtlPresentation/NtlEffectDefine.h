...
#define EFFECT_FILE_VERSION		0x00000014
...
#define EFFECT_BLUR_ALPHA   20         ///< Blur Alpha 값 (0 ~ 255)


// 미리 렌더웨어에서 정의되어있는 Flag들.
// 사용자 정의 Flag는 아래 Flag를 제외한 Flag들을 사용해야 된다.
/*
...
struct SNtlPrtStdEmitterTrail
{
    ...
    RwV3d   vOffset;                  ///< 궤적이 생길 중심점으로부터의 Offset
