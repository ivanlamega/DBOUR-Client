...
#ifdef VER_TW
	pFileMem = SectorUnknown1SkipToFileMem(pFileMemTmp);
#endif
...
RwBool CNtlWorldSectorInfo::SectorHeightfieldLoadFromFile(FILE* pFile, RwV3d* pVertexList)
{
	if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION_OLD))
	{
		fread(pVertexList ,sizeof(RwV3d) * dGET_WORLD_PARAM()->WorldSectorVertNum * dGET_WORLD_PARAM()->WorldSectorVertNum, 1, pFile);
	}
	else if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION))
	{
		RwV3d vBasedPos;
...
RwInt32	CNtlWorldSectorInfo::SectorHeightfieldSkipToFileGetVertex(FILE* pFile, RwInt32 iStartIdx, RwInt32 iCount, RwV3d* pResult)
{
	...
	if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION_OLD))
	{		
		::fseek(pFile, sizeof(RwV3d) * iStartIdx, SEEK_CUR);
		::fread(pResult, sizeof(RwV3d) * iCount, 1, pFile);
		::fseek(pFile, sizeof(RwV3d) * iPostSkipCnt, SEEK_CUR);
	}
	else if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION))
	{
		RwV3d vBasedPos;
...
{		
	...
	if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION_OLD))
	{
		fread(acName, sizeof(RwChar) * 128, 1, pFile);		
	}
	else if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION))
	{
		RwUInt32 uiLength = 0;
...
RwInt32 CNtlWorldSectorInfo::EffectSkipToFile(FILE* pFile)
{
	...
	{
		// Obj. Name
		::fseek(pFile, (sizeof(RwChar) * 128), SEEK_CUR);
	}
	else if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION))
	{
		RwUInt32 uiLength = 0;
...
CNtlPLSound* CNtlWorldSectorInfo::SoundEffectLoadFromFile(FILE* pFile)
{
	...
	if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION_OLD))
	{
		fread(acName, sizeof(RwChar) * 32, 1, pFile);
	}
	else if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION))
	{
		RwUInt32 uiLength = 0;
...
CNtlPLOccluder_Quad* CNtlWorldSectorInfo::OccluderLoadFromFile(FILE* pFile)
{
	...
	if (eFuncFlag & EPLOCCLUDER_FUNC_PVS)
	{
		...
		if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION_OLD))
		{
			fseek(pFile, sizeof(sizeof(RwChar) * 128), SEEK_CUR);
		}
		else if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION))
		{
			RwUInt32 uiLength = 0;
...
CNtlPLLightObject* CNtlWorldSectorInfo::LightObjectLoadFromFile(FILE* pFile)
{
	...
	if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION_OLD))
	{
		fread(&sCreateParam.rgbafColor, sizeof(RwRGBAReal), 1, pFile);
	}
	else if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION))
	{
		RwRGBA rgba;
...
RwInt32 CNtlWorldSectorInfo::LightObjectSkipToFile(FILE* pFile)
{
	if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION_OLD))
	{
	RwInt32 SkipRange = sizeof(RpLightType) + sizeof(RwBool) + sizeof(RwV3d) + sizeof(RwV3d) + sizeof(RwRGBAReal) + sizeof(RwReal) +
...
CNtlPLDecalVolume* CNtlWorldSectorInfo::DecalVolumeLoadFromFile(FILE* pFile)
{
	...
	if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION_OLD))
	{
		fread(sCreateParam.acTextureName, sizeof(RwChar) * 128, 1, pFile);
	}
	else if (dNTL_WORLD_VERSION_COMPARE(dGET_WORLD_PARAM()->WorldLoadVer, dNTL_WORLD_VERSION))
	{
		RwUInt32 uiLength = 0;
