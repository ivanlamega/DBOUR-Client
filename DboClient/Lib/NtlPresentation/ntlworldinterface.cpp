...
RpWorld* RpNtlWorldCreate()
{
	...
	RwBBox NtlWorldBBox = { {(RwReal)dGET_WORLD_PARAM()->WorldValueMax, 1512.0f, (RwReal)dGET_WORLD_PARAM()->WorldValueMax},
							{(RwReal)dGET_WORLD_PARAM()->WorldValueMin, -1512.0f, (RwReal)dGET_WORLD_PARAM()->WorldValueMin} };
#else
