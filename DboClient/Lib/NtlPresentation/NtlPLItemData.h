...
// Grade Effect 리소스 Define
#define EFFECT_GRADE_3          "GME_ITM_WP_G03"
#define EFFECT_GRADE_4          "GME_ITM_WP_G04"
...
{	
	...
	ITEM_EQUIP_USER_MOVE1 = 20,						// Weapon(Gem) Model Tool에서 Offset값 만큼 떨어 뜨린다.
	ITEM_EQUIP_SCOUTER	= 100,						// Scouter(Offset 값 적용되고, Offset값 적용 됨)
};
...
struct SUpgradeEffectProperty
{
    ...
    RwV3d   vOffset2;
    RwChar  szEffect1[MAX_DEFAULT_NAME];
    RwChar  szEffect2[MAX_DEFAULT_NAME];
	/*RwChar  unk01[MAX_DEFAULT_NAME];
	RwChar  unk02[MAX_DEFAULT_NAME];
	RwChar  unk03[MAX_DEFAULT_NAME];
	RwChar  unk04[MAX_DEFAULT_NAME];
	RwChar  unk05[MAX_DEFAULT_NAME];
	RwChar  unk1[MAX_DEFAULT_NAME];
	RwChar  unk2[MAX_DEFAULT_NAME];
	RwChar  unk3[MAX_DEFAULT_NAME];
	RwChar  unk4[MAX_DEFAULT_NAME];
	RwChar  unk5[MAX_DEFAULT_NAME];
	RwChar  unk6[MAX_DEFAULT_NAME];
	RwChar  unk7[MAX_DEFAULT_NAME];
	RwChar  unk8[MAX_DEFAULT_NAME];
	RwChar  unk9[MAX_DEFAULT_NAME];*/
    ...
    SUpgradeEffectProperty()
    {
        ...
        sprintf_s(szEffect1, "%s", EFFECT_GRADE_3);
        sprintf_s(szEffect2, "%s", EFFECT_GRADE_4);
