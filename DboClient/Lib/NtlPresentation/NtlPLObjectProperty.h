...
enum EPLObjectCategory
{
	E_OBJECT_CATEGORY_CONSTRUCTION_SHOP = 0,
	E_OBJECT_CATEGORY_CONSTRUCTION_BUILDING,
	E_OBJECT_CATEGORY_CONSTRUCTION_WALL,
	E_OBJECT_CATEGORY_CONSTRUCTION_ROAD,
	E_OBJECT_CATEGORY_LANDSCAPE_GAME,
	E_OBJECT_CATEGORY_LANDSCAPE_LIFE,
	E_OBJECT_CATEGORY_LANDSCAPE_SIGHT,
	E_OBJECT_CATEGORY_MATTER_TOOL,
	E_OBJECT_CATEGORY_MATTER_CARRY,
	E_OBJECT_CATEGORY_NATURE_TREE,
	E_OBJECT_CATEGORY_NATURE_GRASS,
	E_OBJECT_CATEGORY_NATURE_ROCK,
	E_OBJECT_CATEGORY_NATURE_ANIMAL
};
...
public:
	...
	static std::string m_strVer;			/* property file version **/
...
protected:
	...
	EPLObjectCategory m_eObjectCategory;            ///< Object Category for Editor
...
public:
    ...
    virtual RwBool  SaveScript(const RwChar* strFileName);          ///< XML 스크립트 파일로 저장한다.
	...
	EPLObjectCategory GetCategory();
	void SetCategory(EPLObjectCategory category);
