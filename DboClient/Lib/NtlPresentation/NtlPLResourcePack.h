...
enum EFilePackTypeFlag
{
    ...
    NTL_PACK_TYPE_FLAG_TS           = (1<<NTL_PACK_TYPE_TS),
...
#define NTL_PACKNAME_TERRAIN_HEADER				"tan.pak"
...
#define NTL_PACKNAME_TS_HEADER                  "ts.pak"
...
#define NTL_PACKNAME_TERRAIN_DATA				"terrain"
...
#define NTL_FILEPACK_BUFFER_SIZE	512

#define NTL_MAX_FILEPACK_SIZE		20000000
...
public:
	...
	const char*		encrypt(std::string data);
...
private:
	...
	RwChar*	DumpFile(const char *pFileName, RwUInt32& uiSize);
...
public:
    ...
    void                    LoadTs(const RwChar* pFileName, void** pData, RwInt32* iSize);
