...
struct SPLCharacterCreateParam : public SPLEntityCreateParam
{
    ...
    RwBool  bIsAdult;
	FLOAT	fScale;
	SPLCharacterCreateParam() : bNotShadingFlag(FALSE), bIsAdult(FALSE), fScale(1.0f) {}
};
...
public:
	...
	virtual int	CallBackBaseAnim(RwUInt32 uiAnimEvent);											///< Animation Event를 받는 Callback 함수
