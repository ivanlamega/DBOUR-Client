...
#ifdef TW_VER
	fread(&m_pNtlObjectProp->dwUnknown, sizeof(m_pNtlObjectProp->dwUnknown), 1, pFile);
#endif
...
#ifdef TW_VER
	fwrite(&m_pNtlObjectProp->dwUnknown, sizeof(m_pNtlObjectProp->dwUnknown), 1, pFile);
#endif
...
#ifdef TW_VER
	iPropertyRange += sizeof(RwInt32); //m_pNtlObjectProp->dwUnknow
#endif
