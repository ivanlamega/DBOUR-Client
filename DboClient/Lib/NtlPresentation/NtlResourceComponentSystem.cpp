...
{
//#ifdef RWDEBUG	// Enable effects in release mode -- Kalisto
	m_bShow					= TRUE;
//#endif
...
RwBool CNtlResourceComponentSystem::Load(FILE* pFile)
{
	...
	fread(&m_bAlphaBlend,					sizeof(RwBool),							1,			pFile);
	fread(&m_nSrcBlend,						sizeof(RwBlendFunction),				1,			pFile);
	fread(&m_nDestBlend,					sizeof(RwBlendFunction),				1,			pFile);
