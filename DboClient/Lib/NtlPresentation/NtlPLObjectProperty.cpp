...
std::string CNtlPLObjectProperty::m_strVer;
...
RwBool CNtlPLObjectProperty::SaveScript(const RwChar* strFileName)
{
	CNtlPLObjectXMLScript xmlScript;
	return xmlScript.SaveObjectScript(strFileName, this);
}
...
EPLObjectCategory CNtlPLObjectProperty::GetCategory()
{
	return m_eObjectCategory;
}

void CNtlPLObjectProperty::SetCategory(EPLObjectCategory category)
{
	m_eObjectCategory = category;
}
