...
#define dMONO_POWER_DEFAULT (0.2f)
...
protected:
	...
	//D3DXMATRIX			m_hWorld;
	//D3DXMATRIX			m_hView;
	//D3DXMATRIX			m_hProjection;
	//D3DXMATRIX			m_hWorldInverseTranspose;
	//D3DXHANDLE			m_hDiffuseDirection;
	//D3DXHANDLE			m_hDiffuseColor;
	//D3DXHANDLE			m_hDiffuseIntensity;
	//D3DXHANDLE			m_hLineColor;
	//D3DXHANDLE			m_hLineThicc;
	////Toon Shader Props
	//D3DXHANDLE			m_hDiffuseColor;
