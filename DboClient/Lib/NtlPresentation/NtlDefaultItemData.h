...
protected:
	...
	DEF_ITEM_HEAD_KEY_NAME              m_mapSuperSaiyanBlueHeadKeyName;    ///< 초사이어인용 Head
	DEF_ITEM_FACE_MULTI_TEX_NAME_MAP    m_mapSuperSaiyanBlueFaceMultiTexName;   ///< 초사이어인용 Face
...
public:
	...
	std::string *GetSuperSaiyanBlueHeadKeyName(EClassGenderType eClassGenderType, RwUInt32 uiHeadType);
	RwBool		 AddSuperSaiyanBlueHeadKeyName(EClassGenderType eClassGenderType, RwUInt32 uiHeadType, const std::string & strHeadKeyName);
