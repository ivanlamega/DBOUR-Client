...
std::string CNtlPLItemProperty::m_strVer;			  /* property file version **/ 
std::string CNtlPLItemProperty::m_strItemDataPath;	  /* Item mesh file의 path name **/
//template<size_t S> class Sizer { }; Sizer<sizeof(SEventTrace)> foo;
//template<size_t S> class Sizer { }; Sizer<sizeof(SEventVisualEffect)> foo2;
...
template<size_t S> class Sizer { }; Sizer<sizeof(SEventLinkEffect)> foo2;
