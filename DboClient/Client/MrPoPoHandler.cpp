...
std::wstring CMrPoPoHandler::OnTeleport( RwInt32 nIndex ) 
{
    ...
    {
    case MPP_TELE_YAHOI:
        wstrRet = L"1 4493 4032";
        break;
    case MPP_TELE_YUREKA:
        wstrRet = L"1 6586 3254";
        break;
    case MPP_TELE_DALPANG:
        wstrRet = L"1 3246 -2749";
        break;
    case MPP_TELE_DRAGON:
        wstrRet = L"1 4620 -1729";
        break;
    case MPP_TELE_BAEE:
        wstrRet = L"1 4509 4031";
        break;
    case MPP_TELE_AJIRANG:
        wstrRet = L"1 4509 4031";
        break;
    case MPP_TELE_KARINGA_1:
        wstrRet = L"1 5928 658";
        break;
    case MPP_TELE_KARINGA_2:
        wstrRet = L"1 5884 827";
        break;
    case MPP_TELE_GREAT_TREE:
        wstrRet = L"1 5903 1711";
        break;
    case MPP_TELE_KARINGA_3:
        wstrRet = L"1 7527 -518";
        break;
    case MPP_TELE_MERMAID:
        wstrRet = L"1 4651 -206";
        break;
    case MPP_TELE_GANNET:
        wstrRet = L"1 3690 1396";
        break;
    case MPP_TELE_EMERALD:
        wstrRet = L"1 3390 -564";
        break;
    case MPP_TELE_TEMBARIN:
        wstrRet = L"1 1964 1072";
        break;    
    case MPP_TELE_CELL:
        wstrRet = L"1 -480 1646";
        break;
    case MPP_TELE_BUU:
        wstrRet = L"1 2481 3384";
        break;
    case MPP_TELE_CC:
        wstrRet = L"1 -1796 1106";
        break;
    case MPP_TELE_MUSHROOM:
        wstrRet = L"1 -1408 -1408";
        break;
    }
...
std::wstring CMrPoPoHandler::OnTeleport( RwInt32 nMsg, RwInt32 nVal ) 
{
    ...
    {
        WCHAR buf[1024] = {0,};
        swprintf_s(buf, L"1 %d %d", m_nTemp, nVal);
        strRet = buf;
    }
...
void CMrPoPoHandler::OnSuperMode() 
{
    ...
    swprintf_s(wBuf, L"@setdefense 99999999");
    GetDboGlobal()->GetGamePacketGenerator()->SendServerCommand(wBuf);
