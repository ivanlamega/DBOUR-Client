...
RwBool CDboEventHandler::Create(void)
{
	...
	RegisterMsg(g_EventConnectBoxShow, "g_EventConnectBoxShowStr", "SDboEventMsgBoxShow");
	...
	RegisterMsg(g_EventCharm, "g_EventCharm", " ");	
	RegisterMsg(g_EventCharmVictim, "g_EventCharmVictim", " ");	
	RegisterMsg(g_EventPartyInventory, "g_EventPartyInventory", " ");	
	...
	RegisterMsg(g_EventScouterUpgradePredict, "g_EventScouterUpgradePredict", "SDboScouterUpgradePredict" );
	...
	RegisterMsg( g_EventHoipoiMixItemCheckRes, "g_EventHoipoiMixItemCheckRes", "SDboEventHoipoiMixItemCheckRes" );
	RegisterMsg( g_EventHoipoiMixItemMakeRes, "g_EventHoipoiMixItemMakeRes", "SDboEventHoipoiMixItemMakeRes" );
	RegisterMsg( g_EventHoipoiMixItemMakeEpRes, "g_EventHoipoiMixItemMakeEpRes", " " );
	...
	// Game mania time
	RegisterMsg(g_EventGmtInfo, "g_EventGmtInfo", "SDboEventGmtInfo" );
	RegisterMsg(g_EventGmtUpdate, "g_EventGmtUpdate", "SDboEventGmtUpdate" );
	RegisterMsg(g_EventGmtChanged, "g_EventGmtChanged", "SDboEventGmtChanged" );
	RegisterMsg(g_EventGmtResetOpen, "g_EventGmtResetOpen", "SDboEventGmtResetOpen");
...
void CDboEventHandler::Destroy(void)
{
	...
	UnRegisterMsg(g_EventConnectBoxShow);
	...
	UnRegisterMsg(g_EventCharm);
	UnRegisterMsg(g_EventCharmVictim);
	UnRegisterMsg(g_EventPartyInventory);
	...
	UnRegisterMsg(g_EventScouterUpgradePredict);
	...
	UnRegisterMsg( g_EventHoipoiMixItemCheckRes );
	UnRegisterMsg( g_EventHoipoiMixItemMakeRes );
	UnRegisterMsg( g_EventHoipoiMixItemMakeEpRes );
	...
	// Game Mania time
	UnRegisterMsg(g_EventGmtInfo);
	UnRegisterMsg(g_EventGmtUpdate);
	UnRegisterMsg(g_EventGmtChanged);
	UnRegisterMsg(g_EventGmtResetOpen);
...
void CDboEventHandler::HandleEvents(RWS::CMsg &pMsg)
{
	...
	else if( pMsg.Id == g_EventSysMsg )
	{
		...
		GetAlarmManager()->AlarmMessage( pData->uiMsg, pData->bServerMsg );
	}
	...
	else if( pMsg.Id == g_EventFormatSysMsg )
	{
		...
		GetAlarmManager()->vFormattedAlarmMessage( pData->uiMsg, pData->bServerMsg, NULL, pData->args );
	}
	...
	else if( pMsg.Id == g_EventSobTriggerObjCommunity )
	{
		...
		if( pOBJECT_TBLDAT->wFunction & eDBO_TRIGGER_OBJECT_FUNC_NAMEKAN_SIGN )
		{
