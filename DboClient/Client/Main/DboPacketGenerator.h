...
public:
	...
	bool SendLonInReq(const WCHAR *pUserId, const WCHAR *pPassword, RwUInt16 wLVer, RwUInt16 wRVer, const char* pMacAddress);
...
public:
	...
	bool SendCharAddReq(const WCHAR * pUserName, RwUInt8 byRace, RwUInt8 byClassId, RwUInt8 byGender, RwUInt8 byFace, RwUInt8 byHair, RwUInt8 byHairColor, RwUInt8 bySkinColor, RwUInt8 byBlood, FLOAT fScale);
...
public:
	...
	bool SendShopNetPyItemBuyReq( RwUInt8 byBuyCount, sSHOP_BUY_CART* pBuyData, DWORD totalCost );
