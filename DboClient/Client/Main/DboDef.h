...
#define CLIENT_RVER		80

//----------------------------------------------------------------------------
#define DEFAULT_SCREEN_WIDTH	1366	
#define DEFAULT_SCREEN_HEIGHT	768

#define EXTRA_SCREEN_WIDTH		1366		// cj의 요청에 의해서.
#define EXTRA_SCREEN_HEIGHT		768		// cj의 요청에 의해서.

#define DEFAULT_CAMERA_NEAR		0.5f
#define DEFAULT_CAMERA_FAR		2048.0f
...
#define MAX_VIRTUAL_SERVER_PACKET_SIZE		4096
