...
bool CLoginPacketGenerator::SendLonInReq(const WCHAR *pUserId, const WCHAR *pPassword, RwUInt16 wLVer, RwUInt16 wRVer, const char* pMacAddress)
{
	...
	pMacAddress = GetSystemMacAddress();

	memcpy(sPacket.abyMacAddress, pMacAddress, sizeof(strlen(pMacAddress)));
...
bool CGamePacketGenerator::SendShopNetPyItemBuyReq( RwUInt8 byBuyCount, sSHOP_BUY_CART* pBuyData, DWORD totalCost )
{
