...
public:
	...
	static void CharMaking(RwBool bSetDefaultCamera, RwUInt8 byRace, RwUInt8 byClass, RwUInt8 byHair, RwUInt8 byHairColor, RwUInt8 byFace, RwUInt8 bySkinColor, RwUInt8 byGender, float fScale);
	...
	static void	SayMessage(RwUInt8 byMsgType, const WCHAR * pUserName, RwUInt16 wMsgLen, const WCHAR * pMessage, RwUInt32 hObject = 0xffffffff, bool bIsGameMaster = FALSE);
