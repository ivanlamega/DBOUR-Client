...
{
	// login server
	CNtlPacketHandler::Register(AU_LOGIN_CREATEUSER_RES, PacketHandler_LSCrateUserRes);
	...
	CNtlPacketHandler::Register(GU_SCOUTER_ITEM_SELL_RES, PacketHandler_GSItemRemoteSellRes);
	...
	CNtlPacketHandler::Register(GU_SCOUTER_PREDICT_RES, PacketHandler_GSScouterPredictRes);
	...
	CNtlPacketHandler::Register(GU_SCOUTER_CHIP_REMOVE_ALL_RES, PacketHandler_GSScouterChipRemoveAllRes);
	...
	CNtlPacketHandler::Register(GU_PARTY_INVENTORY_INFO, PacketHandler_GSPartyInventoryInfo);
	CNtlPacketHandler::Register(GU_PARTY_OPENED_CHARM_INVENTORY_INFO, PacketHandler_GSPartyOpenedCharmInventoryInfo);
	...
	CNtlPacketHandler::Register(GU_PARTY_INVENTORY_ITEM_ADDED_NFY, PacketHandler_GSPartyInven_ItemAddedNfy);
	CNtlPacketHandler::Register(GU_PARTY_INVENTORY_ITEM_REMOVED_NFY, PacketHandler_GSPartyInven_ItemRemovedNfy);
	...
	CNtlPacketHandler::Register(GU_PARTY_INVEN_ITEM_RANK_SET_RES, PacketHandler_GSPartyInven_RankSetRes);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_ITEM_RANK_SET_NFY, PacketHandler_GSPartyInven_RankSetNfy);
	CNtlPacketHandler::Register(GU_PARTY_INVEST_ZENNY_RES, PacketHandler_GSPartyInven_InvestZennyRes);
	CNtlPacketHandler::Register(GU_PARTY_INVEST_ZENNY_NFY, PacketHandler_GSPartyInven_InvestZennyNfy);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_LOCK_RES, PacketHandler_GSPartyInven_LockRes);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_LOCK_NFY, PacketHandler_GSPartyInven_LockNfy);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_RESET_RES, PacketHandler_GSPartyInven_ResetRes);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_RESET_NFY, PacketHandler_GSPartyInven_ResetNfy);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_ACCEPTED_RES, PacketHandler_GSPartyInven_AcceptedRes);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_ACCEPTED_NFY, PacketHandler_GSPartyInven_AcceptedNfy);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_GIVE_RES, PacketHandler_GSPartyInven_GiveRes);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_GIVE_NFY, PacketHandler_GSPartyInven_GiveNfy);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_DICE_START_RES, PacketHandler_GSPartyInven_DiceStartRes);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_DICE_START_NFY, PacketHandler_GSPartyInven_DiceStartNfy);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_DICE_ROLL_RES, PacketHandler_GSPartyInven_DiceRollRes);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_DICE_ROLL_NFY, PacketHandler_GSPartyInven_DiceRollNfy);
	CNtlPacketHandler::Register(GU_PARTY_INVEN_DICE_END_NFY, PacketHandler_GSPartyInven_DiceEndNfy);

	CNtlPacketHandler::Register(GU_PARTY_OPEN_CHARM_SLOT_RES, PacketHandler_GSPartyCharm_OpenRes);
	CNtlPacketHandler::Register(GU_PARTY_CHARM_SLOT_OPENED_NFY, PacketHandler_GSPartyCharm_OpenedNfy);
	CNtlPacketHandler::Register(GU_PARTY_CLOSE_CHARM_SLOT_RES, PacketHandler_GSPartyCharm_CloseRes);
	CNtlPacketHandler::Register(GU_PARTY_CHARM_SLOT_CLOSED_NFY, PacketHandler_GSPartyCharm_CloseNfy);	
	CNtlPacketHandler::Register(GU_PARTY_REGISTER_VICTIM_ITEM_RES, PacketHandler_GSPartyCharm_RegVictimItemRes);
	CNtlPacketHandler::Register(GU_PARTY_VICTIM_ITEM_REGISTERED_NFY, PacketHandler_GSPartyCharm_RegVictimItemNfy);
	CNtlPacketHandler::Register(GU_PARTY_UNREGISTER_VICTIM_ITEM_RES, PacketHandler_GSPartyCharm_UnRegVictimItemRes);
	CNtlPacketHandler::Register(GU_PARTY_VICTIM_ITEM_UNREGISTERED_NFY, PacketHandler_GSPartyCharm_UnRegVictimItemNfy);
	CNtlPacketHandler::Register(GU_PARTY_DECLARE_ZENNY_RES, PacketHandler_GSPartyCharm_DeclareZennyRes);
	CNtlPacketHandler::Register(GU_PARTY_DECLARED_ZENNY_CHANGED_NFY, PacketHandler_GSPartyCharm_DeclareZennyNfy);
	CNtlPacketHandler::Register(GU_PARTY_CHARM_ACTIVATION_FAILED_NFY, PacketHandler_GSPartyCharm_Activation_Failed_Nfy);
	CNtlPacketHandler::Register(GU_PARTY_ACTIVATE_CHARM_RES, PacketHandler_GSPartyCharm_ActivateRes);
	CNtlPacketHandler::Register(GU_PARTY_CHARM_ACTIVATED_NFY, PacketHandler_GSPartyCharm_ActivateNfy);
	CNtlPacketHandler::Register(GU_PARTY_DEACTIVATE_CHARM_RES, PacketHandler_GSPartyCharm_DeActivateCharmRes);
	CNtlPacketHandler::Register(GU_PARTY_CHARM_DEACTIVATED_NFY, PacketHandler_GSPartyCharm_DeActivateCharmNfy);
	CNtlPacketHandler::Register(GU_PARTY_CHARM_DICE_START_NFY, PacketHandler_GSPartyCharm_DiceStart_Nfy);
	CNtlPacketHandler::Register(GU_PARTY_CHARM_DICE_ROLLED_RES, PacketHandler_GSPartyCharm_DiceRolled_Res);
	CNtlPacketHandler::Register(GU_PARTY_CHARM_DICE_ROLLED_NFY, PacketHandler_GSPartyCharm_DiceRolled_Nfy);
	CNtlPacketHandler::Register(GU_PARTY_CHARM_DICE_END_NFY, PacketHandler_GSPartyCharm_DiceEnd_Nfy);
	...
	CNtlPacketHandler::Register(GU_CHAR_SITDOWN, PacketHandler_GSCharSitDown);
	CNtlPacketHandler::Register(GU_CHAR_STANDUP, PacketHandler_GSCharStandUp);
	...
	CNtlPacketHandler::Register(GU_SHOP_SKILL_BUY_RES, PacketHandler_GSCharSkillBuyRes);
	...
	CNtlPacketHandler::Register(GU_SCOUTER_TURN_ON_NFY, PacketHandler_GUCharScouterOnNfy);
	CNtlPacketHandler::Register(GU_SCOUTER_TURN_OFF_NFY, PacketHandler_GUCharScouterOffNfy);
	CNtlPacketHandler::Register(GU_SCOUTER_BROKEN_NFY, PacketHandler_GUCharScouterBrokenNfy);
	...
	CNtlPacketHandler::Register(GU_UPDATE_TARGET_INFO, PacketHandler_GSCharUpdateTargetInfo);
	...
	CNtlPacketHandler::Register(GU_WORLD_FREE_PVP_ZONE_ENTERED_NFY, PacketHandler_GSFreePVPStartNfy);
	CNtlPacketHandler::Register(GU_WORLD_FREE_PVP_ZONE_LEFT_NFY, PacketHandler_GSFreePVPEndNfy);
	...
	CNtlPacketHandler::Register(GU_DOJO_BANK_HISTORY_RES, PacketHandler_GSDojo_BankHistoryRes);
	...
	// Time machine quest 게시판
	CNtlPacketHandler::Register(GU_TIMEQUEST_ROOM_LIST_RES, PacketHandler_GUTimeQuest_Room_List_Res);
	CNtlPacketHandler::Register(GU_TIMEQUEST_ROOM_INFO_RES, PacketHandler_GUTimeQuest_Room_Info_Res);
	CNtlPacketHandler::Register(GU_TIMEQUEST_ROOM_JOIN_RES, PacketHandler_GUTimeQuest_Room_Join_Res);
	CNtlPacketHandler::Register(GU_TIMEQUEST_ROOM_JOIN_NFY, PacketHandler_GUTimeQuest_Room_Join_Nfy);
	CNtlPacketHandler::Register(GU_TIMEQUEST_ROOM_LEAVE_RES, PacketHandler_GUTimeQuest_Room_Leave_Res);
	CNtlPacketHandler::Register(GU_TIMEQUEST_ROOM_LEAVE_NFY, PacketHandler_GUTimeQuest_Room_Leave_Nfy);
	CNtlPacketHandler::Register(GU_TIMEQUEST_ROOM_SELECTION_NFY, PacketHandler_GUTimeQuest_Room_Selection_Nfy);
	CNtlPacketHandler::Register(GU_TIMEQUEST_ROOM_TELEPORT_RES, PacketHandler_GUTimeQuest_Room_Teleport_Nfy);
	CNtlPacketHandler::Register(GU_TIMEQUEST_START_NFY, PacketHandler_GUTimeQuest_Room_Start_Nfy);
	CNtlPacketHandler::Register(GU_TIMEQUEST_START_EXCEPTION_NFY, PacketHandler_GUTimeQuest_Room_Start_Exception_Nfy);

	// Time machine quest 게임
	...
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_REQUEST_RES, PacketHandler_GUPrivateShopBusinessRequestRes);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_REQUEST_NFY, PacketHandler_GUPrivateShopBusinessRequestNfy);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_CONSENT_REQ, PacketHandler_GUPrivateShopBusinessConsentReq);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_CONSENT_NFY, PacketHandler_GUPrivateShopBusinessConsentNfy);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_WAITTIMEOUT_NFY, PacketHandler_GUPrivateShopBusinessWaittimeOutNfy);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_PRICEFLUCTUATIONS_RES, PacketHandler_GUPrivateShopBusinessPricefluctuationsRes);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_PRICEFLUCTUATIONS_NFY, PacketHandler_GUPrivateShopBusinessPricefluctuationsNfy);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_IMMEDIATE_ITEM_BUYING_RES, PacketHandler_GUPrivateShopBusinessImmediateItemBuyingRes);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_IMMEDIATE_ITEM_BUYING_NFY, PacketHandler_GUPrivateShopBusinessImmediateItemBuyingNfy);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_WINDOWCLOSE_NFY, PacketHandler_GUPrivateShopBusinessWindowCloseNfy);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_CANCEL_RES, PacketHandler_GUPrivateShopBusinessCancelRes);
	CNtlPacketHandler::Register(GU_PRIVATESHOP_BUSINESS_CANCEL_NFY, PacketHandler_GUPrivateShopBusinessCancelNfy);
	...
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_LIST_RES, PacketHandler_GSRBRoomListRes);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_INFO_RES, PacketHandler_GSRBRoomInfoRes);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_CREATE_RES, PacketHandler_GSRBRoomCreateRes);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_CREATE_NFY, PacketHandler_GSRBRoomCreateNfy);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_LEAVE_RES, PacketHandler_GSRBRoomLeaveRes);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_LEAVE_NFY, PacketHandler_GSRBRoomLeaveNfy);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_CHALLENGE_RES, PacketHandler_GSRBRoomChallengeRes);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_CHALLENGE_NFY, PacketHandler_GSRBRoomChallengeNfy);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_JOIN_INFO_NFY, PacketHandler_GSRBRoomJoinInfoNfy);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_MATCH_START_NFY, PacketHandler_GSRBRoomMatchStartNfy);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_MATCH_CANCEL_RES, PacketHandler_GSRBRoomMatchCancelRes);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_MATCH_CANCELED_NFY, PacketHandler_GSRBRoomMatchCanceledNfy);
	//CNtlPacketHandler::Register(GU_RANKBATTLE_ROOM_MATCH_READY_NFY, PacketHandler_GSRBRoomMatchReadyNfy);
	...
	// Portal System
	CNtlPacketHandler::Register(GU_PORTAL_START_RES, PacketHandler_GUPortalStartRes);
	...
	CNtlPacketHandler::Register(GU_GMT_INFO_NFY, PacketHandler_GUGmtInfoNfy );
	CNtlPacketHandler::Register(GU_GMT_UPDATE_RES, PacketHandler_GUGmtUpdateRes );
	CNtlPacketHandler::Register(GU_GMT_CHANGED_NFY, PacketHandler_GUGmtChangedNfy );	
	CNtlPacketHandler::Register(GU_DESTROY_ALL_OBJECTS_NFY, PacketHandler_GSDestroyAllObjects);
	...
	// Private Shop Business Chatting
	CNtlPacketHandler::Register(TU_CHAT_MESSAGE_PRIVATESHOP_BUSINESS, PacketHandler_TUChatMessagePrivateShopBusiness);
	...
	// Naming
	CNtlPacketHandler::Register(GU_CHAR_NICKNAME_CHANGED_NFY, PacketHandler_NickNameChangedNfy);
	...
	// Hoipoi Mix
	CNtlPacketHandler::Register(GU_HOIPOIMIX_ITEM_MACHINE_DEL_RES, PacketHandler_GUHoipoiMixItemMachineDelRes );
	...
	CNtlPacketHandler::Register(GU_HOIPOIMIX_ITEM_CHECK_RES, PacketHandler_GUHoipoiMixItemCheckRes );
	CNtlPacketHandler::Register(GU_HOIPOIMIX_ITEM_MAKE_RES, PacketHandler_GUHoipoiMixItemMakeRes );
	CNtlPacketHandler::Register(GU_HOIPOIMIX_ITEM_MAKE_EP_RES, PacketHandler_GUHoipoiMixItemMakeEpRes );
	CNtlPacketHandler::Register(GU_HOIPOIMIX_ITEM_RECIPE_INFO, PacketHandelr_GUHoipoiMixItemRecipeInfo );
	CNtlPacketHandler::Register(GU_HOIPOIMIX_ITEM_MAKE_EXP_NFY, PacketHandler_GUHoipoiMixItemMakeExpNfy );
	CNtlPacketHandler::Register(GU_HOIPOIMIX_JOB_SET_RES, PacketHandler_GUHoipoiMixJobSetRes );
	CNtlPacketHandler::Register(GU_HOIPOIMIX_JOB_RESET_RES, PacketHandler_GUHoipoiMixJobResetRes );
	...
	CNtlPacketHandler::Register(GU_VEHICLE_FUEL_UPDATE_NFY, PacketHandler_GUVehicleFuelUpdateNfy );	
	...
	CNtlPacketHandler::Register(GU_PLAY_SFX, PacketHandler_GUSoundPlaySFX);
	...
	// NProtect
	CNtlPacketHandler::Register(GU_GAMEGUARD_AUTH_ANSWER_REQ, PacketHandler_GUGameGuardAuthAnswerReq );
...
{
	// login server
	CNtlPacketHandler::UnRegister(AU_LOGIN_CREATEUSER_RES);
	...
	CNtlPacketHandler::UnRegister(GU_SCOUTER_ITEM_SELL_RES);
	...
	CNtlPacketHandler::UnRegister(GU_SCOUTER_PREDICT_RES);
	...
	CNtlPacketHandler::UnRegister(GU_PARTY_INVENTORY_INFO);
	CNtlPacketHandler::UnRegister(GU_PARTY_OPENED_CHARM_INVENTORY_INFO);
	...
	CNtlPacketHandler::UnRegister(GU_PARTY_INVENTORY_ITEM_ADDED_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVENTORY_ITEM_REMOVED_NFY);
	...
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_ITEM_RANK_SET_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_ITEM_RANK_SET_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEST_ZENNY_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEST_ZENNY_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_LOCK_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_LOCK_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_RESET_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_RESET_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_ACCEPTED_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_ACCEPTED_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_GIVE_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_GIVE_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_DICE_START_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_DICE_START_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_DICE_ROLL_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_DICE_ROLL_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_INVEN_DICE_END_NFY);

	CNtlPacketHandler::UnRegister(GU_PARTY_OPEN_CHARM_SLOT_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_CHARM_SLOT_OPENED_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_CLOSE_CHARM_SLOT_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_CHARM_SLOT_CLOSED_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_REGISTER_VICTIM_ITEM_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_VICTIM_ITEM_REGISTERED_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_UNREGISTER_VICTIM_ITEM_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_VICTIM_ITEM_UNREGISTERED_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_DECLARE_ZENNY_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_DECLARED_ZENNY_CHANGED_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_CHARM_ACTIVATION_FAILED_NFY);	
	CNtlPacketHandler::UnRegister(GU_PARTY_ACTIVATE_CHARM_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_CHARM_ACTIVATED_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_DEACTIVATE_CHARM_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_CHARM_DEACTIVATED_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_CHARM_DICE_START_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_CHARM_DICE_ROLLED_RES);
	CNtlPacketHandler::UnRegister(GU_PARTY_CHARM_DICE_ROLLED_NFY);
	CNtlPacketHandler::UnRegister(GU_PARTY_CHARM_DICE_END_NFY);
	...
	CNtlPacketHandler::UnRegister(GU_SHOP_SKILL_BUY_RES);
	...
	CNtlPacketHandler::UnRegister(GU_SCOUTER_TURN_ON_NFY);
	CNtlPacketHandler::UnRegister(GU_SCOUTER_TURN_OFF_NFY);
	CNtlPacketHandler::UnRegister(GU_SCOUTER_BROKEN_NFY);
	...
	CNtlPacketHandler::UnRegister(GU_WORLD_FREE_PVP_ZONE_ENTERED_NFY);
	CNtlPacketHandler::UnRegister(GU_WORLD_FREE_PVP_ZONE_LEFT_NFY);
	...
	CNtlPacketHandler::UnRegister(GU_DOJO_BANK_HISTORY_RES);
	...
	// TMQ
	CNtlPacketHandler::UnRegister(GU_TIMEQUEST_ROOM_LIST_RES);
	CNtlPacketHandler::UnRegister(GU_TIMEQUEST_ROOM_INFO_RES);
	CNtlPacketHandler::UnRegister(GU_TIMEQUEST_ROOM_JOIN_RES);
	CNtlPacketHandler::UnRegister(GU_TIMEQUEST_ROOM_JOIN_NFY);
	CNtlPacketHandler::UnRegister(GU_TIMEQUEST_ROOM_LEAVE_RES);
	CNtlPacketHandler::UnRegister(GU_TIMEQUEST_ROOM_LEAVE_NFY);
	CNtlPacketHandler::UnRegister(GU_TIMEQUEST_ROOM_SELECTION_NFY);
	CNtlPacketHandler::UnRegister(GU_TIMEQUEST_ROOM_TELEPORT_RES);
	...
	// PrviateShop Business
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_REQUEST_RES);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_REQUEST_NFY);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_CONSENT_REQ);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_CONSENT_NFY);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_WAITTIMEOUT_NFY);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_PRICEFLUCTUATIONS_RES);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_PRICEFLUCTUATIONS_NFY);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_IMMEDIATE_ITEM_BUYING_RES);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_IMMEDIATE_ITEM_BUYING_NFY);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_WINDOWCLOSE_NFY);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_CANCEL_RES);
	CNtlPacketHandler::UnRegister(GU_PRIVATESHOP_BUSINESS_CANCEL_NFY);
...
//	CNtlPacketHandler::UnRegister(GU_RANKBATTLE_ROOM_MATCH_READY_NFY);
	...
	CNtlPacketHandler::UnRegister(TU_CHAT_MESSAGE_PRIVATESHOP_BUSINESS);
	...
	//CNtlPacketHandler::
	CNtlPacketHandler::UnRegister(GU_HOIPOIMIX_ITEM_MACHINE_DEL_RES);
	CNtlPacketHandler::UnRegister(GU_DYNAMIC_OBJECT_UPDATE_STATE);

	CNtlPacketHandler::UnRegister(GU_HOIPOIMIX_RECIPE_REG_NFY);
	CNtlPacketHandler::UnRegister(GU_HOIPOIMIX_ITEM_CHECK_RES);
	CNtlPacketHandler::UnRegister(GU_HOIPOIMIX_ITEM_MAKE_RES);
	CNtlPacketHandler::UnRegister(GU_HOIPOIMIX_ITEM_MAKE_EP_RES);
	CNtlPacketHandler::UnRegister(GU_HOIPOIMIX_ITEM_RECIPE_INFO);
	CNtlPacketHandler::UnRegister(GU_HOIPOIMIX_ITEM_MAKE_EXP_NFY);

	CNtlPacketHandler::UnRegister(GU_HOIPOIMIX_JOB_SET_RES);
	CNtlPacketHandler::UnRegister(GU_HOIPOIMIX_JOB_RESET_RES);

	// Vehicle
	CNtlPacketHandler::UnRegister(GU_VEHICLE_START_NFY);
	CNtlPacketHandler::UnRegister(GU_VEHICLE_ENGINE_START_RES);
	CNtlPacketHandler::UnRegister(GU_VEHICLE_ENGINE_START_NFY);
	CNtlPacketHandler::UnRegister(GU_VEHICLE_ENGINE_STOP_RES);
	CNtlPacketHandler::UnRegister(GU_VEHICLE_ENGINE_STOP_NFY);
	CNtlPacketHandler::UnRegister(GU_VEHICLE_FUEL_UPDATE_NFY);
	...
	CNtlPacketHandler::UnRegister(GU_PLAY_SFX);
	...
	// NProtect
	CNtlPacketHandler::UnRegister(GU_GAMEGUARD_AUTH_ANSWER_REQ);
	...
	CNtlPacketHandler::UnRegister(GU_DESTROY_ALL_OBJECTS_NFY);
}
