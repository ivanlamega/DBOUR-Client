...
const WCHAR* Logic_GetClassName(RwUInt8 byClass)
{
	...
	return GetDisplayStringManager()->GetString( DST_NAMEK_FIGHTER );
...
const WCHAR* Logic_GetNPCJobName(RwUInt8 byJob)
{
	...
	case NPC_JOB_SCOUTER_MERCHANT: case 58:			return GetDisplayStringManager()->GetString( DST_JOB_SCOUTER_MERCHANT );
	...
	case NPC_JOB_BUDOHSI_MERCHANT: case 60: case 61:			return GetDisplayStringManager()->GetString( DST_JOB_BUDOHSI_MERCHANT );
	case NPC_JOB_REFEREE:					return GetDisplayStringManager()->GetString( DST_JOB_REFEREE );
	case NPC_JOB_GAMBLE_MERCHANT: case 62:			return GetDisplayStringManager()->GetString( DST_JOB_GAMBLE_MERCHANT );
	...
	case NPC_JOB_MIX_MASTER:	case 57:			return GetDisplayStringManager()->GetString( DST_JOB_MIX_MASTER );
	case 45: case 46:  return L"Quest Merchant";
	case 47: return L"Pet Merchant";
	case 48: return L"Event NPC";
	case 49: return L"DWC NPC";
	case 50: return L"Pet Gamble Merchant";
	case 51: return L"Dungeon Manager";
	case 52: return L"Upgrade Merchant";
	case 53: return L"Vehicle Merchant";
	case 54: return L"Alien Engineer";
	case 55: return L"MascotEX Merchant";
	case 56: return L"MascotEX Gamble Merchant";
	
	case 59: return L"Special Scouter Merchant";
	}


	static WCHAR awcBuffer[64];
	memset(awcBuffer, 0, sizeof(awcBuffer));
		swprintf_s(awcBuffer, 64, L"NPCID:%d", byJob);

	printf("Logic_GetNPCJobName, Not exist NPC job name of NPC job index :%d", byJob);
