...
RwBool CWebLoginStage::CreateWorld()
{
	...
	vAvatarPos.x	= 159.99f;
	vAvatarPos.y	= 43.48f;
	vAvatarPos.z	= -287.41f;
	...
	char buffer[256];
	wsprintf(buffer, "World DBOUR_START Create Elapsed: %u\n", (int)dwElapsedTime);
...
void CWebLoginStage::SetCameraPositioin()
{
	...
	v3CameraPos.x	= 169.39f;
	v3CameraPos.y	= 43.27f;
	v3CameraPos.z	= -289.74f;

	v3CameraDir.x	= 169.99f;
	v3CameraDir.y	= 43.48f;
	v3CameraDir.z	= -289.88f;
