...
#define	dOPTION_VIRTUAL_HEIGHT			21			// 리스트의 높이
...
protected:
	...
	//Display nameplates
	gui::CButton*		m_pMyNameOn;
	gui::CButton*		m_pMyNameOff;
	gui::CButton*		m_pOtherNameOn;
	gui::CButton*		m_pOtherNameOff;

	SOnOff				m_onoffGuild;
	SOnOff				m_onoffDojo;
	SOnOff				m_onoffScouter;
	SOnOff				m_onoffMyName;
	SOnOff				m_onoffOtherName;
public:
	COptionInfo();
	virtual ~COptionInfo();
...
private: // system setting
	...
	void				SetMyNameplateOnOff(RwBool bOnOff);
	RwBool				GetMyNameplateOnOff();
	void				SetOtherNameplateOnOff(RwBool bOnOff);
	RwBool				GetOtherNameplateOnOff();
};
