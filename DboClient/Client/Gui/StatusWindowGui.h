...
/**
* \ingroup client
* \brief Tab showing Detailed Statistics
*/
...
private:
	gui::CDialog*		m_pSelf;
	gui::CDialog*		m_dialogStats;
	gui::CScrollBar*    m_pScrollBar;
	gui::CStaticBox*	m_pstbAttributesTitle[68];
	gui::CStaticBox*	m_pstbAttributes[68]; //sAVATAR_ATTRIBUTE only LastAttribute and others. 
