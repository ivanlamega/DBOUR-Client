...
RwBool CTMQBoardGui::Create()
{
	...
	m_pDifficult->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	m_pDifficult->SetTextColor( RGB(255, 190, 77) );
	m_pDifficult->SetText( "Difficulty" );
	...
	m_pStartTime->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	...
	m_pDifficultText->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	...
	m_pStartTimeText->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	...
	m_pLimitedTimeText->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	...
	m_pReservationPeople->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	...
	m_pNextTitle_Senario_1->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	...
	m_pNextTitle_Senario_2->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	...
	m_pNextTitle_Senario_3->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
