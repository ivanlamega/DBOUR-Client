...
RwBool CCharGuiGroup::Create(void)
{
    ...
    {
        AddGuiMacro(m_pNetMarblePCBangGui, CNetMarblePCBangGui, "NetMarblePCBangGui");    
    }    
...
void CCharGuiGroup::Destroy(void)
{
    ...
    //RemoveGuiMacro(m_pConnetBox);
    RemoveGuiMacro(m_pNetMarblePCBangGui);
