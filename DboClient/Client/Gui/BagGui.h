...
class CNetpyStoreBagGui : public CBag16SpaceGui
{
public:
	RwBool	Create(VOID);	
...
/*For adding the bigger bag slots - SanGawku*/
...
#define VISIBLE_BAGSLOT_COUNT ( NTL_MAX_BAGSLOT_COUNT - 1 )
