...
#define WHO_LIST_MAX_VISIBLE 13
 ...
 * \author agebreak
 */
class CWhoListGui : public CNtlPLGui, public RWS::CEventHandler
{
public:
...
public:
	CWhoListGui(void);
	CWhoListGui(const RwChar* pName);
	virtual ~CWhoListGui(void);
...
protected:
    ...
    CButtonList<CWhoListGui, sCommunityMember*> m_InfoList;
    gui::CStaticBox*    m_pSttLevel[WHO_LIST_MAX_VISIBLE];
    gui::CStaticBox*    m_pSttLoc[WHO_LIST_MAX_VISIBLE];
    gui::CStaticBox*    m_pSttChannel[WHO_LIST_MAX_VISIBLE];    
    gui::CPanel*        m_pPnlBackSpace[WHO_LIST_MAX_VISIBLE];
    gui::CPanel*        m_pPnlIcon[WHO_LIST_MAX_VISIBLE];
    ...
    gui::CSlot          m_slotMouseMove[WHO_LIST_MAX_VISIBLE];
    gui::CSlot          m_slotBtnMouseLeave[WHO_LIST_MAX_VISIBLE];    
    gui::CSlot          m_slotListWheelMove[WHO_LIST_MAX_VISIBLE];
    gui::CSlot          m_slotToggled[WHO_LIST_MAX_VISIBLE];
