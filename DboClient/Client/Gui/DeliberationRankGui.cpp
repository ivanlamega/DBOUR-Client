...
static BYTE restTest = 1;
#define dREST_TIME				(3600.f)
#define dSHOW_TIME				(60.f)
...
VOID CDeliberationRankContainer::Update(RwReal fElapsed)
{
	...
	if( !m_pDeliberationRank )
	{
		...
		switch (restTest)
		{
			case 1:
			{
				GetAlarmManager()->AlarmMessage(DST_DELIBERATION_RANK_MESSAGE_1);
				restTest++;
				break;
			}
			case 2:
			{
				GetAlarmManager()->AlarmMessage(DST_DELIBERATION_RANK_MESSAGE_2);
				restTest++;
				break;
			}
			case 3:
			{
				GetAlarmManager()->AlarmMessage(DST_DELIBERATION_RANK_MESSAGE_3);
				restTest++;
				break;
			}
			case 4:
			{
				GetAlarmManager()->AlarmMessage(DST_DELIBERATION_RANK_MESSAGE_4);
				restTest++;
				break;
			}
			case 5:
			{
				GetAlarmManager()->AlarmMessage(DST_DELIBERATION_RANK_MESSAGE_5);
				restTest++;
				break;
			}
			case 6:
			{
				GetAlarmManager()->AlarmMessage(DST_DELIBERATION_RANK_MESSAGE_WARING_1);
				restTest++;
				break;
			}
			default:
