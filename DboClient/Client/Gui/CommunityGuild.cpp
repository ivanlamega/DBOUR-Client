...
:m_charID(INVALID_CHARACTERID)
{
	...
	m_pName->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	m_pName->Show(false);
	...
	m_pLevel->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	m_pLevel->Show(false);
	...
	m_pArea->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);
	m_pArea->Show(false);
...
RwBool CCommunityGuild::Create(CNtlPLGui* pParent)
{
	...
	m_pGuildName->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);	
	...
	m_pGuildPoint = NTL_NEW gui::CStaticBox( rect, m_pParent->GetDialog(), GetNtlGuiManager()->GetSurfaceManager(), COMP_TEXT_LEFT );
	m_pGuildPoint->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);	
	m_pGuildPoint->SetTextColor(RGB(255, 210, 0));
	m_pGuildPoint->Clear();
	m_pGuildPoint->Enable(false);
	m_pGuildPoint->Show(false);
	...
	m_pGuildNoticeTime->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);	
	...
	m_pGuildNoticer->CreateFontStd( "Default", DEFAULT_FONT_SIZE, DEFAULT_FONT_ATTR);	
		...
		case SLGE_GUILD_INFO:
			{
				...
				m_pGuildPoint->Format(L"%d pt", pGuild->GetReputationEver() );
