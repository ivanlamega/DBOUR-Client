...
RwBool CGameGuiGroup::Create(void)
{
	...
	AddDialog(m_pWhoListGui, CWhoListGui, "WhoListGui", DIALOG_WHOSONLINE);
	...
	if( (eDBO_SERVICE_PUBLISHER_CJI_KOR == eService ) || (GetServiceInterface()->GetPublisherID() == eDBO_SERVICE_PUBLISHER_DBONU))
	{
