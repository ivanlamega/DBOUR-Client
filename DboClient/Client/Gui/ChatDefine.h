...
#define CHAT_DISP_MAXIMUM_WIDTH				720		// ChatDisplay.frm의 outputDisplay의 넓이보다 크면 안된다
#define CHAT_DISP_MAXIMUM_HEIGHT			720		// ChatDisplay.frm의 outputDisplay의 높이보다 크면 안된다
