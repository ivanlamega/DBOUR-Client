...
VOID CItemUpgradeGui::SetResult( RwInt32 eResult, RwUInt8 byBattleAttribute, RwInt32 nGrade )
{
	...
	else
	{
			...
			EQUIP_TYPE_SUB_WEAPON == pAttr->GetItemTbl()->byEquip_Type )			
		{
			...
			{
				wPhysicalOffence = pAttr->GetItemTbl()->wPhysical_Offence;// Logic_GetFinalItemValue( pAttr->GetItemTbl()->wPhysical_Offence, nGrade, pAttr->GetItemTbl()->dwPhysical_OffenceUpgrade );
				wBeforePhysicalOffence = pAttr->GetItemTbl()->wPhysical_Offence;// Logic_GetFinalItemValue( pAttr->GetItemTbl()->wPhysical_Offence, pAttr->GetGrade(), pAttr->GetItemTbl()->dwPhysical_OffenceUpgrade );
			...
			{
				wEnergyOffence = pAttr->GetItemTbl()->wEnergy_Offence;// Logic_GetFinalItemValue(pAttr->GetItemTbl()->wEnergy_Offence, nGrade, pAttr->GetItemTbl()->dwEnergy_OffenceUpgrade);
				wBeforeEnergyOffence = pAttr->GetItemTbl()->wEnergy_Offence;//Logic_GetFinalItemValue( pAttr->GetItemTbl()->wEnergy_Offence, pAttr->GetGrade(), pAttr->GetItemTbl()->dwEnergy_OffenceUpgrade );
		...
		else
		{
			...
			{
				wPhysicalDefence = pAttr->GetItemTbl()->wPhysical_Defence;// Logic_GetFinalItemValue(pAttr->GetItemTbl()->wPhysical_Defence, nGrade, pAttr->GetItemTbl()->dwPhysical_DefenceUpgrade);
				wBeforePhysicalDefence = pAttr->GetItemTbl()->wPhysical_Defence;//	Logic_GetFinalItemValue( pAttr->GetItemTbl()->wPhysical_Defence, pAttr->GetGrade(), pAttr->GetItemTbl()->dwPhysical_DefenceUpgrade );
			...
			{
				wEnergyDefence = pAttr->GetItemTbl()->wEnergy_Defence;//Logic_GetFinalItemValue( pAttr->GetItemTbl()->wEnergy_Defence, nGrade, pAttr->GetItemTbl()->dwEnergy_DefenceUpgrade );
				wBeforeEnergyDefence = pAttr->GetItemTbl()->wEnergy_Defence;//Logic_GetFinalItemValue( pAttr->GetItemTbl()->wEnergy_Defence, pAttr->GetGrade(), pAttr->GetItemTbl()->dwEnergy_DefenceUpgrade );
	...
	case STATE_UPGRADE_READY:
		{
				...
				EQUIP_TYPE_SUB_WEAPON == pItemAttr->GetItemTbl()->byEquip_Type )				
			{
				...
				if( pItemAttr->GetItemTbl()->wPhysical_Offence != INVALID_WORD )
				{
					...
					wPhysicalValue = pItemAttr->GetItemTbl()->wPhysical_Offence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wPhysical_Offence, byGrade, pItemAttr->GetItemTbl()->dwPhysical_OffenceUpgrade );
					wNextPhysicalValue = pItemAttr->GetItemTbl()->wPhysical_Offence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wPhysical_Offence, byNextGrade, pItemAttr->GetItemTbl()->dwPhysical_OffenceUpgrade );
					wPureMaxValue = pItemAttr->GetItemTbl()->wPhysical_Offence;// Logic_GetFinalItemValue(pItemAttr->GetItemTbl()->wPhysical_Offence, byPureMaxGrade, pItemAttr->GetItemTbl()->dwPhysical_OffenceUpgrade);
					...
					wFailPhysicalValue = pItemAttr->GetItemTbl()->wPhysical_Offence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wPhysical_Offence, byGrade, pItemAttr->GetItemTbl()->dwPhysical_OffenceUpgrade );
				...
				if( pItemAttr->GetItemTbl()->wEnergy_Offence != INVALID_WORD )
				{
					...
					wEnergyValue = pItemAttr->GetItemTbl()->wEnergy_Offence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wEnergy_Offence, byGrade, pItemAttr->GetItemTbl()->dwEnergy_OffenceUpgrade );
					wNextEnergyValue = pItemAttr->GetItemTbl()->wEnergy_Offence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wEnergy_Offence, byNextGrade, pItemAttr->GetItemTbl()->dwEnergy_OffenceUpgrade );
					wPureMaxValue = pItemAttr->GetItemTbl()->wEnergy_Offence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wEnergy_Offence, byPureMaxGrade, pItemAttr->GetItemTbl()->dwEnergy_OffenceUpgrade );
					...
					wFailEnergyValue = pItemAttr->GetItemTbl()->wEnergy_Offence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wEnergy_Offence, byGrade, pItemAttr->GetItemTbl()->dwEnergy_OffenceUpgrade );
			...
			else
			{
				...
				if( pItemAttr->GetItemTbl()->wPhysical_Defence != INVALID_WORD )
				{
					...
					wPhysicalValue = pItemAttr->GetItemTbl()->wPhysical_Defence;// Logic_GetFinalItemValue(pItemAttr->GetItemTbl()->wPhysical_Defence, byGrade, pItemAttr->GetItemTbl()->dwPhysical_DefenceUpgrade);
					wNextPhysicalValue = pItemAttr->GetItemTbl()->wPhysical_Defence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wPhysical_Defence, byNextGrade, pItemAttr->GetItemTbl()->dwPhysical_DefenceUpgrade );
					wPureMaxValue = pItemAttr->GetItemTbl()->wPhysical_Defence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wPhysical_Defence, byPureMaxGrade, pItemAttr->GetItemTbl()->dwPhysical_DefenceUpgrade );
					...
					wFailPhysicalValue = pItemAttr->GetItemTbl()->wPhysical_Defence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wPhysical_Defence, byGrade, pItemAttr->GetItemTbl()->dwPhysical_DefenceUpgrade );
				...
				if( pItemAttr->GetItemTbl()->wEnergy_Defence != INVALID_WORD )
				{
					...
					wEnergyValue = pItemAttr->GetItemTbl()->wEnergy_Defence;// Logic_GetFinalItemValue(pItemAttr->GetItemTbl()->wEnergy_Defence, byGrade, pItemAttr->GetItemTbl()->dwEnergy_DefenceUpgrade);
					wNextEnergyValue = pItemAttr->GetItemTbl()->wEnergy_Defence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wEnergy_Defence, byNextGrade, pItemAttr->GetItemTbl()->dwEnergy_DefenceUpgrade );
					wPureMaxValue = pItemAttr->GetItemTbl()->wEnergy_Defence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wEnergy_Defence, byPureMaxGrade, pItemAttr->GetItemTbl()->dwEnergy_DefenceUpgrade );
					...
					wFailEnergyValue = pItemAttr->GetItemTbl()->wEnergy_Defence;//Logic_GetFinalItemValue( pItemAttr->GetItemTbl()->wEnergy_Defence, byGrade, pItemAttr->GetItemTbl()->dwEnergy_DefenceUpgrade );
