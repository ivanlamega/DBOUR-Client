...
class CTMQSideIconGui;
class CTMQSideViewGui;
...
protected:
	...
	CTMQSideIconGui*			m_pTMQSideIconGui;
	CTMQSideViewGui*			m_pTMQSideViewGui;
	...
	CSCSSideIconGui*			m_pSCSSideIconGui;
	CSCSSideViewGui*			m_pSCSSideViewGui;
};
