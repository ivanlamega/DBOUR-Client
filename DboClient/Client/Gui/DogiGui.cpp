...
VOID CDogiGui::RegisterDogiItem( TBLIDX tblIdx, RwUInt8 byGrade )
{
	...
	if ( pCharProxy )
	{
		...
		SEquipItem* pEquipItem = pCharProxy->GetUIDogiCharacter()->pUIEquipProxy->GetEquipItem( EQUIP_SLOT_TYPE_DOGI );
		...
		if ( pEquipItem )
		{
			...
			pCharProxy->GetUIDogiCharacter()->pUIEquipProxy->DeleteEquipItem( EQUIP_SLOT_TYPE_DOGI );
			pCharProxy->GetUIDogiCharacter()->pUIEquipProxy->CreateEquipItem( tblIdx, EQUIP_SLOT_TYPE_DOGI, byGrade );
...
VOID CDogiGui::UnregisterDogiIem( void )
{
	...
	{	//This is where you add more equipment types - SanGakwu
		...
		if ( pEquipItem && m_tblDogiItem != pEquipItem->uiItemTblId )
		{
			...
			//This is where you add more equipment types - SanGakwu
			pCharProxy->GetUIDogiCharacter()->pUIEquipProxy->DeleteEquipItem( EQUIP_SLOT_TYPE_DOGI );
			pCharProxy->GetUIDogiCharacter()->pUIEquipProxy->CreateEquipItem( m_tblDogiItem, EQUIP_SLOT_TYPE_DOGI, m_byDogiGrade );
