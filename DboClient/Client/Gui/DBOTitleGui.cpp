...
#define dADJUST_X_GAP	 (29)
	...
	m_srfTitle.SetPosition((rect.GetWidth()  - m_srfTitle.GetWidth())/2,
		(rect.GetHeight() - m_srfTitle.GetHeight())/2 - 250);
...
//	std::string path = "file://";
	...
	std::string fullPath = cwd + "\\movie\\AGE1000_DBOUR.mp4";

	m_media = libvlc_media_new_path(m_vlc, fullPath.c_str());
	...
	libvlc_media_player_set_hwnd(m_player, (void*)CDboApplication::GetInstance()->GetHWnd());
