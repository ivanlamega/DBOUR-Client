...
RwBool CSideDialogControlGui::Create()
{
	...
	dADD_BUTTON(BUTTONTYPE_PARTYCHARM,		"btnPartyCharm",	GetDisplayStringManager()->GetString(DST_PARTYGUI_CHARM),				SDIALOG_PARTY_CHRAM);
	dADD_BUTTON(BUTTONTYPE_PARTYINVEN,		"btnPartyInven",	GetDisplayStringManager()->GetString(DST_PARTYGUI_INVEN),				SDIALOG_PARTY_INVEN);
	...
	dADD_BUTTON(BUTTONTYPE_BUDOKAI_FINAL,	"btnDojoScramble",	L"DOJO SCRAMBLE",															SDIALOG_SCRAMBLE_STATUS);
