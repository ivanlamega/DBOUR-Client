...
void CNtlWeAvatarController::CreateWeAvatar()
{
	...
	//else
	//{
		wcscpy_s(pAvatarInfo->sCharPf.awchName, NTL_MAX_SIZE_CHAR_NAME_UNICODE, L"DBNU");
	//}
	...
	//pAvatarInfo->sItemPf[0].aOptionTblidx[0] = 0xffffffff;
	//pAvatarInfo->sItemPf[0].aOptionTblidx[1] = 0xffffffff;
	...
	//pAvatarInfo->sItemPf[1].aOptionTblidx[0]= 0xffffffff;
	//pAvatarInfo->sItemPf[1].aOptionTblidx[1]= 0xffffffff;
	...
	//pAvatarInfo->sItemPf[2].aOptionTblidx[0] = 0xffffffff;
	//pAvatarInfo->sItemPf[2].aOptionTblidx[1] = 0xffffffff;	
	...
	//pAvatarInfo->sItemPf[3].aOptionTblidx[0] = 0xffffffff;
	//pAvatarInfo->sItemPf[3].aOptionTblidx[1] = 0xffffffff;
	...
	//pAvatarInfo->sItemPf[4].aOptionTblidx[0] = 0xffffffff;
	//pAvatarInfo->sItemPf[4].aOptionTblidx[1] = 0xffffffff;
