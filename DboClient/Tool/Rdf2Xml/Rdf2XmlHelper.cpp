...
int DecToHex(int p_intValue)
{
	...
	int l_intResult = std::stoi(l_pCharRes, nullptr, 16);
	return l_intResult;
}
	...
	float fNodeValue)
{
	...
	_snwprintf(wszText, 256, L"%f", fNodeValue);
	...
	DWORD dNodeValue)
{
	...
	_snwprintf(wszText, 256, L"%d", dNodeValue);

	return AppendElementW(pDoc, pRoot, pNodeName, wszText);
}

// Add a that is a HEX bitflag
int AppendElementwBF(MSXML2::IXMLDOMDocumentPtr & pDoc,
	MSXML2::IXMLDOMElementPtr & pRoot,
	WCHAR * pNodeName,
	WORD dNodeValue)
{
	...
	if (dNodeValue != -1)
	{
		std::string hexstr = int_to_hex(dNodeValue);
		std::wstring wHex = std::wstring(hexstr.begin(), hexstr.end());
		_snwprintf(wszText, 256, L"%ls", wHex.c_str());
	}
	else
	_snwprintf(wszText, 256, L"%d", dNodeValue);
...
// Add a that is a HEX bitflag
int AppendElementdwBF(MSXML2::IXMLDOMDocumentPtr & pDoc,
	MSXML2::IXMLDOMElementPtr & pRoot,
	WCHAR * pNodeName,
	DWORD dNodeValue)
{
	...
	CHAR * pNodeValue)
{
	...
	//std::cout << "AppeandElementChar :" << pNodeValue << std::endl;
	_snwprintf(wszText, 256, L"%ls", A2W(pNodeValue));
	std::wregex re(L"^Í+");

	
	if (std::regex_search(wszText, re))
	{
		_snwprintf(wszText, 256, L"%ls", L"@");
	}
...
void SetFieldNameList_NpcTable(std::vector<std::wstring>& vecFieldName)
{
	vecFieldName.clear();
	...
	vecFieldName.push_back(L"Model");
	vecFieldName.push_back(L"Level");
	vecFieldName.push_back(L"Job");
	vecFieldName.push_back(L"Function_Bit_Flag");
	vecFieldName.push_back(L"Ai_Bit_Flag");
	vecFieldName.push_back(L"Dialog_Script_Index");
	vecFieldName.push_back(L"Battle_Attribute");
	vecFieldName.push_back(L"NPC_type");
	vecFieldName.push_back(L"Basic_LP");
	vecFieldName.push_back(L"LP_Regeneration");
	vecFieldName.push_back(L"Basic_EP");
	vecFieldName.push_back(L"EP_Regeneration");
	...
	{
		WCHAR wszBuffer[100] = { 0x00, };
		swprintf(wszBuffer, 100, L"Merchant_Tblidx_%d", i + 1);

		vecFieldName.push_back(wszBuffer);
	}
	vecFieldName.push_back(L"Camera_Bone_Name");
	vecFieldName.push_back(L"Status_Transform_Tblidx");
...
void SetFieldNameList_ItemTable(std::vector<std::wstring>& vecFieldName)
{
	...
	vecFieldName.push_back(L"Attack_Range_Bonus"); // New
	vecFieldName.push_back(L"Attack_Speed_Rate"); // New
	vecFieldName.push_back(L"Need_Level");
	vecFieldName.push_back(L"Need_Max_Level"); // New
	vecFieldName.push_back(L"Need_Class_Bit_Flag");
	vecFieldName.push_back(L"Need_Gender_Bit_Flag"); //New
	...
	vecFieldName.push_back(L"Scouter_Parts_Type_1"); // Type changed to Type_1
	vecFieldName.push_back(L"Use_Item_Tblidx");
	vecFieldName.push_back(L"Item_Option_Tblidx"); // New
	vecFieldName.push_back(L"bCan_Have_Option"); // New
	...
	vecFieldName.push_back(L"Can_Renwal"); //New
	vecFieldName.push_back(L"Contents_Tblidx");
	vecFieldName.push_back(L"Duration_Group");
	vecFieldName.push_back(L"Drop_Level"); // New
	vecFieldName.push_back(L"Create_Enchant_Rate_Tblidx"); // New
	vecFieldName.push_back(L"Excellent_Tblidx"); // New
	vecFieldName.push_back(L"Rare_Tblidx"); // New
	vecFieldName.push_back(L"Legendary_Tblidx"); // New
	vecFieldName.push_back(L"Create_Superior_Able"); // New
	vecFieldName.push_back(L"Create_Excellent_Able"); // New
	vecFieldName.push_back(L"Create_Rare_Able"); // New
	vecFieldName.push_back(L"Create_Legendary_Able"); // New
	vecFieldName.push_back(L"fAtk_Phy"); // New
	vecFieldName.push_back(L"fAtk_Eng"); // New
	vecFieldName.push_back(L"fDef_Phy"); // New
	vecFieldName.push_back(L"fDef_Eng"); // New
	vecFieldName.push_back(L"Scouteur_Parts_Type_2"); // New
	vecFieldName.push_back(L"Scouteur_Parts_Type_3"); // New
	vecFieldName.push_back(L"Scouteur_Parts_Type_4"); // New
	vecFieldName.push_back(L"TMP_Category_Type"); // New
	vecFieldName.push_back(L"Disassamble_BitFlag"); // New
	vecFieldName.push_back(L"Normal_Min"); // New
	vecFieldName.push_back(L"Normal_Max"); // New
	vecFieldName.push_back(L"Rank_Up_Min"); // New
	vecFieldName.push_back(L"Rank_Up_Max"); // New
}
...
void SetFieldNameList_PcTable(std::vector<std::wstring>& vecFieldName)
{
	...
	vecFieldName.push_back(L"Basic_Energy_Defence");
	vecFieldName.push_back(L"Weight_Limit");
	...
	vecFieldName.push_back(L"Child_Fly_Speed_Origin");
	vecFieldName.push_back(L"Child_Fly_Speed");
	vecFieldName.push_back(L"Adult_Fly_Speed_Origin");
	vecFieldName.push_back(L"Adult_Fly_Speed");
	vecFieldName.push_back(L"Child_Fly_Dash_Speed_Origin");
	vecFieldName.push_back(L"Child_Fly_Dash_Speed");
	vecFieldName.push_back(L"Adult_Fly_Dash_Speed_Origin");
	vecFieldName.push_back(L"Adult_Fly_Dash_Speed");
	vecFieldName.push_back(L"Child_Fly_Accel_Speed_Origin");
	vecFieldName.push_back(L"Child_Fly_Accel_Speed");
	vecFieldName.push_back(L"Adult_Fly_Accel_Speed_Origin");
	vecFieldName.push_back(L"Adult_Fly_Accel_Speed");
...
void SetFieldNameList_SystemEffectTable(std::vector<std::wstring>& vecFieldName)
{
	...
	vecFieldName.push_back(L"Is_Apply_Percentage");
}

void SetFieldNameList_DragonBallTable(std::vector<std::wstring>& vecFieldName)
{

	vecFieldName.clear();

	vecFieldName.push_back(L"Tblidx");
	vecFieldName.push_back(L"Altar_Group");
	vecFieldName.push_back(L"Ball_Type");
	vecFieldName.push_back(L"Ball_1_Tblidx");
	vecFieldName.push_back(L"Ball_2_Tblidx");
	vecFieldName.push_back(L"Ball_3_Tblidx");
	vecFieldName.push_back(L"Ball_4_Tblidx");
	vecFieldName.push_back(L"Ball_5_Tblidx");
	vecFieldName.push_back(L"Ball_6_Tblidx");
	vecFieldName.push_back(L"Ball_7_Tblidx");
	vecFieldName.push_back(L"Ball_Drop_Tblidx");
	vecFieldName.push_back(L"Ball_Junk_Tblidx");
	vecFieldName.push_back(L"Start_Dialog");
	vecFieldName.push_back(L"End_Dialog");
	vecFieldName.push_back(L"Hurry_Dialog");
	vecFieldName.push_back(L"Timeover_Dialog");
	vecFieldName.push_back(L"No_Repeat_Dialog");
	vecFieldName.push_back(L"Dragon_NPC_Tblidx");
	vecFieldName.push_back(L"Default_Summon_Chat");
	vecFieldName.push_back(L"Inventory_Full_Dialog");
	vecFieldName.push_back(L"Appear_Dir_X");
	vecFieldName.push_back(L"Appear_Dir_Z");
}

void SetFieldNameList_HLSItemTable(std::vector<std::wstring>& vecFieldName)
{
	vecFieldName.clear();
	vecFieldName.push_back(L"Tblidx");
	vecFieldName.push_back(L"Name_Text");
	...
	vecFieldName.push_back(L"Note");
	vecFieldName.push_back(L"Icon_Name");
	vecFieldName.push_back(L"CJI_Product_ID");
	vecFieldName.push_back(L"HLS_Item_Type");
	vecFieldName.push_back(L"HLS_Duration_Type");
	vecFieldName.push_back(L"HLS_Duration_Time");
	vecFieldName.push_back(L"Item_Tblidx");
	vecFieldName.push_back(L"On_Sale");
	vecFieldName.push_back(L"Sell_Type");
	vecFieldName.push_back(L"Cash");
	vecFieldName.push_back(L"Discount");
	vecFieldName.push_back(L"Item_Stack_Count");
	vecFieldName.push_back(L"Display_Bit_Flag");
	WCHAR wszBuffer[1024] = { 0x00, };
	WCHAR wszBuffer2[1024] = { 0x00, };
	for (int i = 0; i < DBO_MAX_COUNT_HLSITEM_SUB_ITEM; i++)
	{
		swprintf(wszBuffer, 1024, L"Sub_Item_Tblidx_%d", i + 1);
		vecFieldName.push_back(wszBuffer);
		swprintf(wszBuffer2, 1024, L"Sub_Item_Count_%d", i + 1);
		vecFieldName.push_back(wszBuffer2);
	}
	vecFieldName.push_back(L"Quick_Link");
	vecFieldName.push_back(L"Priority");
	vecFieldName.push_back(L"Display_Consume_Type");
	vecFieldName.push_back(L"Yardrat_Tab_Type");
}

void SetFieldNameList_ActionTable(std::vector<std::wstring>& vecFieldName)
{
	vecFieldName.clear();

	vecFieldName.push_back(L"Tblidx");
	vecFieldName.push_back(L"Validity_Able");
	vecFieldName.push_back(L"Action_Type");
	vecFieldName.push_back(L"Action_Name");
	vecFieldName.push_back(L"Icon_Name");
	vecFieldName.push_back(L"Note");
	vecFieldName.push_back(L"Chat_Command_Index");
	vecFieldName.push_back(L"ETC_Action_Type");
}
/////////////////////////////////////////////////////////////
...
*/
	...
	//fileNameList.SetFileName(CTableContainer::TABLE_MOB_SPAWN, "spawn_mob");
	...
	*/
	...
	//printf("==== Gametables Saved! ==== \n");


	if (byLoadMethod == CTable::eLOADING_METHOD::LOADING_METHOD_XML)
	{
		m_pTableContainer->SaveToFile(flagManager, &fileNameList, TRUE); // Save to EDF or RDF(False = RDF True = EDF)
		m_pTableContainer->SaveToFile(flagManager, &fileNameList, FALSE);
		printf("==== Gametables Saved! ==== \n");
	}
...
bool CRdf2XmlHelper::SaveToXml_MobTable(const char* pszPath)
{
	...
	for (iter = pMobTable->Begin(); pMobTable->End() != iter; iter++)
	{
		...
		AppendElementdwBF(pXMLDoc, pMobTableNode, L"Ai_Bit_Flag", pTableData->dwAi_Bit_Flag);
...
bool CRdf2XmlHelper::SaveToXml_NpcTable(const char* pszPath)
{
	if (pszPath == NULL)
	{
		return false;
	...
	CNPCTable* pNpcTable = m_pTableContainer->GetNpcTable();
	...
	strPathFilename += "\\Table_Npc_Data.xml";
	...
	// Createe Field-Name block
	std::vector<std::wstring> vecFieldName;
	SetFieldNameList_NpcTable(vecFieldName);
	AppendFieldNameBlockW(pXMLDoc, pRoot, vecFieldName);

	// Create Npc-Table XML blocks
	CTable::TABLE::iterator iter;
	MSXML2::IXMLDOMElementPtr pNpcTableNode;

	for (iter = pNpcTable->Begin(); pNpcTable->End() != iter; iter++)
	{
		sNPC_TBLDAT* pTableData = (sNPC_TBLDAT*)(iter->second);

		// NpcTable		
		AppendBlockElementW(pXMLDoc, pRoot, pNpcTableNode, L"Table_Data_KOR", NULL);
		if (pNpcTableNode == NULL)
		{
			printf("Failed to create NpcTable XML node.\n");
			return false;
		}

		AppendElementW(pXMLDoc, pNpcTableNode, L"TblIdx", pTableData->tblidx);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Validity_Able", pTableData->bValidity_Able ? 1 : 0);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Name", pTableData->Name);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Name_Text", pTableData->wszNameText);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Model", pTableData->szModel);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Level", pTableData->byLevel);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Job", pTableData->byJob);
		AppendElementdwBF(pXMLDoc, pNpcTableNode, L"Function_Bit_Flag", pTableData->dwAi_Bit_Flag);
		AppendElementdwBF(pXMLDoc, pNpcTableNode, L"Ai_Bit_Flag", pTableData->dwAi_Bit_Flag);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Dialog_Script_Index", pTableData->Dialog_Script_Index);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Battle_Attribute", pTableData->byBattle_Attribute);
		AppendElementW(pXMLDoc, pNpcTableNode, L"NPC_Type", pTableData->byNpcType);

		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_LP", pTableData->wBasic_LP);
		AppendElementW(pXMLDoc, pNpcTableNode, L"LP_Regeneration", pTableData->wLP_Regeneration);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_EP", pTableData->wBasic_EP);
		AppendElementW(pXMLDoc, pNpcTableNode, L"EP_Regeneration", pTableData->wEP_Regeneration);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Attack_Type", pTableData->byAttack_Type);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_Offence", pTableData->wBasic_Offence);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_Physical_Defence", pTableData->wBasic_Physical_Defence);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_Energy_Defence", pTableData->wBasic_Energy_Defence);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Str", pTableData->byStr);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Con", pTableData->byCon);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Foc", pTableData->byFoc);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Dex", pTableData->byDex);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Sol", pTableData->bySol);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Eng", pTableData->byEng);
		AppendElementW_f(pXMLDoc, pNpcTableNode, L"Scale", pTableData->fScale);
		AppendElementW_f(pXMLDoc, pNpcTableNode, L"Walk_Speed_Origin", pTableData->fWalk_Speed_Origin);
		AppendElementW_f(pXMLDoc, pNpcTableNode, L"Walk_Speed", pTableData->fWalk_Speed);
		AppendElementW_f(pXMLDoc, pNpcTableNode, L"RunSpeedOrigin", pTableData->fRun_Speed_Origin);
		AppendElementW_f(pXMLDoc, pNpcTableNode, L"RunSpeed", pTableData->fRun_Speed);
		AppendElementW_f(pXMLDoc, pNpcTableNode, L"Radius_X", pTableData->fRadius_X);
		AppendElementW_f(pXMLDoc, pNpcTableNode, L"Radius_Z", pTableData->fRadius_Z);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Attack_Speed_Rate", pTableData->wAttack_Speed_Rate);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Attack_Cool_Time", pTableData->wAttackCoolTime);
		AppendElementW_f(pXMLDoc, pNpcTableNode, L"AttackRange", pTableData->fAttack_Range);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_Attack_Rate", pTableData->wAttack_Rate);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_Dodge_Rate", pTableData->wDodge_Rate);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_Block_Rate", pTableData->wBlock_Rate);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_Curse_Success_Rate", pTableData->wCurse_Success_Rate);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_Curse_Tolerance_Rate", pTableData->wCurse_Tolerance_Rate);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Sight_Range", pTableData->bySight_Range);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Scan_Range", pTableData->byScan_Range);
		...
		for (int i = 0; i < NTL_MAX_NPC_HAVE_SKILL; i++)
		{
			...
			AppendElementW(pXMLDoc, pNpcTableNode, wszBuffer, pTableData->wUse_Skill_Time[i]);
		}
		...
		for (int i = 0; i < NTL_MAX_NPC_HAVE_SKILL; i++)
		{
			...
			AppendElementW(pXMLDoc, pNpcTableNode, wszBuffer, pTableData->use_Skill_Tblidx[i]);
		}
		...
		for (int i = 0; i < NTL_MAX_NPC_HAVE_SKILL; i++)
		{
			...
			AppendElementW(pXMLDoc, pNpcTableNode, wszBuffer, pTableData->byUse_Skill_Basis[i]);
		}
		...
		for (int i = 0; i < NTL_MAX_NPC_HAVE_SKILL; i++)
		{
			...
			AppendElementW(pXMLDoc, pNpcTableNode, wszBuffer, pTableData->wUse_Skill_LP[i]);
		}
		
		AppendElementW(pXMLDoc, pNpcTableNode, L"Visible_Sight_Range", pTableData->byVisible_Sight_Range);

		for (int i = 0; i < NTL_MAX_MERCHANT_TAB_COUNT; i++)
		{
			swprintf(wszBuffer, 50, L"Merchant_Tblidx_%d", i + 1);

			AppendElementW(pXMLDoc, pNpcTableNode, wszBuffer, pTableData->wUse_Skill_LP[i]);
		}

		AppendElementW(pXMLDoc, pNpcTableNode, L"Camera_Bone_Name", pTableData->szCamera_Bone_Name);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Status_Transform_Tblidx", pTableData->statusTransformTblidx);

		AppendElementW_f(pXMLDoc, pNpcTableNode, L"Fly_Height", pTableData->fFly_Height);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Spawn_Animation", pTableData->bSpawn_Animation ? 1 : 0);
		AppendElementW(pXMLDoc, pNpcTableNode, L"ILLust", pTableData->szILLust);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Contents_Tblidx", pTableData->contentsTblidx);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Dialog_Group", pTableData->dwDialogGroup);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Alliance_Idx", pTableData->dwAllianceIdx);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Aggro_Max_Count", pTableData->wAggroMaxCount);
		AppendElementW(pXMLDoc, pNpcTableNode, L"Basic_Aggro_Point", pTableData->wBasic_Aggro_Point);
		
		// Add a line feed
		pNpcTableNode->appendChild(pXMLDoc->createTextNode("\n\t"));
		pNpcTableNode = NULL;
	}
...
bool CRdf2XmlHelper::SaveToXml_ItemTable(const char* pszPath)
{
	...
	for (iter = pItemTable->Begin(); pItemTable->End() != iter; iter++)
	{
		...
		AppendElementdwBF(pXMLDoc, pItemTableNode, L"Equip_Slot_Type_Bit_Flag", pTableData->wEquip_Slot_Type_Bit_Flag);
		AppendElementwBF(pXMLDoc, pItemTableNode, L"Function_Bit_Flag", pTableData->wFunction_Bit_Flag);
		AppendElementW(pXMLDoc, pItemTableNode, L"Restrict_Type", pTableData->byRestrictType);// New
		...
		AppendElementW(pXMLDoc, pItemTableNode, L"Weight", pTableData->wWeight);// New
		...
		AppendElementW(pXMLDoc, pItemTableNode, L"Drop_Visual", pTableData->byDropVisual);// New
...
//		AppendElementW(pXMLDoc, pItemTableNode, L"Energy_DefenceUpgrade", pTableData->dwEnergy_DefenceUpgrade);
		...
		AppendElementW(pXMLDoc, pItemTableNode, L"Need_Max_Level", pTableData->byNeed_Max_Level); // New
		AppendElementdwBF(pXMLDoc, pItemTableNode, L"Need_Class_Bit_Flag", pTableData->dwNeed_Class_Bit_Flag);
		AppendElementdwBF(pXMLDoc, pItemTableNode, L"Need_Gender_Bit_Flag", pTableData->dwNeed_Gender_Bit_Flag); // New
		...
		AppendElementW(pXMLDoc, pItemTableNode, L"Scouter_Parts_Type_1", pTableData->byScouter_Parts_Type); // Changed Type to Type_1
//		AppendElementW(pXMLDoc, pItemTableNode, L"Scouter_Parts_Value", pTableData->byScouter_Parts_Value);
		...
		AppendElementW(pXMLDoc, pItemTableNode, L"bCan_Have_Option", pTableData->bCanHaveOption ? 1 : 0); // New
		...
		AppendElementwBF(pXMLDoc, pItemTableNode, L"Costume_Hide_Bit_Flag", pTableData->wCostumeHideBitFlag);
		...
		AppendElementW(pXMLDoc, pItemTableNode, L"Can_Renewal", pTableData->bCanRenew ? 1 : 0); // New
		...
		AppendElementW(pXMLDoc, pItemTableNode, L"Drop_Level", pTableData->dropLevel); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Create_Enchant_Rate_Tblidx", pTableData->CreateEnchanteRateTblidx); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Excellent_Tblidx", pTableData->ExcellentTblidx); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Rare_Tblidx", pTableData->RareTblidx); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Legendary_Tblidx", pTableData->LegendaryTblidx); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Create_Superior_Able", pTableData->CreateSuperiorAble ? 1 : 0); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Create_Excellent_Able", pTableData->CreateExcellentAble ? 1 : 0); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Create_Rare_Able", pTableData->CreateRareAble ? 1 : 0); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Create_Legendary_Able", pTableData->CreateLegendaryAble ? 1 : 0); // New
		AppendElementW_f(pXMLDoc, pItemTableNode, L"fAtk_Phy", pTableData->fAtkPhy); // New
		AppendElementW_f(pXMLDoc, pItemTableNode, L"fAtk_Eng", pTableData->fAtkEng); // New
		AppendElementW_f(pXMLDoc, pItemTableNode, L"fDef_Phy", pTableData->fDefPhy); // New
		AppendElementW_f(pXMLDoc, pItemTableNode, L"fDef_Eng", pTableData->fDefEng); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Scouter_Parts_Type_2", pTableData->ScouterPartsType2); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Scouter_Parts_Type_3", pTableData->ScouterPartsType3); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Scouter_Parts_Type_4", pTableData->ScouterPartsType4); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"TMP_Category_Type", pTableData->TMPCategoryType); // New
		AppendElementdwBF(pXMLDoc, pItemTableNode, L"Disassamble_Bit_Flag", pTableData->DisassembleBitFlag); //New
		AppendElementW(pXMLDoc, pItemTableNode, L"Normal_Min", pTableData->NormalMin); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Normal_Max", pTableData->NormalMax); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Rank_Up_Min", pTableData->RankupMin); // New
		AppendElementW(pXMLDoc, pItemTableNode, L"Rank_Up_Max", pTableData->RankupMax); // New
...
bool CRdf2XmlHelper::SaveToXml_SkillTable(const char* pszPath)
{
	...
	for (iter = pSkillTable->Begin(); pSkillTable->End() != iter; iter++)
	{
		...
		AppendElementdwBF(pXMLDoc, pSkillTableNode, L"PC_Class_Bit_Flag", pTableData->dwPC_Class_Bit_Flag);
		...
		AppendElementdwBF(pXMLDoc, pSkillTableNode, L"Function_Bit_Flag", pTableData->wFunction_Bit_Flag);
		...
		AppendElementdwBF(pXMLDoc, pSkillTableNode, L"Transform_Use_Info_Bit_Flag", pTableData->dwTransform_Use_Info_Bit_Flag);
...
bool CRdf2XmlHelper::SaveToXml_PcTable(const char* pszPath)
{
	...
	for (iter = pPcTable->Begin(); pPcTable->End() != iter; iter++)
	{
		...
		AppendElementdwBF(pXMLDoc, pPcTableNode, L"Class_Bit_Flag", pTableData->dwClass_Bit_Flag);
		...
		//AppendElementW(pXMLDoc, pPcTableNode, L"Weight_Limit", pTableData->dwWeight_Limit);
		...
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Child_Fly_Speed_Origin", pTableData->fChild_Fly_Speed_Origin);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Child_Fly_Speed", pTableData->fChild_Fly_Speed);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Adult_Fly_Speed_Origin", pTableData->fAdult_Fly_Speed_Origin);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Adult_Fly_Speed", pTableData->fAdult_Fly_Speed);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Child_Fly_Dash_Speed_Origin", pTableData->fChild_Fly_Dash_Speed_Origin);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Child_Fly_Dash_Speed", pTableData->fChild_Fly_Dash_Speed);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Adult_Fly_Dash_Speed_Origin", pTableData->fAdult_Fly_Dash_Speed_Origin);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Adult_Fly_Dash_Speed", pTableData->fAdult_Fly_Dash_Speed);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Child_Fly_Accel_Speed_Origin", pTableData->fChild_Fly_Accel_Speed_Origin);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Child_Fly_Accel_Speed", pTableData->fChild_Fly_Accel_Speed);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Adult_Fly_Accel_Speed_Origin", pTableData->fAdult_Fly_Accel_Speed_Origin);
		AppendElementW_f(pXMLDoc, pPcTableNode, L"Adult_Fly_Accel_Speed", pTableData->fAdult_Fly_Accel_Speed);
...
bool CRdf2XmlHelper::SaveToXml_WorldTable(const char* pszPath)
{
	...
	for (iter = pWorldTable->Begin(); pWorldTable->End() != iter; iter++)
	{
		...
		AppendElementdwBF(pXMLDoc, pWorldTableNode, L"funcflag", pTableData->wFuncFlag);
...
bool CRdf2XmlHelper::SaveToXml_LandMarkTable(const char* pszPath)
{
	...
	for (iter = pLandmarkTable->Begin(); pLandmarkTable->End() != iter; iter++)
	{
		...
		AppendElementwBF(pXMLDoc, pLandmarkTableNode, L"Landmark_BitFlag", pTableData->byLandmarkBitflag);
		AppendElementwBF(pXMLDoc, pLandmarkTableNode, L"Landmark_Display_BitFlag", pTableData->byLandmarkDisplayBitFlag);
...
bool CRdf2XmlHelper::SaveToXml_WorldZoneTable(const char* pszPath)
{
	...
	for (iter = pWorldZoneTable->Begin(); pWorldZoneTable->End() != iter; iter++)
	{
		...
		AppendElementwBF(pXMLDoc, pWorldZoneTableNode, L"Function_Bit_Flag", pTableData->wFunctionBitFlag);
...
bool CRdf2XmlHelper::SaveToXml_DirectionLinkTable(const char* pszPath)
{
	...
	for (iter = pDirectionLinkTable->Begin(); pDirectionLinkTable->End() != iter; iter++)
	{
		...
		AppendElementwBF(pXMLDoc, pDirectionLinkTableNode, L"Direction_Func_Flag", pTableData->byFuncFlag);
...
bool CRdf2XmlHelper::SaveToXml_SystemEffectTable(const char* pszPath)
{
	...
	for (iter = pSystemEffectTable->Begin(); pSystemEffectTable->End() != iter; iter++)
	{
		...
		//AppendElementW(pXMLDoc, pSystemEffectTableNode, L"Is_Apply_Percentage", pTableData->bIsApplyPercentage);
...
bool CRdf2XmlHelper::SaveToXml_DragonBallTable(const char* pszPath)
{
	if (pszPath == NULL)
	{
		return false;
	...
	CDragonBallTable* pDragonBallTable = m_pTableContainer->GetDragonBallTable();

	if (pDragonBallTable == NULL)
	{
		printf("No DragonBallTable.\n");
		return false;
	}
	...
	strPathFilename += "\\Table_Dragon_Ball_Data.xml";
	...
	// Createe Field-Name block
	std::vector<std::wstring> vecFieldName;
	SetFieldNameList_DragonBallTable(vecFieldName);
	AppendFieldNameBlockW(pXMLDoc, pRoot, vecFieldName);

	// Create Mob-Table XML blocks
	CTable::TABLE::iterator iter;
	MSXML2::IXMLDOMElementPtr pDragonBallTableNode;

	for (iter = pDragonBallTable->Begin(); pDragonBallTable->End() != iter; iter++)
	{
		sDRAGONBALL_TBLDAT* pTableData = (sDRAGONBALL_TBLDAT*)(iter->second);

		// ObjectTable		
		AppendBlockElementW(pXMLDoc, pRoot, pDragonBallTableNode, L"Table_Data_KOR", NULL);
		if (pDragonBallTableNode == NULL)
		{
			printf("Failed to create DragonBall XML node.\n");
			return false;
		}

		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Tblidx", pTableData->tblidx);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Altar_Group", pTableData->dwAltarGroup);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Ball_Type", pTableData->byBallType);

		WCHAR wszBuffer[1024] = { 0x00, };
		for (int i = 0; i < NTL_ITEM_MAX_DRAGONBALL; i++)
		{
			swprintf(wszBuffer, 1024, L"Ball_%d_Tblidx", i + 1);
			AppendElementW(pXMLDoc, pDragonBallTableNode, wszBuffer, pTableData->aBallTblidx[i]);
		}
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Ball_Drop_Tblidx", pTableData->ballDropTblidx);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Ball_Junk_Tblidx", pTableData->ballJunkTblidx);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Start_Dialog", pTableData->startDialog);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"End_Dialog", pTableData->endDialog);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Hurry_Dialog", pTableData->hurryDialog);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Timeover_Dialog", pTableData->timeoverDialog);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"No_Repeat_Dialog", pTableData->noRepeatDialog);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Dragon_NPC_Tblidx", pTableData->dragonNPCTblidx);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Default_Summon_Chat", pTableData->defaultSummonChat);
		AppendElementW(pXMLDoc, pDragonBallTableNode, L"Inventory_Full_Dialog", pTableData->inventoryFullDialog);
		AppendElementW_f(pXMLDoc, pDragonBallTableNode, L"Appear_Dir_X", pTableData->fDir.x);
		AppendElementW_f(pXMLDoc, pDragonBallTableNode, L"Appear_Dir_Z", pTableData->fDir.z);

		// Add a line feed
		pDragonBallTableNode->appendChild(pXMLDoc->createTextNode("\n\t"));
		pDragonBallTableNode = NULL;
	}
...
bool CRdf2XmlHelper::SaveToXml_HLSItemTable(const char* pszPath)
{
	if (pszPath == NULL)
	{
		return false;
	...
	CHLSItemTable* pHlsTable = m_pTableContainer->GetHLSItemTable();


	if (pHlsTable == NULL)
	{
		printf("No HLSItemTable.\n");
		return false;
	}
	...
	strPathFilename += "\\Table_HLS_Item_Data.xml";
	...
	// Createe Field-Name block
	std::vector<std::wstring> vecFieldName;
	SetFieldNameList_HLSItemTable(vecFieldName);
	AppendFieldNameBlockW(pXMLDoc, pRoot, vecFieldName);
	...
	for (iter = pHlsTable->Begin(); pHlsTable->End() != iter; iter++)
	{
		...
		if (pMobTableNode == NULL)
		{
			printf("Failed to create HLSItemTable XML node.\n");
			return false;
		}

		AppendElementW(pXMLDoc, pMobTableNode, L"Tblidx", pTableData->tblidx);
		AppendElementW(pXMLDoc, pMobTableNode, L"Name_Text", pTableData->wszName);
		AppendElementW(pXMLDoc, pMobTableNode, L"Name", pTableData->Name);
		AppendElementW(pXMLDoc, pMobTableNode, L"Note", pTableData->Note);
		AppendElementW(pXMLDoc, pMobTableNode, L"Icon_Name", pTableData->wszIcon);
		AppendElementW(pXMLDoc, pMobTableNode, L"CJI_Product_ID", pTableData->wszCJIProductID);
		AppendElementW(pXMLDoc, pMobTableNode, L"HLS_Item_Type", pTableData->wHLSItemType);
		AppendElementW(pXMLDoc, pMobTableNode, L"HLS_Duration_Type", pTableData->byHLSDurationType);
		AppendElementW(pXMLDoc, pMobTableNode, L"HLS_Duration_Time", pTableData->dwHLSDurationTime);
		AppendElementW(pXMLDoc, pMobTableNode, L"Item_Tblidx", pTableData->dwItemTblidx);
		AppendElementW(pXMLDoc, pMobTableNode, L"On_Sale", pTableData->bOnSale);
		AppendElementW(pXMLDoc, pMobTableNode, L"Sell_Type", pTableData->bySellType);
		AppendElementW(pXMLDoc, pMobTableNode, L"Cash", pTableData->wCash);
		AppendElementW(pXMLDoc, pMobTableNode, L"Discount", pTableData->byDiscount);
		AppendElementW(pXMLDoc, pMobTableNode, L"Item_Stack_Count", pTableData->byStackCount);
		AppendElementW(pXMLDoc, pMobTableNode, L"Display_Bit_Flag", pTableData->wDisplayBitFlag);
		WCHAR wszBuffer[1024] = { 0x00, };
		WCHAR wszBuffer2[1024] = { 0x00, };
		for (int i = 0; i < DBO_MAX_COUNT_HLSITEM_SUB_ITEM; i++)
		{
			swprintf(wszBuffer, 1024, L"Sub_Item_Tblidx_%d", i + 1);
			AppendElementW(pXMLDoc, pMobTableNode, wszBuffer, pTableData->asSubItem[i].itemTblidx);

			swprintf(wszBuffer2, 1024, L"Sub_Item_Count_%d", i + 1);
			AppendElementW(pXMLDoc, pMobTableNode, wszBuffer2, pTableData->asSubItem[i].byStackCount);
		}

		AppendElementW(pXMLDoc, pMobTableNode, L"Quick_Link", pTableData->byQuickLink);
		AppendElementW(pXMLDoc, pMobTableNode, L"Priority", pTableData->byPriority);
		AppendElementW(pXMLDoc, pMobTableNode, L"Display_Consume_Type", pTableData->byDisplayConsumeType);
		AppendElementW(pXMLDoc, pMobTableNode, L"Yardrat_Tab_Type", pTableData->byYardratTabType);
		// Add a line feed
		pMobTableNode->appendChild(pXMLDoc->createTextNode("\n\t"));
		pMobTableNode = NULL;
	}
...
bool CRdf2XmlHelper::SaveToXml_ActionTable(const char* pszPath)
{
	if (pszPath == NULL)
	{
		return false;
	...
	CActionTable* pActionTable = m_pTableContainer->GetActionTable();

	if (pActionTable == NULL)
	{
		printf("No ActionTable .\n");
		return false;
	}
	...
	strPathFilename += "\\Table_Action_Data.xml";
	...
	// Createe Field-Name block
	std::vector<std::wstring> vecFieldName;
	SetFieldNameList_ActionTable(vecFieldName);
	AppendFieldNameBlockW(pXMLDoc, pRoot, vecFieldName);

	// Create Exp-Table XML blocks
	CTable::TABLE::iterator iter;
	MSXML2::IXMLDOMElementPtr pActionTableNode;

	for (iter = pActionTable->Begin(); pActionTable->End() != iter; iter++)
	{
		sACTION_TBLDAT* pTableData = (sACTION_TBLDAT*)(iter->second);

		// ExpTable		
		AppendBlockElementW(pXMLDoc, pRoot, pActionTableNode, L"Table_Data_KOR", NULL);
		if (pActionTableNode == NULL)
		{
			printf("Failed to create ExpTable XML node.\n");
			return false;
		}

		AppendElementW(pXMLDoc, pActionTableNode, L"Tblidx", pTableData->tblidx);
		AppendElementW(pXMLDoc, pActionTableNode, L"Validity_Able", pTableData->bValidity_Able);
		AppendElementW(pXMLDoc, pActionTableNode, L"Action_Type", pTableData->byAction_Type);
		AppendElementW(pXMLDoc, pActionTableNode, L"Action_Name", pTableData->Action_Name);
		AppendElementW(pXMLDoc, pActionTableNode, L"Icon_Name", pTableData->szIcon_Name);
		AppendElementW(pXMLDoc, pActionTableNode, L"Note", pTableData->Note);
		AppendElementW(pXMLDoc, pActionTableNode, L"Chat_Command_Index", pTableData->chat_Command_Index);
		AppendElementW(pXMLDoc, pActionTableNode, L"ETC_Action_Type", pTableData->byETC_Action_Type);


		// Add a line feed
		pActionTableNode->appendChild(pXMLDoc->createTextNode("\n\t"));
		pActionTableNode = NULL;
	}
...
bool CRdf2XmlHelper::SaveToBinary_SkillTable(const char* pszPath)
{
	...
	strPathFilename += "\\Table_Skill_DataFromMethod.rdf";
...
bool CRdf2XmlHelper::SaveToBinary_HLSItemTable(const char* pszPath)
{
	if (pszPath == NULL)
	{
		return false;
	...
	CHLSItemTable* pHLSItemTable = m_pTableContainer->GetHLSItemTable();

	if (pHLSItemTable == NULL)
	{
		printf("No pHLSItemTable.\n");
		return false;
	}
	...
	strPathFilename += "\\Table_HLS_Item_Data.rdf";

	printf("Generating %s ...\n", strPathFilename.c_str());

	CNtlFileSerializer serializer;
	pHLSItemTable->SaveToBinary(serializer);
	serializer.SaveFile((char *)strPathFilename.c_str());
...
bool CRdf2XmlHelper::SaveToBinary_SystemEffectTable(const char* pszPath)
{
	if (pszPath == NULL)
	{
		return false;
	...
	CSystemEffectTable* pSystemEffectTable = m_pTableContainer->GetSystemEffectTable();
	CTextTable* pSystemEffectText = m_pTableContainer->GetTextAllTable()->GetSystemEffectTbl();
	...
	strPathFilename += "\\Table_System_Effect_Data.rdf";

	printf("Generating %s ...\n", strPathFilename.c_str());


	for (CSystemEffectTable::TABLEIT it = pSystemEffectTable->Begin(); it != pSystemEffectTable->End(); ++it)
	{
		std::wstring wstrText = L"";
		WCHAR buf[256];
		sSYSTEM_EFFECT_TBLDAT* pSystemEffectTbldat = reinterpret_cast<sSYSTEM_EFFECT_TBLDAT*>(it->second);
		wstrText = pSystemEffectText->GetText(pSystemEffectTbldat->Effect_Info_Text);
		if (!wstrText.empty())
		{
			WCHAR* szFormat = L"%d";
			size_t nInsertPosition = wstrText.find(szFormat);
//			pSystemEffectTbldat->bIsApplyPercentage = false;

			if ((size_t)nInsertPosition == std::wstring::npos)
			{
				szFormat = L"%g";
				nInsertPosition = wstrText.find(szFormat);
			}

			swprintf_s(buf, 256, wstrText.c_str(), 123);
			
			wstrText = buf;

			WCHAR* szFormatA = L"%";
			size_t nFindPosition = wstrText.find(szFormatA);

			if (nFindPosition != std::string::npos)
			{				
//				pSystemEffectTbldat->bIsApplyPercentage = true;
			}
		}
	}

	CNtlFileSerializer serializer;
	pSystemEffectTable->SaveToBinary(serializer);
	serializer.SaveFile((char *)strPathFilename.c_str());

	printf("Generating %s complete.\n", strPathFilename.c_str());
}

bool CRdf2XmlHelper::SaveToBinary_ActionTable(const char* pszPath)
{
	if (pszPath == NULL)
	{
		return false;
	...
	strPathFilename += "\\Table_Action_Data.rdf";

	printf("Generating %s ...\n", strPathFilename.c_str());

	CNtlFileSerializer serializer;
	pActionTable->SaveToBinary(serializer);
	serializer.SaveFile((char *)strPathFilename.c_str());
