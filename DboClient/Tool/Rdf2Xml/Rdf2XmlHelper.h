...
public:
	...
	bool SaveToXml_NpcTable(const char* pszPath);
	...
	bool SaveToXml_DragonBallTable(const char* pszPath);
	bool SaveToXml_HLSItemTable(const char* pszPath);

	bool SaveToXml_ActionTable(const char * pszPath);
	...
	bool SaveToBinary_SystemEffectTable(const char * pszPath);
	bool SaveToBinary_ActionTable(const char * pszPath);
	bool SaveToBinary_PortalTable(const char* pszPath);
	bool SaveToBinary_HLSItemTable(const char* pszPath);
