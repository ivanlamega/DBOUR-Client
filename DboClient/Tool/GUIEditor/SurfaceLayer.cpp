...
void CSurfaceLayer::OnInitialUpdate()
{
	...
	m_RollUpCtrl.InsertPage( L"Rect Info", IDD_RECTINFODLG, RUNTIME_CLASS( CRectInfoDlg ) );
	m_RollUpCtrl.InsertPage( L"Surface List", IDD_SURFACELISTDLG, RUNTIME_CLASS( CSurfaceListDlg ) );
	m_RollUpCtrl.InsertPage( L"Surface Attribute", IDD_SURFACEATTRIBUTEDLG, RUNTIME_CLASS( CSurfaceAttributeDlg ) );
	m_RollUpCtrl.InsertPage( L"File View", IDD_FILEVIEWDLG, RUNTIME_CLASS( CFileViewDlg ) );
