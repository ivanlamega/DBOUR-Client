...
void CSizingTabCtrlBar::DoDataExchange(CDataExchange* pDX)
{
...
int CSizingTabCtrlBar::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	m_images.Create(IDB_TABIMAGE, 32, 1, RGB(255,0,255));
...
//			pMainFrame->SetActiveView (pView);
	...
	wcscpy_s(pMember->szLabel, 32, lpszLabel);
#else
...
BOOL CSizingTabCtrlBar::OnEraseBkgnd(CDC* pDC)
{
	//if (GetActiveView())
        //GetActiveView()->RedrawWindow();//>Invalidate(TRUE);
		
	return CWnd::OnEraseBkgnd(pDC);
}

void CSizingTabCtrlBar::OnPaint()
{	
	CSizingControlBar::OnPaint();
}

void CSizingTabCtrlBar::OnMouseMove(UINT nFlags, CPoint point) 
{
	 // Minimap drag process...
	 
	 // else...
	 CSizingControlBar::OnMouseMove(nFlags, point);	 
}

void CSizingTabCtrlBar::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
	// Minimap dbl click
	// else....
...
void CSizingTabCtrlBar::OnLButtonDown(UINT nFlags, CPoint point)
{
	 // Minimap lclk process...
	 //else 
	 {		 
...
void CSizingTabCtrlBar::OnLButtonUp(UINT nFlags, CPoint point)
{
	 // Minimap lup process...
	 // else...
...
void CSizingTabCtrlBar::OnRButtonDown(UINT nFlags, CPoint point)
{
	 
	 CSizingControlBar::OnRButtonDown(nFlags, point);
}

void CSizingTabCtrlBar::OnRButtonUp(UINT nFlags, CPoint point)
{
...
void CSizingTabCtrlBar::OnWindowPosChanged(WINDOWPOS FAR* lpwndpos) 
{
