...
void CResourceLayer::OnInitialUpdate()
{
	...
	m_RollUpCtrl.InsertPage( L"Resource List", IDD_RESOURCELISTDLG, RUNTIME_CLASS( CResourceListDlg ) );
	m_RollUpCtrl.InsertPage( L"Resource Attribute", IDD_RESOURCEATTRIBUTEDLG, RUNTIME_CLASS( CResourceAttributeDlg ) );
