...
void CMainFrame::InitCtrlBar()
{
	...
	m_wndLayerBar.AddView( L"ResourceLayer", RUNTIME_CLASS( CResourceLayer ) );
	m_wndLayerBar.AddView( L"SurfaceLayer", RUNTIME_CLASS( CSurfaceLayer ) );
...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	if (!RwEngineInit(NULL, rwENGINEINITNOFREELISTS, (4 << 20)))
	{
		return FALSE;
	}
