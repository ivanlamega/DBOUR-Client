...
void CResourceAttributeDlg::OnBnClickedFixResourcelist()
{
	...
	if( nFocusID < 1 )
	{
		AfxMessageBox( L"수정할 아이템을 클릭하세요" );
		return;
	}
