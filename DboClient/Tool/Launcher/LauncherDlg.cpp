...
BOOL CLauncherDlg::OnInitDialog()
{
    ...
    MoveWindow(nScreenX, nScreenY, 1920, 1080);
    ...
    m_ButtonGameStart.MoveWindow(835, 660, 85, 85);

    m_nIDProgress1 = AddBitmap(IDB_PROGRESS,115, 694, 676 ,7);
    m_nIDProgress2 = AddBitmap(IDB_PROGRESS,115, 724, 676 ,7);

    SetBltRateX(m_nIDProgress1, 0, MAX_PROGRESS_RANGE);
    SetBltRateX(m_nIDProgress2, 0, MAX_PROGRESS_RANGE);
    
    m_StaticFileDown.MoveWindow(115, 670, 676, 14);
    m_StaticFIlePatch.MoveWindow(115, 714, 676, 14);
    m_StaticInfoOutput.MoveWindow(0, 2, 640, 14);        
    m_StaticLog.MoveWindow(650, 665, 483, 14);    
