...
void CMPPSetItemPane::OnInitialUpdate()
{
    ...
    m_cbTeleSelect.InsertString(MPP_TELE_YAHOI, L"Yahoi Town");
    m_cbTeleSelect.InsertString(MPP_TELE_YUREKA, L"Eureka Park");
    m_cbTeleSelect.InsertString(MPP_TELE_DALPANG, L"Dalpang");
    m_cbTeleSelect.InsertString(MPP_TELE_DRAGON, L"Dragon");
    m_cbTeleSelect.InsertString(MPP_TELE_BAEE, L"Village to Ship");
    m_cbTeleSelect.InsertString(MPP_TELE_AJIRANG, L"Mirage Sam");
    m_cbTeleSelect.InsertString(MPP_TELE_KARINGA_1, L"Karinga Village 1");
    m_cbTeleSelect.InsertString(MPP_TELE_KARINGA_2, L"Karinga Village 2");
    m_cbTeleSelect.InsertString(MPP_TELE_GREAT_TREE, L"Great Tree");
    m_cbTeleSelect.InsertString(MPP_TELE_KARINGA_3, L"Karinga Fishing Village");
    m_cbTeleSelect.InsertString(MPP_TELE_MERMAID, L"Mermaid");
    m_cbTeleSelect.InsertString(MPP_TELE_GANNET, L"Garnet Observatory");
    m_cbTeleSelect.InsertString(MPP_TELE_EMERALD, L"Emerald Beach");
    m_cbTeleSelect.InsertString(MPP_TELE_TEMBARIN, L"Interment Camp");
    m_cbTeleSelect.InsertString(MPP_TELE_CELL, L"Cell Games Arena");
    m_cbTeleSelect.InsertString(MPP_TELE_BUU, L"Buu Memorial Hall");
    m_cbTeleSelect.InsertString(MPP_TELE_CC, L"CC History Museum");
    m_cbTeleSelect.InsertString(MPP_TELE_MUSHROOM, L"Mushroom Village");
}
