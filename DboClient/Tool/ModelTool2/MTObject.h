...
#define OBJECT_MESH_PATH    L"\\Object\\Mesh\\"
#define OBJECT_TEXTURE_PATH L"\\Texture\\Object\\;"
...
public:
    ...
    virtual int	   CallBackBaseAnim(RwUInt32 uiEventData);	            	///< Animation Event의 CallBack 함수    
