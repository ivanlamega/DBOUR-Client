...
protected:
    void    OnDataUpdate();
    void    OnDisplayMaterialInfo(WCHAR* szMaterialName);    
...
protected:
	...
	CListBox m_listBoxMaterialFlags;
	CButton m_btnFlagSet;
	CComboBox m_groupFlag;
public:
...
public:
	afx_msg void OnBtnClickedSetFlag();
	void fillComboBox();
};
