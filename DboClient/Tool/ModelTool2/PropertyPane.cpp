...
#define EFFECT_HIT_WORD_PREFIX          L"TXT_"          ///< Word Effect의 Prefix
#define EFFECT_POST_EFFECT_PREFIX       L"POST_"         ///< Post Effect의 Prefix   
...
void CPropertyPane::OnInitialUpdate()
{
    ...
    if(m_property.Create(rc, this, IDC_PROPERTY_GRID))
    {
        ...
        m_property.ShowHelp(TRUE);
        m_property.HighlightChangedItems(TRUE);

        // Create Hit Event Category
        m_pCatHitEvent = m_property.AddCategory(L"HitEvent Properties");
        
        // Add Child Items to Hit Event
         m_pItemTime              = (CCustomItemSpinDouble*)m_pCatHitEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));                  
         m_pItemPowerEffect       = (CXTPPropertyGridItemBool*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemBool(L"PowerEffect", TRUE));                 
         m_pItemTargetBehavior    = (CXTPPropertyGridItemEnum*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"TargetBehavior"));
         m_pItemKB2Push           = (CXTPPropertyGridItemBool*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemBool(L"KB to Push"));
         m_pItemHandType          = (CXTPPropertyGridItemEnum*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"HandType"));
         m_pItemProjectileName    = m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItem(L"ProjectileEffect Name"));
         m_pItemProjectileType    = (CXTPPropertyGridItemEnum*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"ProjectileType"));
         m_pItemProjectileShot    = (CXTPPropertyGridItemEnum*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Projectile Shot Type"));
         m_pItemBoneName          = m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItem(L"BoneName"));         
         m_pItemSubWeaponBoneFlag = (CXTPPropertyGridItemFlags*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemFlags(L"SubWeapon Bone"));
         m_pItemProjSpeed         = (CCustomItemSpinDouble*)m_pCatHitEvent->AddChildItem(new CCustomItemSpinDouble(L"Projectile Speed"));         
         m_pItemTargetAttach	  = (CXTPPropertyGridItemBool*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemBool(L"Target Attach"));
         m_pItemTargetEffectName  = m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItem(L"TargetEffect Name"));      
		 m_pItemTargetEffectType  = (CXTPPropertyGridItemEnum*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"TargetEffect Type"));
         m_pItemSubTargetEffect   = m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItem(L"Sub Target Effect"));
         m_pItemTargetHeight      = (CCustomItemSpinDouble*)m_pCatHitEvent->AddChildItem(new CCustomItemSpinDouble(L"Target Height"));
         m_pItemTargetSoundName   = (CCustomItemFileBox*)m_pCatHitEvent->AddChildItem(new CCustomItemFileBox(L"TargetSound Name", FILTER_SOUND));
         m_pItemSoundType         = (CXTPPropertyGridItemEnum*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"TargetSound Type"));
         m_pItemHitSoundEcho      = (CXTPPropertyGridItemBool*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemBool(L"Hit Sound Echo"));
         m_pItemWordEffect        = m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItem(L"Word Effect"));
         m_pItemCameraShake       = (CXTPPropertyGridItemBool*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemBool(L"Camera Shake"));
         m_pItemShakeFactor       = (CCustomItemSpinDouble*)m_pItemCameraShake->AddChildItem(new CCustomItemSpinDouble(L"Shake Factor"));
         m_pItemShakeMaxHeight    = (CCustomItemSpinDouble*)m_pItemCameraShake->AddChildItem(new CCustomItemSpinDouble(L"Shake Max Height Factor"));
         m_pHitHosidanOffset      = (CCustomItemOffset*)m_pCatHitEvent->AddChildItem(new CCustomItemOffset(L"Target Effect Offset"));
         m_pHitHosidanWaitTime    = (CCustomItemSpinDouble*)m_pCatHitEvent->AddChildItem(new CCustomItemSpinDouble(L"Target Effect Start WaitTIme"));
         m_pHitHosidanSpeed       = (CCustomItemSpinDouble*)m_pCatHitEvent->AddChildItem(new CCustomItemSpinDouble(L"Target Effect Speed"));
         m_pHitHissidanApplyAngle = (CXTPPropertyGridItemBool*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemBool(L"Hissidan Apply Angle"));
         m_pHitHissidianDirection = (CCustomItemOffset*)m_pCatHitEvent->AddChildItem(new CCustomItemOffset(L"Hissidan Start Direction", CCustomItemOffset::TYPE_XY));
         m_pHitMultiHissidanCount = (CXTPPropertyGridItemNumber*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemNumber(L"Multi Hissidan Count"));
         m_pHitMultiHissidanIndex = (CXTPPropertyGridItemEnum*)m_pCatHitEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Multi Hissidan Index"));
         m_pHitMultiHissidanDir   = (CCustomItemOffset*)m_pCatHitEvent->AddChildItem(new CCustomItemOffset(L"Multi Hissidan Dir", CCustomItemOffset::TYPE_XY));
        
         m_pItemTargetBehavior->GetConstraints()->AddConstraint(L"None", TARGET_BEHAVIOR_NONE);
         m_pItemTargetBehavior->GetConstraints()->AddConstraint(L"Push", TARGET_BEHAVIOR_PUSH);
         m_pItemTargetBehavior->GetConstraints()->AddConstraint(L"Toss", TARGET_BEHAVIOR_TOSS);
         m_pItemTargetBehavior->GetConstraints()->AddConstraint(L"Fall Down", TARGET_BEHAVIOR_FALL_DOWN);
         m_pItemTargetBehavior->GetConstraints()->AddConstraint(L"Knock Down", TARGET_BEHAVIOR_KNOCK_DOWN);
         m_pItemHandType->GetConstraints()->AddConstraint(L"Left Hand", HAND_TYPE_LEFT);
         m_pItemHandType->GetConstraints()->AddConstraint(L"Right Hand", HAND_TYPE_RIGHT);
         m_pItemSoundType->GetConstraints()->AddConstraint(L"Effect", CHANNEL_GROUP_EFFECT_SOUND);
         m_pItemSoundType->GetConstraints()->AddConstraint(L"Voice", CHANNEL_GROUP_VOICE_SOUND);
         m_pItemProjectileShot->GetConstraints()->AddConstraint(L"Character", BONE_CHARACTER);
         m_pItemProjectileShot->GetConstraints()->AddConstraint(L"Weapon", BONE_WEAPON);
         m_pItemProjectileShot->GetConstraints()->AddConstraint(L"Sub Weapon", BONE_SUB_WEAPON);
         m_pItemSubWeaponBoneFlag->GetConstraints()->AddConstraint(L"All SubWeapon Bone", SUB_WEAPON_PROJECTILE_1 + SUB_WEAPON_PROJECTILE_2 + SUB_WEAPON_PROJECTILE_3);
         m_pItemSubWeaponBoneFlag->GetConstraints()->AddConstraint(L"Projectile_1", SUB_WEAPON_PROJECTILE_1);
         m_pItemSubWeaponBoneFlag->GetConstraints()->AddConstraint(L"Projectile_2", SUB_WEAPON_PROJECTILE_2);
         m_pItemSubWeaponBoneFlag->GetConstraints()->AddConstraint(L"Projectile_3", SUB_WEAPON_PROJECTILE_3);
         m_pItemProjectileType->GetConstraints()->AddConstraint(L"PROJ_BALL", BEID_PROJ_BALL);
         m_pItemProjectileType->GetConstraints()->AddConstraint(L"PROJ_BEAM", BEID_PROJ_BEAM);
         m_pItemProjectileType->GetConstraints()->AddConstraint(L"PROJ_HISSIDAN", BEID_PROJ_HISSIDAN);
         m_pItemProjectileType->GetConstraints()->AddConstraint(L"PROJ_HELLZONE", BEID_PROJ_HELLZONE);
         m_pItemProjectileType->GetConstraints()->AddConstraint(L"PROJ_MULTI_HISSIDAN", BEID_PROJ_MULTI_HISSIDAN);
         m_pItemProjectileType->GetConstraints()->AddConstraint(L"PROJ_MAGARE", BEID_PROJ_MAGARE);
		 m_pItemTargetEffectType->GetConstraints()->AddConstraint(L"NONE", TARGET_EFFECT_TYPE_NONE);
		 m_pItemTargetEffectType->GetConstraints()->AddConstraint(L"SIDE", TARGET_EFFECT_TYPE_SIDE);
		 m_pItemTargetEffectType->GetConstraints()->AddConstraint(L"FRONT", TARGET_EFFECT_TYPE_FRONT);
        ...
        // Create Visual Effect Category
         m_pCatVisualEffectEvent = m_property.AddCategory(L"VisualEffect Properties");
         m_pVETime        = (CCustomItemSpinDouble*)m_pCatVisualEffectEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
         m_pVEName        = m_pCatVisualEffectEvent->AddChildItem(new CXTPPropertyGridItem(L"Effect Name"));
         m_pVEProjectileType = (CXTPPropertyGridItemBool*)m_pCatVisualEffectEvent->AddChildItem(new CXTPPropertyGridItemBool(L"Projectile Type"));
         m_pVEAttach      = (CXTPPropertyGridItemBool*)m_pCatVisualEffectEvent->AddChildItem(new CXTPPropertyGridItemBool(L"Effect Attach"));
         m_pVEAttachType  = (CXTPPropertyGridItemEnum*)m_pCatVisualEffectEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Attach Type"));
         m_pVEBoneType    = (CXTPPropertyGridItemEnum*)m_pCatVisualEffectEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Attach Bone Type"));
         m_pVEBoneName    = m_pCatVisualEffectEvent->AddChildItem(new CXTPPropertyGridItem(L"Bone Name"));
         m_pVEWeaponBoneName = m_pCatVisualEffectEvent->AddChildItem(new CXTPPropertyGridItem(L"Weapon Bone Name"));
         m_pVEOffsetPos   = (CCustomItemOffset*)m_pCatVisualEffectEvent->AddChildItem(new CCustomItemOffset(L"Offset Pos"));                                    
         m_pVEApplyScale  = (CXTPPropertyGridItemBool*)m_pCatVisualEffectEvent->AddChildItem(new CXTPPropertyGridItemBool(L"Apply Scale", TRUE));
         ...
         m_pVEAttachType->GetConstraints()->AddConstraint(L"Position", VE_ATTACH_POS);
         m_pVEAttachType->GetConstraints()->AddConstraint(L"Bone", VE_ATTACH_BONE);

         m_pVEBoneType->GetConstraints()->AddConstraint(L"Character Bone", BONE_CHARACTER);
         m_pVEBoneType->GetConstraints()->AddConstraint(L"Weapon Bone", BONE_WEAPON);
         m_pVEBoneType->GetConstraints()->AddConstraint(L"Sub Weapon Bone", BONE_SUB_WEAPON);
         
         m_pVEWeaponBoneName->GetConstraints()->AddConstraint(L"Weapon_VE_1");
         m_pVEWeaponBoneName->GetConstraints()->AddConstraint(L"Weapon_VE_2");
         m_pVEWeaponBoneName->GetConstraints()->AddConstraint(L"Weapon_VE_3");
        ...
        m_pCatVisualSoundEvent = m_property.AddCategory(L"Visual Sound Properties");
        m_pSETime       = (CCustomItemSpinDouble*)m_pCatVisualSoundEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pSESoundName1  = (CCustomItemFileBox*)m_pCatVisualSoundEvent->AddChildItem(new CCustomItemFileBox(L"Sound File 1", FILTER_SOUND));
        m_pSESoundName2  = (CCustomItemFileBox*)m_pCatVisualSoundEvent->AddChildItem(new CCustomItemFileBox(L"Sound File 2", FILTER_SOUND));
        m_pSESoundName3  = (CCustomItemFileBox*)m_pCatVisualSoundEvent->AddChildItem(new CCustomItemFileBox(L"Sound File 3", FILTER_SOUND));
        m_pSESoundName4  = (CCustomItemFileBox*)m_pCatVisualSoundEvent->AddChildItem(new CCustomItemFileBox(L"Sound File 4", FILTER_SOUND));
        m_pSESoundType  = (CXTPPropertyGridItemEnum*)m_pCatVisualSoundEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Sound Type"));
        m_pSESoundLoop  = (CXTPPropertyGridItemBool*)m_pCatVisualSoundEvent->AddChildItem(new CXTPPropertyGridItemBool(L"Sound Loop"));
        m_pSESoundVolume = (CCustomItemSpin*)m_pCatVisualSoundEvent->AddChildItem(new CCustomItemSpin(L"Sound Volume", 0, 100));
        m_pSESoundDist   = (CCustomItemSpin*)m_pCatVisualSoundEvent->AddChildItem(new CCustomItemSpin(L"Sound Distance", 0, 100));
        m_pSESoundDecayDist = (CCustomItemSpin*)m_pCatVisualSoundEvent->AddChildItem(new CCustomItemSpin(L"Sound Decay Dist", 0, 100));
        m_pSESoundPitchMin  = (CCustomItemSpinDouble*)m_pCatVisualSoundEvent->AddChildItem(new CCustomItemSpinDouble(L"Sound Pitch Min", _T("%.2f"), 0.0f, 10.0f));
        m_pSESoundPitchMax  = (CCustomItemSpinDouble*)m_pCatVisualSoundEvent->AddChildItem(new CCustomItemSpinDouble(L"Sound Pitch Max", _T("%.2f"), 0.0f, 10.0f));

        m_pSESoundType->GetConstraints()->AddConstraint(L"Effect", CHANNEL_GROUP_EFFECT_SOUND);
        m_pSESoundType->GetConstraints()->AddConstraint(L"Voice", CHANNEL_GROUP_VOICE_SOUND);
        ...
        m_pCatFootStepEvent = m_property.AddCategory(L"Foot Step Properties");
        m_pFSTime = (CCustomItemSpinDouble*)m_pCatFootStepEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pFSType = (CXTPPropertyGridItemEnum*)m_pCatFootStepEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"TYPE"));
        m_pFSMobType = (CXTPPropertyGridItemEnum*)m_pCatFootStepEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Mob Type"));

        m_pFSType->GetConstraints()->AddConstraint(L"LEFT FOOT", FOOT_LEFT);
        m_pFSType->GetConstraints()->AddConstraint(L"RIGHT FOOT", FOOT_RIGHT);

        m_pFSMobType->GetConstraints()->AddConstraint(L"NORMAL", FOOT_TYPE_NORMAL);
        m_pFSMobType->GetConstraints()->AddConstraint(L"LARGE", FOOT_TYPE_LARGE);
        ...
        m_pCatLinkEffectEvent = m_property.AddCategory(L"Link Event Properties");
        m_pLEName      = m_pCatLinkEffectEvent->AddChildItem(new CXTPPropertyGridItem(L"Effect Name"));
        m_pLEAttachBone = (CXTPPropertyGridItemBool*)m_pCatLinkEffectEvent->AddChildItem(new CXTPPropertyGridItemBool(L"Attach Bone"));
        m_pLEBoneName  = m_pCatLinkEffectEvent->AddChildItem(new CXTPPropertyGridItem(L"Bone Name"));
        m_pLEOffsetPos = (CCustomItemOffset*)m_pCatLinkEffectEvent->AddChildItem(new CCustomItemOffset(L"Offset Pos"));        
        m_pLEOffsetRot = (CCustomItemOffset*)m_pCatLinkEffectEvent->AddChildItem(new CCustomItemOffset(L"Offset Rot"));
        ...
        m_pCatSlowTimeEvent = m_property.AddCategory(L"Weight Time Event Properties");
        m_pSTTime       = (CCustomItemSpinDouble*)m_pCatSlowTimeEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pSTLifeTime   = (CCustomItemSpinDouble*)m_pCatSlowTimeEvent->AddChildItem(new CCustomItemSpinDouble(L"Life TIme"));
        m_pSTWeight     = (CCustomItemSpinDouble*)m_pCatSlowTimeEvent->AddChildItem(new CCustomItemSpinDouble(L"Weight Time"));
        ...
        m_pCatTraceEvent    = m_property.AddCategory(L"Trace Event Properties");
        m_pTEStartTime      = (CCustomItemSpinDouble*)m_pCatTraceEvent->AddChildItem(new CCustomItemSpinDouble(L"Start Time"));
        m_pTELifeTime       = (CCustomItemSpinDouble*)m_pCatTraceEvent->AddChildItem(new CCustomItemSpinDouble(L"Life Time"));
        m_pTEEdgeLifeTime   = (CCustomItemSpinDouble*)m_pCatTraceEvent->AddChildItem(new CCustomItemSpinDouble(L"Edge Life Time"));
        m_pTEAttachType     = (CXTPPropertyGridItemEnum*)m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Attach Type"));
        m_pTETraceKind      = (CXTPPropertyGridItemEnum*)m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Trace Kind"));
        m_pTEStartBoneName  = m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItem(L"Start Bone Name"));
        m_pTEEndBoneName    = m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItem(L"End Bone Name"));
        m_pTETexture        = (CCustomItemFileBox*)m_pCatTraceEvent->AddChildItem(new CCustomItemFileBox(L"Texture Name", FILTER_TEXTURE));
        m_pTEStartBoneOffset= (CCustomItemOffset*)m_pCatTraceEvent->AddChildItem(new CCustomItemOffset(L"Start Bone Offset"));
        m_pTEEndBoneoffset  = (CCustomItemOffset*)m_pCatTraceEvent->AddChildItem(new CCustomItemOffset(L"End Bone Offset"));
        m_pTEEdgeGap = (CCustomItemSpinDouble*)m_pCatTraceEvent->AddChildItem(new CCustomItemSpinDouble(L"Edge Gap"));
        m_pTESplinePointCount = (CCustomItemSpin*)m_pCatTraceEvent->AddChildItem(new CCustomItemSpin(L"Spline Point Count"));
        m_pTEMaxEdgeCount   = (CXTPPropertyGridItemNumber*)m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItemNumber(L"Max Edge Count"));
        m_pTEMaxLength      = (CCustomItemSpinDouble*)m_pCatTraceEvent->AddChildItem(new CCustomItemSpinDouble(L"Max Length(m)"));
        m_pTESrcBlend       = (CXTPPropertyGridItemEnum*)m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Src Alpha Blend", rwBLENDSRCALPHA));
        m_pTEDestBlend      = (CXTPPropertyGridItemEnum*)m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Dest Alpha Blend", rwBLENDONE));
        m_pTEStartColor     = (CXTPPropertyGridItemColor*)m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItemColor(L"Start Color"));
        m_pTEStartAlpha     = (CXTPPropertyGridItemNumber*)m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItemNumber(L"Start Alpha"));
        m_pTEEndColor       = (CXTPPropertyGridItemColor*)m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItemColor(L"End Color"));
        m_pTEEndAlpha       = (CXTPPropertyGridItemNumber*)m_pCatTraceEvent->AddChildItem(new CXTPPropertyGridItemNumber(L"End Alpha"));

        for(int i = 0; i < g_nBlendMaxCount; ++i)
        {
            m_pTESrcBlend->GetConstraints()->AddConstraint(A2W(g_BlendString[i]), i + 1);
            m_pTEDestBlend->GetConstraints()->AddConstraint(A2W(g_BlendString[i]), i + 1);
        }

        m_pTEAttachType->GetConstraints()->AddConstraint(L"Character Bone", SEventTrace::CHARACTER_BONE);
        m_pTEAttachType->GetConstraints()->AddConstraint(L"Weapon Bone", SEventTrace::WEAPONE_BONE);
        m_pTEAttachType->GetConstraints()->AddConstraint(L"Sub Weapon bone", SEventTrace::SUB_WEAPON_BONE);

        m_pTETraceKind->GetConstraints()->AddConstraint(L"Event Trace", SEventTrace::EVENT_TRACE);
        m_pTETraceKind->GetConstraints()->AddConstraint(L"Item Trace", SEventTrace::ITEM_TRACE);
        ...
        m_pCatSubWeaponEvent = m_property.AddCategory(L"SubWeapon Event Properties");
        m_pSWTime = (CCustomItemSpinDouble*)m_pCatSubWeaponEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pSWActive = (CXTPPropertyGridItemEnum*)m_pCatSubWeaponEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Active"));

        m_pSWActive->GetConstraints()->AddConstraint(L"Active", SUB_WEAPON_ACTIVE);
        m_pSWActive->GetConstraints()->AddConstraint(L"DeActive", SUB_WEAPON_DEACTIVE);
        ...
        m_pCatPostEffectEvent = m_property.AddCategory(L"Post Effect Event Properties");
        m_pPETime = (CCustomItemSpinDouble*)m_pCatPostEffectEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pPEEffectName = (CXTPPropertyGridItem*)m_pCatPostEffectEvent->AddChildItem(new CXTPPropertyGridItem(L"Effect"));
        m_pPETarget = (CXTPPropertyGridItemEnum*)m_pCatPostEffectEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Target"));
        m_pPEOffset = (CCustomItemOffset*)m_pCatPostEffectEvent->AddChildItem(new CCustomItemOffset(L"Offset"));
        m_pPECenterFix = (CXTPPropertyGridItemBool*)m_pCatPostEffectEvent->AddChildItem(new CXTPPropertyGridItemBool(L"Center Fix"));
        m_pPETargetHeight = (CCustomItemSpinDouble*)m_pCatPostEffectEvent->AddChildItem(new CCustomItemSpinDouble(L"Target Height"));
        m_pPEPCBoneName = m_pCatPostEffectEvent->AddChildItem(new CXTPPropertyGridItem(L"Attach Bone"));

        m_pPEEffectName->SetFlags(xtpGridItemHasComboButton);
        m_pPEPCBoneName->SetFlags(xtpGridItemHasComboButton);
        m_pPETarget->GetConstraints()->AddConstraint(L"SELF", POST_EFFECT_TARGET_TYPE_SELF);
        m_pPETarget->GetConstraints()->AddConstraint(L"TARGET", POST_EFFECT_TARGET_TYPE_TARGET);
		...
		m_pCatSummonPetEvent = m_property.AddCategory(L"Summon Pet Event Properties");
		m_pSUETime = (CCustomItemSpinDouble*)m_pCatSummonPetEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        ...
        m_pCatTMQEvent = m_property.AddCategory(L"TMQ Event Properties");
        m_pTMQTime = (CCustomItemSpinDouble*)m_pCatTMQEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pTMQType = (CXTPPropertyGridItemEnum*)m_pCatTMQEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"TMQ Type"));

        m_pTMQType->GetConstraints()->AddConstraint(L"IN", E_TMQ_EVENT_IN);
        m_pTMQType->GetConstraints()->AddConstraint(L"OUT", E_TMQ_EVENT_OUT);
        ...
        m_pCatAlphaEvent = m_property.AddCategory(L"Alpha Fade Event Properties");
        m_pAlphaTime = (CCustomItemSpinDouble*)m_pCatAlphaEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pAlphaStart = (CXTPPropertyGridItemNumber*)m_pCatAlphaEvent->AddChildItem(new CXTPPropertyGridItemNumber(L"Start Alpha"));
        m_pAlphaDest = (CXTPPropertyGridItemNumber*)m_pCatAlphaEvent->AddChildItem(new CXTPPropertyGridItemNumber(L"Dest Alpha"));        
        m_pAlphaLifeTime = (CCustomItemSpinDouble*)m_pCatAlphaEvent->AddChildItem(new CCustomItemSpinDouble(L"Life Time"));
        m_pAlphaFadeTime = (CCustomItemSpinDouble*)m_pCatAlphaEvent->AddChildItem(new CCustomItemSpinDouble(L"Fade Time"));        
        m_pAlphaType = (CXTPPropertyGridItemEnum*)m_pCatAlphaEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Apply Type"));        

        m_pAlphaType->GetConstraints()->AddConstraint(L"CLUMP", SEventAlpha::E_ALPHA_EVENT_CLUMP);
        m_pAlphaType->GetConstraints()->AddConstraint(L"ATOMIC", SEventAlpha::E_ALPHA_EVENT_ATOMIC);
        ...
        {
            m_pAlphaAtomic[i] = (CXTPPropertyGridItemBool*)m_pCatAlphaEvent->AddChildItem(new CXTPPropertyGridItemBool(L""));
        ...
        m_pCatExplosionEvent = m_property.AddCategory(L"Explosion Event Properties");
        m_pExplosionTime = (CCustomItemSpinDouble*)m_pCatExplosionEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pExplosionType = (CXTPPropertyGridItemEnum*)m_pCatExplosionEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Explosion Type"));

        m_pExplosionType->GetConstraints()->AddConstraint(L"SMALL", EXPLOSION_EVENT_TYPE_SMALL);
        m_pExplosionType->GetConstraints()->AddConstraint(L"NORMAL", EXPLOSION_EVENT_TYPE_NORMAL);
        m_pExplosionType->GetConstraints()->AddConstraint(L"BIG", EXPLOSION_EVENT_TYPE_BIG);
        ...
        m_pCatObjectProperty = m_property.AddCategory(L"Object Properties");
        m_pObjName      = m_pCatObjectProperty->AddChildItem(new CXTPPropertyGridItem(L"Name"));
        m_pObjClumpName = m_pCatObjectProperty->AddChildItem(new CXTPPropertyGridItem(L"Clump Name"));
        m_pObjShadow    = (CXTPPropertyGridItemBool*)m_pCatObjectProperty->AddChildItem(new CXTPPropertyGridItemBool(L"Shadow", TRUE));                
        m_pObjCullDist  = (CCustomItemSpinDouble*)m_pCatObjectProperty->AddChildItem(new CCustomItemSpinDouble(L"Cull Distance", _T("%.2f"), 100.0f, 500.0f));        
        m_pObjBBox      = (CCustomItemOffset*)m_pCatObjectProperty->AddChildItem(new CCustomItemOffset(L"Trigger BBox"));        
        m_pObjUVAnim    = (CCustomItemFileBox*)m_pCatObjectProperty->AddChildItem(new CCustomItemFileBox(L"UVAnimFile", FILTER_UVANIM));
        m_pObjUVAnimSpeed = (CCustomItemSpinDouble*)m_pCatObjectProperty->AddChildItem(new CCustomItemSpinDouble(L"UVAnim Speed"));
        m_pObjAnim      = (CCustomItemFileBox*)m_pCatObjectProperty->AddChildItem(new CCustomItemFileBox(L"Anim FIle", FILTER_ANIM));        
        m_pObjCollision = (CXTPPropertyGridItemBool*)m_pCatObjectProperty->AddChildItem(new CXTPPropertyGridItemBool(L"Path Engine Collision", FALSE));
        m_pObjCollisonMesh = (CCustomItemFileBox*)m_pCatObjectProperty->AddChildItem(new CCustomItemFileBox(L"Collison Mesh File", FILTER_CLUMP));
        m_pObjType      = (CXTPPropertyGridItemEnum*)m_pCatObjectProperty->AddChildItem(new CXTPPropertyGridItemEnum(L"Object Type"));
        m_pObjApplyPVS  = (CXTPPropertyGridItemBool*)m_pCatObjectProperty->AddChildItem(new CXTPPropertyGridItemBool(L"Apply PVS", TRUE));
        m_pObjSortByPos = (CXTPPropertyGridItemBool*)m_pCatObjectProperty->AddChildItem(new CXTPPropertyGridItemBool(L"Sort By Pos", FALSE));
        m_pObjForcePicking = (CXTPPropertyGridItemBool*)m_pCatObjectProperty->AddChildItem(new CXTPPropertyGridItemBool(L"Force Picking", FALSE));
        m_pObjPENaviPress = (CXTPPropertyGridItemBool*)m_pCatObjectProperty->AddChildItem(new CXTPPropertyGridItemBool(L"PE Navi Press", FALSE));
        m_pObjCullTestAllAtomic = (CXTPPropertyGridItemBool*)m_pCatObjectProperty->AddChildItem(new CXTPPropertyGridItemBool(L"Culling Test All Atomic"));
        m_pCatObjSoundProperty = m_property.AddCategory(L"Object Sound Properties");
        m_pObjSoundName = (CCustomItemFileBox*)m_pCatObjSoundProperty->AddChildItem(new CCustomItemFileBox(L"Sound File", FILTER_SOUND));
        m_pObjSoundVolume = (CCustomItemSpin*)m_pCatObjSoundProperty->AddChildItem(new CCustomItemSpin(L"Sound Volume"));
        m_pObjSoundDist = (CCustomItemSpin*)m_pCatObjSoundProperty->AddChildItem(new CCustomItemSpin(L"Sound Distance"));
        m_pObjSoundDecayDist = (CCustomItemSpin*)m_pCatObjSoundProperty->AddChildItem(new CCustomItemSpin(L"Sound Decay Distance"));
        m_pObjSoundPicth = (CCustomItemSpinDouble*)m_pCatObjSoundProperty->AddChildItem(new CCustomItemSpinDouble(L"Sound Pitch"));
		...
		m_pObjCullDist->GetConstraints()->AddConstraint(L"70");
        m_pObjCullDist->GetConstraints()->AddConstraint(L"100");
        m_pObjCullDist->GetConstraints()->AddConstraint(L"200");
        m_pObjCullDist->GetConstraints()->AddConstraint(L"300");
        m_pObjCullDist->GetConstraints()->AddConstraint(L"400");
        m_pObjCullDist->GetConstraints()->AddConstraint(L"500");

        m_pObjType->GetConstraints()->AddConstraint(L"Normal", E_OBJECT_NORMAL);
        m_pObjType->GetConstraints()->AddConstraint(L"MilePost", E_OBJECT_MILEPOST);

        m_pCatObjectProperty->Expand();
        m_pCatObjSoundProperty->Expand();

        // Create Item Properties Category
        m_pCatItemProperty  = m_property.AddCategory(L"Item Properties");
        m_pItemName         = m_pCatItemProperty->AddChildItem(new CXTPPropertyGridItem(L"Name"));
        m_pItemMeshPath     = m_pCatItemProperty->AddChildItem(new CXTPPropertyGridItem(L"Mesh Path"));
        m_pItemMeshName     = m_pCatItemProperty->AddChildItem(new CXTPPropertyGridItem(L"Mesh File"));
        m_pItemAttachType   = (CXTPPropertyGridItemEnum*)m_pCatItemProperty->AddChildItem(new CXTPPropertyGridItemEnum(L"Attach Type"));
        m_pItemAttachSlot   = (CXTPPropertyGridItemEnum*)m_pCatItemProperty->AddChildItem(new CXTPPropertyGridItemEnum(L"Attach Slot"));
        m_pItemAttachOffset = (CCustomItemOffset*)m_pCatItemProperty->AddChildItem(new CCustomItemOffset(L"Attach Offset"));
        m_pItemTraceEnable  = (CXTPPropertyGridItemBool*)m_pCatItemProperty->AddChildItem(new CXTPPropertyGridItemBool(L"Trace Effect Enable Default"));
        m_pItemApplyEmblem  = (CXTPPropertyGridItemBool*)m_pCatItemProperty->AddChildItem(new CXTPPropertyGridItemBool(L"Apply Emblem"));
        ...
        m_pItemAttachType->GetConstraints()->AddConstraint(L"EQUIP_BODY", ITEM_RES_EQUIP_BODY);        
		m_pItemAttachType->GetConstraints()->AddConstraint(L"EQUIP_MAIN", ITEM_RES_EQUIP_MAIN);
		m_pItemAttachType->GetConstraints()->AddConstraint(L"EQUIP_SUB", ITEM_RES_EQUIP_SUB);
        m_pItemAttachType->GetConstraints()->AddConstraint(L"NOT_EQUIP", ITEM_RES_NOT_EQUIP);

        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"HEAD", ITEM_EQUIP_HEAD);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"FACE", ITEM_EQUIP_FACE);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"JACKET", ITEM_EQUIP_JACKET);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"PANTS", ITEM_EQUIP_PANTS);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"BOOTS", ITEM_EQUIP_BOOTS);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"TWO_HAND", ITEM_EQUIP_TWO_HAND);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"R_EYE", ITEM_EQUIP_R_EYE);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"R_HAND", ITEM_EQUIP_R_HAND);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"L_HAND", ITEM_EQUIP_L_HAND);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"BACK", ITEM_EQUIP_BACK);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"USER_MOVE1", ITEM_EQUIP_USER_MOVE1);
        m_pItemAttachSlot->GetConstraints()->AddConstraint(L"MASK", ITEM_EQUIP_MASK);

        m_pCatItemProperty->Expand();

        // Item Upgrade Properties
        m_pCatUpgradeProperty = m_property.AddCategory(L"Upgrade Properties");
        m_pUpgradeBone1         = m_pCatUpgradeProperty->AddChildItem(new CXTPPropertyGridItem(L"Bone 1"));
        m_pUpgradeOffset1       = (CCustomItemOffset*)m_pCatUpgradeProperty->AddChildItem(new CCustomItemOffset(L"Bone1 Offset"));
        m_pUpgradeBone2         = m_pCatUpgradeProperty->AddChildItem(new CXTPPropertyGridItem(L"Bone 2"));
        m_pUpgradeOffset2       = (CCustomItemOffset*)m_pCatUpgradeProperty->AddChildItem(new CCustomItemOffset(L"Bone2 Offset"));
        m_pUpgradeEffect1       = m_pCatUpgradeProperty->AddChildItem(new CXTPPropertyGridItem(L"Effect (3Grade)"));
        m_pUpgradeEffect2       = m_pCatUpgradeProperty->AddChildItem(new CXTPPropertyGridItem(L"Effect (4Grade)"));
        ...
        // Character
        m_pCatCharacterProperty = m_property.AddCategory(L"Character Properties");
        m_pCharFaceCameraPos    = (CCustomItemOffset*)m_pCatCharacterProperty->AddChildItem(new CCustomItemOffset(L"Face Camera Position"));
        m_pCharFaceCameraLookAt = (CCustomItemOffset*)m_pCatCharacterProperty->AddChildItem(new CCustomItemOffset(L"Face Camera Height"));
		m_pCharInitWalkSpeed	= (CCustomItemSpinDouble*)m_pCatCharacterProperty->AddChildItem(new CCustomItemSpinDouble(L"Init Walk Anim Speed"));
		m_pCharInitRunSpeed		= (CCustomItemSpinDouble*)m_pCatCharacterProperty->AddChildItem(new CCustomItemSpinDouble(L"Init Run Anim Speed"));
        m_pCharApplyTangent     = (CXTPPropertyGridItemBool*)m_pCatCharacterProperty->AddChildItem(new CXTPPropertyGridItemBool(L"Apply Normal"));
        m_pCharAlphaDistance    = (CCustomItemSpinDouble*)m_pCatCharacterProperty->AddChildItem(new CCustomItemSpinDouble(L"Alpha Distance"));
        ...
        // Direct Event
        m_pCatDirectEvent = m_property.AddCategory(L"Direct Event Properties");
        m_pDirectEventTime = (CCustomItemSpinDouble*)m_pCatDirectEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pDirectEventType = (CXTPPropertyGridItemEnum*)m_pCatDirectEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Direct Type"));
        m_pDirectEventType->GetConstraints()->AddConstraint(L"Camera Shake", DIRECT_EVENT_TYPE_CAMERA_SHAKE);
        ...
        // Color Change Event
        m_pCatColorChangeEvent = m_property.AddCategory(L"Color Change Event Properties");
        m_pColChangeEventTime = (CCustomItemSpinDouble*)m_pCatColorChangeEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pColChangeEventType = (CXTPPropertyGridItemEnum*)m_pCatColorChangeEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Change Type"));
        m_pColChangeEventEdge = (CXTPPropertyGridItemColor*)m_pCatColorChangeEvent->AddChildItem(new CXTPPropertyGridItemColor(L"Edge Color"));
        m_pColChangeEventBody = (CXTPPropertyGridItemColor*)m_pCatColorChangeEvent->AddChildItem(new CXTPPropertyGridItemColor(L"Body Color"));
        m_pColChangeEventAdd  = (CXTPPropertyGridItemColor*)m_pCatColorChangeEvent->AddChildItem(new CXTPPropertyGridItemColor(L"Add Color"));
        m_pColChangeEventType->GetConstraints()->AddConstraint(L"Start Point", COLOR_CHANGE_TYPE_START);
        m_pColChangeEventType->GetConstraints()->AddConstraint(L"End Point", COLOR_CHANGE_TYPE_END);
        m_pColChangeEventType->GetConstraints()->AddConstraint(L"Animation", COLOR_CHANGE_TYPE_ANIM);
        ...
        // Stretch Event
        m_pCatStretchEvent = m_property.AddCategory(L"Bone Stretch Event Properties");
        m_pStretchEventTime = (CCustomItemSpinDouble*)m_pCatStretchEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));
        m_pStretchEventType = (CXTPPropertyGridItemEnum*)m_pCatStretchEvent->AddChildItem(new CXTPPropertyGridItemEnum(L"Type"));
        m_pStretchBoneName[0]   = m_pCatStretchEvent->AddChildItem(new CXTPPropertyGridItem(L"Bone 1"));
        m_pStretchBoneName[1]   = m_pCatStretchEvent->AddChildItem(new CXTPPropertyGridItem(L"Bone 2"));
        m_pStretchSpeed         = (CCustomItemSpinDouble*)m_pCatStretchEvent->AddChildItem(new CCustomItemSpinDouble(L"Bone Speed"));
        m_pStretchAccel         = (CCustomItemSpinDouble*)m_pCatStretchEvent->AddChildItem(new CCustomItemSpinDouble(L"Bone Accel Speed"));
        m_pStretchWidth         = (CCustomItemSpinDouble*)m_pCatStretchEvent->AddChildItem(new CCustomItemSpinDouble(L"Bone Width"));        
        m_pStretchScaleName     = m_pCatStretchEvent->AddChildItem(new CXTPPropertyGridItem(L"Scale Bone"));
        m_pStretchScaleSize     = (CCustomItemSpinDouble*)m_pCatStretchEvent->AddChildItem(new CCustomItemSpinDouble(L"Scale Size"));
        m_pStretchAxisBoneName  = m_pCatStretchEvent->AddChildItem(new CXTPPropertyGridItem(L"Axis Bone"));
        m_pStretchTargetEffect  = m_pCatStretchEvent->AddChildItem(new CXTPPropertyGridItem(L"Target Effect"));        

        m_pStretchEventType->GetConstraints()->AddConstraint(L"PULLING", E_STRETCH_PULLING);
        m_pStretchEventType->GetConstraints()->AddConstraint(L"HIT", E_STRETCH_HIT);
        ...
        // Trigger Event
        m_pCatTriggerEvent = m_property.AddCategory(L"Trigger Event Properties");
        m_pTriggerEventTime = (CCustomItemSpinDouble*)m_pCatTriggerEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));

        m_pTriggerEventTime->SetID(ID_TRIGGER_TIME);
        m_pCatTriggerEvent->Expand();

        // Skill Cancel Event
        m_pCatSkillCancelEvent = m_property.AddCategory(L"Skill Cancel Properties");
        m_pSCTime = (CCustomItemSpinDouble*)m_pCatSkillCancelEvent->AddChildItem(new CCustomItemSpinDouble(L"Time"));

        m_pSCTime->SetID(ID_SC_TIME);
        m_pCatSkillCancelEvent->Expand();

        // Animation Property
        m_pCatAnimation = m_property.AddCategory(L"Animation Properties");
        m_pAnimCullTestAllAtomic = (CXTPPropertyGridItemBool*)m_pCatAnimation->AddChildItem(new CXTPPropertyGridItemBool(L"Cull Test All Atomic"));
...
void CPropertyPane::SetObject(CMTObject* pObject)
{
    ...
    else
    {
        ...
        m_pObjName->SetValue(A2W(pObject->GetProperty()->GetName()));
        m_pObjClumpName->SetValue(A2W(pObject->GetProperty()->GetDffName()));
        ...
        m_pObjAnim->SetValue(A2W(pObject->GetProperty()->m_strAnimFileName.c_str()));
        m_pObjCollision->SetBool(pObject->GetProperty()->GetCollision());        
        m_pObjCollisonMesh->SetValue(A2W(pObject->GetProperty()->m_strCollisionMeshName.c_str()));
        ...
        m_pObjUVAnim->SetValue(A2W(m_pObject->GetProperty()->m_strUVAnimFileName.c_str()));
        ...
        m_pObjSoundName->SetValue(A2W(pSoundProp->chSoundName));
...
void CPropertyPane::SetItem(CMTItem* pItem)
{
    ...
    else
    {
        ...
        m_pItemName->SetValue(A2W(pItem->GetProperty()->GetName()));
        m_pItemMeshPath->SetValue(A2W(pItem->GetProperty()->GetMeshPath().c_str()));
        m_pItemMeshName->SetValue(A2W(pItem->GetProperty()->GetMeshFileName().c_str()));
...
void CPropertyPane::Update()
{
    ...
    case EVENT_ANIM_LINK_EFFECT:
        {
            ...
            if(m_pClump)
            {
                ...
                m_pLEBoneName->SetValue(A2W(pEventLink->chBoneName));                
            ...
            m_pLEName->SetValue(A2W(pEventLink->chEffectName));                
	...
	case EVENT_ANIM_SUMMON_PET:		
		...
		break;
    case EVENT_ANIM_TMQ:
        ApplyTMQEventProperties((SEventTMQ*)m_pEventAnim);
        break;
    case EVENT_ANIM_ALPHA:
...
void CPropertyPane::SetBoneList()
{
    ...
    {
        CString strBoneName = A2W(it->first.c_str());
        if(m_pCharacter)
        {
...
void CPropertyPane::SetEffectTypeList()
{
    ...
    if(pMap)
    {
        ...
        {
            CString strEffectType = A2W(it->second.c_str());
...
void CPropertyPane::SetEffectNameList()
{
    ...
    m_pItemProjectileName->GetConstraints()->AddConstraint(L"");
    m_pItemTargetEffectName->GetConstraints()->AddConstraint(L"");
    m_pItemSubTargetEffect->GetConstraints()->AddConstraint(L"");
    m_pItemWordEffect->GetConstraints()->AddConstraint(L"");
    m_pVEName->GetConstraints()->AddConstraint(L"");
    m_pUpgradeEffect1->GetConstraints()->AddConstraint(L"");
    m_pUpgradeEffect2->GetConstraints()->AddConstraint(L"");
    m_pStretchTargetEffect->GetConstraints()->AddConstraint(L"");
    ...
    for(; it != mapEffectProperty.end(); ++it)
    {
        ...
        CString sEffectName = A2W(strEffectName.c_str());        
    ...
    if(wParam == XTP_PGN_ITEMVALUE_CHANGED)
    {
        ...
        {            
            ...
            case EVENT_ANIM_SUMMON_PET:                
                ...
                break;
            case EVENT_ANIM_TMQ:
                SetTMQEventProperties((SEventTMQ*)m_pEventAnim, pItem->GetID());
                break;
            case EVENT_ANIM_ALPHA:
...
void CPropertyPane::ApplyHitEventProperties( SEventAnimHit* pAnimHit ) 
{
    ...
    m_pItemBoneName->SetValue(A2W(pAnimHit->chBoneName));
    m_pItemSubWeaponBoneFlag->SetFlags(pAnimHit->nSubWeaponFlag);
    m_pItemProjectileName->SetValue(A2W(pAnimHit->chProjectileEffectName));
    m_pItemTargetAttach->SetBool(pAnimHit->bTargetAttach);
    m_pItemTargetEffectName->SetValue(A2W(pAnimHit->chTargetEffectName));
    m_pItemTargetEffectType->SetEnum(pAnimHit->eTargetEffectType);
    m_pItemSubTargetEffect->SetValue(A2W(pAnimHit->chSubTargetEffect));
    m_pItemTargetSoundName->SetValue(A2W(pAnimHit->chTargetSoundName));
    m_pItemSoundType->SetEnum((int)pAnimHit->eSoundType);
    m_pItemHitSoundEcho->SetBool(pAnimHit->bHitSoundEcho);
    m_pItemWordEffect->SetValue(A2W(pAnimHit->chWordEffect));
...
void CPropertyPane::SetHitEventProperties( SEventAnimHit* pEventHit, UINT nID ) 
{
    ...
    case ID_HIT_BONE_NAME:                
        strcpy_s(pEventHit->chBoneName, W2A(m_pItemBoneName->GetValue()));
        break;
    case ID_HIT_SUBWEAPON_BONE_FLAG:                    
        pEventHit->nSubWeaponFlag = m_pItemSubWeaponBoneFlag->GetFlags();
        break;
    case ID_HIT_PROJECTILE_NAME:                        
        strcpy_s(pEventHit->chProjectileEffectName, W2A(m_pItemProjectileName->GetValue()));
        break;
    ...
    case ID_HIT_TARGET_EFFECT_NAME:                
        strcpy_s(pEventHit->chTargetEffectName, W2A(m_pItemTargetEffectName->GetValue()));
        break;
    ...
    case ID_HIT_SUB_TARGET_EFFECT:
        strcpy_s(pEventHit->chSubTargetEffect, W2A(m_pItemSubTargetEffect->GetValue()));
        break;
    case ID_HIT_TARGET_SOUND_NAME:                
        {
            ...
            strcpy_s(pEventHit->chTargetSoundName, W2A(strTargetSoundName));
        }        
        break;
    ...
    case ID_HIT_WORD_EFFECT:                
        strcpy_s(pEventHit->chWordEffect, W2A(m_pItemWordEffect->GetValue()));
        break;
...
void CPropertyPane::OnLEBoneName()
{
    ...
    strncpy(pEvent->chBoneName, W2A(m_pLEBoneName->GetValue()), MAX_DEFAULT_NAME);
...
void CPropertyPane::SetTraceEventProperties( SEventTrace* pEventTrace, UINT nID ) 
{
    ...
    case ID_TE_START_BONE_NAME:
        strncpy(pEventTrace->strStartBoneName, W2A(m_pTEStartBoneName->GetValue()), MAX_DEFAULT_NAME);
        break;
    case ID_TE_END_BONE_NAME:
        strncpy(pEventTrace->strEndBoneName, W2A(m_pTEEndBoneName->GetValue()), MAX_DEFAULT_NAME);
        break;
    case ID_TE_TEXTURE_NAME:
        {
            ...
            strncpy(pEventTrace->strTexture, W2A(strTextureName), MAX_DEFAULT_NAME);
        }                    
        break;
...
void CPropertyPane::ApplyTraceEventProperties(SEventTrace* pEventTrace) 
{
    ...
    m_pTEStartBoneName->SetValue(A2W(pEventTrace->strStartBoneName));
    m_pTEEndBoneName->SetValue(A2W(pEventTrace->strEndBoneName));
    ...
    m_pTETexture->SetValue(A2W(pEventTrace->strTexture));
...
void CPropertyPane::ApplyVisualEffectEventProperties( const SEventVisualEffect* pEventVisualEffect ) 
{
    ...
    m_pVEName->SetValue(A2W(pEventVisualEffect->chEffectName));
    m_pVEBoneType->SetEnum(pEventVisualEffect->eBoneType);
    m_pVEBoneName->SetValue(A2W(pEventVisualEffect->chBoneName));            
    m_pVEWeaponBoneName->SetValue(A2W(pEventVisualEffect->chBoneName));
...
void CPropertyPane::SetVisualEffectEventProperties( SEventVisualEffect* pEventVisualEffect, UINT nID ) 
{
    ...
    case ID_VE_TIME:        
        ...
        break;
    case ID_VE_NAME:        
        if(!CNtlPLPropertyContainer::GetInstance()->GetProperty(PLENTITY_EFFECT, W2A(m_pVEName->GetValue())))
        {
            MessageBox(L"Not Exist Effect!");
            return;
        }
        else
        {
            strcpy_s(pEventVisualEffect->chEffectName, W2A( m_pVEName->GetValue()));
        }        
        break;
    ...
    case ID_VE_BONE_NAME:         
        strncpy(pEventVisualEffect->chBoneName, W2A(m_pVEBoneName->GetValue()), MAX_DEFAULT_NAME);
        break;
    case ID_VE_SUB_WEAPON_BONE_NAME:
        strcpy(pEventVisualEffect->chBoneName, W2A(m_pVEWeaponBoneName->GetValue()));
        break;    
...
void CPropertyPane::ApplyPostEffectEventProperties( const SEventPostEffect* pEventPostEffect ) 
{
	...
	m_pPEEffectName->SetValue(A2W(pEventPostEffect->szPostEffectName));
    ...
    m_pPEPCBoneName->SetValue(A2W(pEventPostEffect->szPCBoneName));
...
void CPropertyPane::SetPostEffectEventProperties( SEventPostEffect* pEventPostEffect, UINT nID ) 
{
    ...
    case ID_PE_TIME:
        ...
        break;
    case ID_PE_NAME:
        strcpy(pEventPostEffect->szPostEffectName, W2A(m_pPEEffectName->GetValue()));
        break;
    case ID_PE_TARGET:
    ...
    case ID_PE_TARGET_HEIGHT:
        ...
        break;
    case ID_PE_PC_BONE:
        strcpy_s(pEventPostEffect->szPCBoneName, W2A(m_pPEPCBoneName->GetValue()));
        break;
    }
}
...
void CPropertyPane::ApplyTMQEventProperties( const SEventTMQ* pEventTMQ ) 
{
    m_pTMQTime->SetDouble(pEventTMQ->fTime);
    m_pTMQType->SetEnum(pEventTMQ->eTMQEventType);    
}

void CPropertyPane::SetTMQEventProperties( SEventTMQ* pEventTMQ, UINT nID ) 
{
    switch(nID)
    {
    case ID_TMQ_TIME:
        ...
        break;
    case ID_TMQ_TYPE:
        pEventTMQ->eTMQEventType = (ETMQEventType)m_pTMQType->GetEnum();
        break;    
    }
}
...
void CPropertyPane::SetAtomicList(const SEventAlpha* pEventAlpah)
{
    ...
    for(UINT i = 0; i < vAtomicNames.size(); ++i)
    {
        ...
        m_pAlphaAtomic[i]->SetCaption(A2W(strAtomicName.c_str()));
...
void CPropertyPane::ApplyUpgradeEffectProperties( const SUpgradeEffectProperty* pUpgradeEffectProperty ) 
{
    ...
    m_pUpgradeBone1->SetValue(A2W(pUpgradeEffectProperty->szBone1));
    m_pUpgradeBone2->SetValue(A2W(pUpgradeEffectProperty->szBone2));
    m_pUpgradeEffect1->SetValue(A2W(pUpgradeEffectProperty->szEffect1));
    m_pUpgradeEffect2->SetValue(A2W(pUpgradeEffectProperty->szEffect2));
...
void CPropertyPane::SetUpgradeEffectProperties( SUpgradeEffectProperty* pUpgradeEffectProperty, UINT nID ) 
{
    ...
    case ID_UPGRADE_BONE1:
        sprintf_s(pUpgradeEffectProperty->szBone1, "%s", W2A(m_pUpgradeBone1->GetValue()));
        break;
    case ID_UPGRADE_BONE2:
        sprintf_s(pUpgradeEffectProperty->szBone2, "%s", W2A(m_pUpgradeBone2->GetValue()));
        break;
    case ID_UPGRADE_EFFECT1:
        sprintf_s(pUpgradeEffectProperty->szEffect1, "%s", W2A(m_pUpgradeEffect1->GetValue()));
        break;
    case ID_UPGRADE_EFFECT2:
        sprintf_s(pUpgradeEffectProperty->szEffect2, "%s", W2A(m_pUpgradeEffect2->GetValue()));
        break;
...
void CPropertyPane::ApplySoundEventProperties( const SEventSound* pEventSound ) 
{
    ...
    m_pSESoundName1->SetValue(A2W(pEventSound->chSoundName));
    m_pSESoundName2->SetValue(A2W(pEventSound->chSoundName2));
    m_pSESoundName3->SetValue(A2W(pEventSound->chSoundName3));
    m_pSESoundName4->SetValue(A2W(pEventSound->chSoundName4));
    ...
    case ID_SE_SOUND_NAME1:      
        {
            ...
            sprintf_s(pEventSound->chSoundName, "%s", W2A(strSoundName));
        }        
        break;
    case ID_SE_SOUND_NAME2:
        {
            ...
            sprintf_s(pEventSound->chSoundName2, "%s", W2A(strSoundName));
        }        
        break;
    case ID_SE_SOUND_NAME3:
        {
            ...
            sprintf_s(pEventSound->chSoundName3, "%s", W2A(strSoundName));
        }        
        break;
    case ID_SE_SOUND_NAME4:
        {
            ...
            sprintf_s(pEventSound->chSoundName4, "%s", W2A(strSoundName));
        }        
        break;
...
void CPropertyPane::ApplyStretchEventProperties( const SEventStretch* pEventStretch ) 
{
    ...
    m_pStretchBoneName[0]->SetValue(A2W(pEventStretch->szBoneName[0]));
    m_pStretchBoneName[1]->SetValue(A2W(pEventStretch->szBoneName[1]));
    ...
    m_pStretchScaleName->SetValue(A2W(pEventStretch->szScaleBone));
    m_pStretchScaleSize->SetDouble(pEventStretch->fScaleSize);
    m_pStretchAxisBoneName->SetValue(A2W(pEventStretch->szAxisBone));
    m_pStretchTargetEffect->SetValue(A2W(pEventStretch->szTargetEffect));
}
...
void CPropertyPane::SetStretchEventProperties( SEventStretch* pEventStretch, UINT nID ) 
{
    ...
    case ID_STRETCH_BONE1_NAME:                
        sprintf_s(pEventStretch->szBoneName[0], "%s", W2A(m_pStretchBoneName[0]->GetValue()));
        break;
    case ID_STRETCH_BONE2_NAME:        
        sprintf_s(pEventStretch->szBoneName[1], "%s", W2A(m_pStretchBoneName[1]->GetValue()));
        break;
    ...
    case ID_STRETCH_SCALE_NAME:
        sprintf_s(pEventStretch->szScaleBone, "%s", W2A(m_pStretchScaleName->GetValue()));
        break;
    case ID_STRETCH_SCALE_SIZE:
        pEventStretch->fScaleSize = (RwReal)m_pStretchScaleSize->GetDouble();
        break;
    case ID_STRETCH_AXIS_BONE:
        sprintf_s(pEventStretch->szAxisBone, "%s", W2A(m_pStretchAxisBoneName->GetValue()));
        break;
    case ID_STRETCH_TARGET_EFFECT:
        sprintf_s(pEventStretch->szTargetEffect, "%s", W2A(m_pStretchTargetEffect->GetValue()));
        break;
    }
}
...
void CPropertyPane::SetObjectProperties( CMTObject* pObject, UINT nID ) 
{
    ...
    case ID_OBJ_UVANIM:
        {
            CString strWorkFolder = A2W(CModelToolApplication::GetInstance()->GetWorkDir());
            CString strUVAnimFileName = m_pObjUVAnim->GetValue();
            strWorkFolder.MakeUpper();
            strUVAnimFileName.MakeUpper();
            strUVAnimFileName.Replace(strWorkFolder, L".");
            m_pObjUVAnim->SetValue(strUVAnimFileName);

            pObject->GetProperty()->m_strUVAnimFileName = W2A(strUVAnimFileName);

            ::SetCurrentDirectoryA(CModelToolApplication::GetInstance()->GetWorkDir());
            if(pObject->SetUVAnim(W2A(strUVAnimFileName)))    
            {
            ...
            {
                MessageBox(L"UV Anim Setup Fail", NULL, MB_ICONERROR);
            }
        }        
        break;
    ...
    case ID_OBJ_ANIM:
        {
            ...
            strAnimFileName.Replace(strWorkFolder, L".");

            ::SetCurrentDirectoryA(CModelToolApplication::GetInstance()->GetWorkDir());
            m_pObjAnim->SetValue(strAnimFileName);
            pObject->GetProperty()->m_strAnimFileName = W2A(strAnimFileName);
            if(!pObject->SetAnimation(W2A(strAnimFileName)))
            {
                MessageBox(L"Animation Setup Fail!", NULL, MB_ICONERROR);
            }
        }
        break;
    case ID_OBJ_COLLISON_MESH:
        {
            ...
            pObject->GetProperty()->m_strCollisionMeshName = W2A(strCollisonMeshName);               
        }                
        break;
    case ID_OBJ_TYPE:
    ...
    case ID_SE_SOUND_NAME1:
        {
            ...
            sprintf_s(pObject->GetProperty()->GetSoundProp()->chSoundName, "%s", W2A(strSoundName));
