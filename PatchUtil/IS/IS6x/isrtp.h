...
//----------------------------------------------------
// Constants for the /y switch. Do not edit.
//----------------------------------------------------
# define ISSHARED				"Y"
# define ISSELFREG				"Y"
# define ISBACKUP				"Y"
...
//----------------------------------------------------------
prototype isrtp16.ISRTPatch16( NUMBER, BYVAL STRING, BYVAL STRING, BYVAL STRING, BYVAL STRING, BYVAL STRING, LONG, LONG, LONG );
prototype isrtp32.ISRTPatch32( NUMBER, BYVAL STRING, BYVAL STRING, BYVAL STRING, BYVAL STRING, BYVAL STRING, LONG, LONG, LONG );

//-------------------------------------------------------------------
// GetCurrentDirectory and GetCurrentFolder - used to store the CWD
//-------------------------------------------------------------------
prototype NUMBER KERNEL.GetCurrentDirectory ( NUMBER, BYREF STRING ); 
prototype NUMBER GetCurrentFolder( BYREF STRING ); 


//-------------------------------------------------------------------
// ISRTPatch16SetText and ISRTPatch32SetText - secondary entry points
//-------------------------------------------------------------------
prototype isrtp16.ISRTPatch16SetText( BYREF STRING, BYREF STRING, BYREF STRING, BYREF STRING );
prototype isrtp32.ISRTPatch32SetText( BYREF STRING, BYREF STRING, BYREF STRING, BYREF STRING );
...
//---------------------------------------------
// ISRTPatchCommitChanges - script function prototype
//---------------------------------------------
prototype ISRTPatchCommitChanges (
	STRING); 	// path to ISRTPxx.DLL-created log file, should be CWD
