...
enum eOPCODE_GU
{
	...
	GU_SESSION_STATE_WRONG, // ÇöÀç ¼¼¼Ç »óÅÂ¿Í Å¬¶óÀÌ¾ðÆ®ÀÇ ¿äÃ»ÀÌ ¸ÂÁö ¾Ê´Ù.
	GU_CHAR_STATE_WRONG, // ÇöÀç Ä³¸¯ÅÍ »óÅÂ¿Í Å¬¶óÀÌ¾ðÆ®ÀÇ ¿äÃ»ÀÌ ¸ÂÁö ¾Ê´Ù.
	...
	GU_AVATAR_ZONE_INFO,
	GU_AVATAR_QUEST_COMPLETE_INFO,	// Äù½ºÆ® ¿Ï·á Á¤º¸
	GU_AVATAR_QUEST_PROGRESS_INFO,	// Äù½ºÆ® ÁøÇà Á¤º¸
	GU_AVATAR_QUEST_INVENTORY_INFO,	// Äù½ºÆ® ÀÎº¥ Á¤º¸
	GU_AVATAR_INFO_END,
	...
	GU_CHAR_MOVE, // ÀÌµ¿
	GU_CHAR_DEST_MOVE, // ¸ñÀûÁöÀÌµ¿
	GU_CHAR_CHANGE_HEADING, // ¹æÇâ È¸Àü
	GU_CHAR_MOVE_SYNC, // À§Ä¡ º¸Á¤
	GU_CHAR_CHANGE_JUMP_DIRECTION, // Ä³¸¯ÅÍ Á¡ÇÁ ¹æÇâ
	GU_CHAR_CHANGE_DIRECTION_ON_FLOATING,		// Ä³¸¯ÅÍ Á¡ÇÁ/falling ¶§ÀÇ ¹Ù¶óº¸´Â ¹æÇâ
	GU_CHAR_FOLLOW_MOVE, // µû¶ó°¡±â
	GU_CHAR_JUMP, // Á¡ÇÁ
	GU_CHAR_JUMP_END, // Á¡ÇÁ ³¡
	GU_CHAR_PUSHED_NFY,							// Push ¹ß»ý
	GU_CHAR_FIGHTMODE, // °ø°Ý¸ðµå
	GU_CHAR_BLOCK_MODE_COOL_TIME_NFY, // Block ¸ðµå ÄðÅ¸ÀÓ countÀÇ ½ÃÀÛ ¾Ë¸²
	//------------------------------------------------------------------
	//  [5/24/2006 zeroera] : º¸¿ÏÇÊ¿ä : Á»´õ È¿À²ÀûÀÎ Àü¼ÛÀ» À§ÇØ »óÅÂ ´ë½Å ´ÙÀ½ÀÇ ¸Þ½ÃÁöµé·Îµµ Àü¼Û °¡´ÉÇÏ´Ù
	// ÇöÀç´Â »óÅÂ ¾÷µ¥ÀÌÆ® ¸Þ½ÃÁö·Î Ã³¸®ÇÏ¹Ç·Î »ç¿ë ÇÏÁö ¾Ê´Â´Ù.
	//------------------------------------------------------------------
	GU_CHAR_SITDOWN,
	GU_CHAR_STANDUP,
	GU_CHAR_CAMPING,
	...
	GU_CHAR_DIALOG,									// Ä³¸¯ÅÍ ´ëÈ­ Ãâ·Â
	GU_CHAR_DIRECT_PLAY,							// Ä³¸¯ÅÍ ¿¬Ãâ
	GU_CHAR_DIRECT_PLAY_END,					// Ä³¸¯ÅÍ ¿¬Ãâ ³¡ ( sync°¡ ¼³Á¤µÇ¾î ÀÖ´Â °æ¿ì¿¡¸¸ Àü¼Û )
	GU_CHAR_AWAY_RES,
	GU_CHAR_MAIL_INFO,	
	GU_CHAR_KEY_INFO,
	...
	GU_SKILL_CASTING_DELAYED_NFY,					// ½ºÅ³ Ä³½ºÆÃÀÌ Áö¿¬µÇ¾úÀ½À» ¾Ë¸²
	...
	GU_SKILL_NOTIFY_EXP,
	GU_SKILL_AFTEREFFECT_REMAINING_TIME_NFY,		// º¯½Å ÈÄÀ¯Áõ ÄðÅ¸ÀÓ countÀÇ ½ÃÀÛ ¾Ë¸²
	GU_SKILL_COOL_TIME_STARTED_NFY,					// ½ºÅ³ÀÇ cool timeÀÌ ½ÃÀÛµÇ¾úÀ½À» ¾Ë¸²

	GU_HTB_START_RES, // HTB ½ÃÀÛ ÀÀ´ä
	GU_HTB_LEARN_RES, // HTB ½Àµæ ÀÀ´ä
	GU_HTB_FORWARD_RES, // HTB ÁøÇà ÀÀ´ä
	...
	GU_BUFF_DROPPED,
	GU_BUFF_REFRESH_ALL,
	GU_BUFF_DROP_RES,				// Buff ÇØÁ¦ ¿äÃ»¿¡ ´ëÇÑ °á°ú
	...
	GU_ITEM_DELETE,
	GU_ITEM_DELETE_RES,
	GU_ITEM_EQUIP_REPAIR_RES,			// ¼ö¸® ¿Ï·á ÀÀ´ä
	GU_ITEM_REPAIR_RES,
	GU_ITEM_USE_RES, // ¾ÆÀÌÅÛ »ç¿ë ¿äÃ»¿¡ ´ëÇÑ °á°ú
	GU_ITEM_CASTING_CANCELED,		// ¾ÆÀÌÅÛ Ä³½ºÆÃÀÌ Ãë¼ÒµÇ¾úÀ½À» ¾Ë¸²
	GU_ITEM_CASTING_DELAYED_NFY,					// ¾ÆÀÌÅÛ Ä³½ºÆÃÀÌ Áö¿¬µÇ¾úÀ½À» ¾Ë¸²
	GU_ITEM_DUR_DOWN,
	GU_ITEM_DUR_UPDATE,
	...
	GU_UPDATE_ITEM_EQUIP,	// neighbor pc¿¡¸¸ Àü´ÞÇÑ´Ù.
	...
	GU_SYSTEM_DISPLAY_TEXT, // ÅØ½ºÆ® µð½ºÇÃ·¹ÀÌ
	GU_SYSTEM_DISPLAY_RESULTCODE,	// ResultCode ÅØ½ºÆ®¸¦ Å¬¶óÀÌ¾ðÆ®¿¡ Ãâ·ÂÇÑ´Ù.

	GU_SHOP_START_RES,
	GU_SHOP_BUY_RES,
	GU_SHOP_SELL_RES,
	GU_SHOP_END_RES,
	GU_SHOP_SKILL_BUY_RES,		// ½ºÅ³ ±¸¸Å ÀÀ´ä
	...
	GU_SOCIAL_ACTION, // Social Action »ç¿ë

	GU_SCOUTER_INDICATOR_RES, // ½ºÄ«¿ìÅÍ ÀüÅõ·ÂÃøÁ¤ °á°ú
	GU_SCOUTER_PREDICT_RES,
	GU_SCOUTER_EQUIP_CHECK_RES,
	GU_SCOUTER_CHIP_REMOVE_ALL_RES,

	GU_TS_CONFIRM_STEP_RES,							// Æ®¸®°Å ´Ü°è ÁøÇà ÀÀ´ä
	GU_TS_UPDATE_SYNC_NFY,							// Æ®¸®°Å µ¿±â ÁøÇà ¾Ë¸²
	GU_TS_UPDATE_STATE,								// Æ®¸®°Å ½ÇÆÐ »óÅÂ ¾÷µ¥ÀÌÆ®
	GU_TS_UPDATE_EVENT_NFY,							// Æ®¸®°Å ÀÌº¥Æ® ¾÷µ¥ÀÌÆ®
	GU_TS_EXCUTE_TRIGGER,							// Å¬¶óÀÌ¾ðÆ® Æ®¸®°Å °­Á¦ ½ÇÇà
	...
	GU_QUEST_ITEM_CREATE_NFY,						// Äù½ºÆ® ¾ÆÀÌÅÛ »ý¼º ¾Ë¸²
	GU_QUEST_ITEM_DELETE_NFY,						// Äù½ºÆ® ¾ÆÀÌÅÛ »èÁ¦ ¾Ë¸²
	GU_QUEST_ITEM_UPDATE_NFY,						// Äù½ºÆ® ¾ÆÀÌÅÛ º¯°æ ¾Ë¸²
	GU_QUEST_ITEM_MOVE_RES,							// Äù½ºÆ® ¾ÆÀÌÅÛ ÀÌµ¿ ÀÀ´ä
	GU_QUEST_ITEM_DELETE_RES,						// Äù½ºÆ® ¾ÆÀÌÅÛ »èÁ¦ ÀÀ´ä
	GU_QUEST_SVREVT_START_NFY,						// Äù½ºÆ® ÀÌº¥Æ® ½ÃÀÛ
	GU_QUEST_SVREVT_END_NFY,						// Äù½ºÆ® ÀÌº¥Æ® Á¾·á
	GU_QUEST_SVREVT_UPDATE_NFY,						// Äù½ºÆ® ÀÌº¥Æ® ¾÷µ¥ÀÌÆ®
	GU_QUEST_GIVEUP_RES,							// Äù½ºÆ® Æ÷±â ÀÀ´ä
	GU_QUEST_SHARE_NFY,								// Äù½ºÆ® °øÀ¯
	GU_QUEST_RESET_NFY,								// Äù½ºÆ®ÀÇ ÁöÁ¤µÈ ¹üÀ§¸¸Å­ ÁøÇà Á¤º¸¿Í ¿Ï·á Á¤º¸¸¦ »èÁ¦ÇÑ´Ù.
	GU_QUEST_OBJECT_VISIT_RES,						// npc, tobject ¹æ¹® ÀÌº¥Æ®
	GU_QUEST_FORCED_COMPLETION_NFY,					// Äù½ºÆ® °­Á¦ ¿Ï·á ¼³Á¤(Å×½ºÆ®¿ë)

	GU_FREEBATTLE_CHALLENGE_RES,					// ÇÁ¸®¹èÆ² ´ëÀü ½ÅÃ» ÀÀ´ä
	GU_FREEBATTLE_ACCEPT_REQ,						// ÇÁ¸®¹èÆ² ´ëÀü¼ö¶ô ¿äÃ»
	GU_FREEBATTLE_CANCEL_NFY,						// ÇÁ¸®¹èÆ² ´ëÀü Ãë¼Ò
	GU_FREEBATTLE_START_NFY,						// ÇÁ¸®¹èÆ² ´ëÀü ½ÃÀÛ
	GU_FREEBATTLE_OUTSIDE_NFY,						// ÇÁ¸®¹èÆ² ´ëÀü¹üÀ§ ¹þ¾î³²
	GU_FREEBATTLE_INSIDE_NFY,						// ÇÁ¸®¹èÆ² ´ëÀü¹üÀ§ µé¾î¿È
	GU_FREEBATTLE_END_NFY,							// ÇÁ¸®¹èÆ² ´ëÀü Á¾·á
	GU_WORLD_FREE_PVP_ZONE_ENTERED_NFY,				//Open PVP Zones
	GU_WORLD_FREE_PVP_ZONE_LEFT_NFY,

	GU_QUICK_SLOT_UPDATE_RES,						// Äü½½·Ô¾÷µ¥ÀÌÆ®
	GU_QUICK_SLOT_DEL_NFY,							// Äü½½·Ô »èÁ¦	
	GU_QUICK_SLOT_INFO,								// QuickSlot Load

	GU_PET_CHAR_INFO,
	GU_PET_SKILL_INFO,
	GU_PET_INFO_END,
	GU_PET_DESPAWNED_NFY,							// ÆêÀÇ »ç¶óÁü
	GU_PET_DISMISS_PET_RES,							// ÆêÀÇ ¼ÒÈ¯ Ãë¼Ò ¿äÃ» °á°ú

	GU_ACTION_REPORT_MESSAGE,						// Ç¥½ÃÇÏ°í ½ÍÀº ¸Þ¼¼Áö¸¦ ¸®Á®Æ® ÄÚµå ÀÎµ¦½º¸¦ Ã·ºÎÇÏ¿© º¸³»¸é Å¬¶óÀÌ¾ðÆ®´Â Ç¥½ÃÇÑ´Ù.
	...
	GU_GUILD_NAME_CHANGED_NFY,					// ±æµå ÀÌ¸§ º¯°æ ¾Ë¸²
	GU_GUILD_CREATE_RES,						// ±æµå »ý¼º ¿äÃ» °á°ú
	GU_GUILD_INVITE_RES,						// ±æµå ÃÊ´ë °á°ú

	GU_TOBJECT_UPDATE_STATE,						// Æ®¸®°Å ¿ÀºêÁ§Æ® »óÅÂ ¾÷µ¥ÀÌÆ®
	GU_TOBJECT_ACTION_ATTACK,						// Æ®¸®°Å ¿ÀºêÁ§Æ® µ¥¹ÌÁö
	
	GU_TUTORIAL_HINT_UPDATE_RES,					// ÈùÆ® ÇÃ·¡±× ¾÷µ¥ÀÌÆ®

	GU_TELECAST_MESSAGE_BEG_NFY,					// ¹æ¼Û ¸Þ½ÃÁö ÅëÁö ½ÃÀÛ
	GU_TELECAST_MESSAGE_END_NFY,					// ¹æ¼Û ¸Þ½ÃÁö ÅëÁö Á¾·á
	GU_BROAD_MESSAGE_BEG_NFY,						// ¹æ¼Û ¸Þ½ÃÁö ½ÃÀÛ
	GU_BROAD_MESSAGE_END_NFY,						// ¹æ¼Û ¸Þ½ÃÁö ³¡
	GU_MINI_NARRATION_NFY,							// ¹Ì´Ï³ª·¹ÀÌ¼Ç
	GU_PROGRESS_MESSAGE_NFY,						// Å¸ÀÓ¸Ó½Å ÁøÇà ¸Þ½ÃÁö ÅëÁö
	GU_DIRECTION_INDICATE_NFY,						// ¹æÇâÁö½Ã ÅëÁö

	GU_TIMEQUEST_ROOM_LIST_RES,						// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ¹æ ¸ñ·Ï ¿äÃ» ÀÀ´ä
	GU_TIMEQUEST_ROOM_INFO_RES,						// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ¹æ Á¤º¸ ¿äÃ» ÀÀ´ä
	GU_TIMEQUEST_ROOM_JOIN_RES,						// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ¹æ ÁøÀÔ ¿äÃ» ÀÀ´ä
	GU_TIMEQUEST_ROOM_JOIN_NFY,						// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ¹æ ÁøÀÔÀ» ÆÄÆ¼¿ø¿¡°Ô ¾Ë¸²(ÆÄÆ¼Àå Á¦¿Ü)
	GU_TIMEQUEST_ROOM_LEAVE_RES,					// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ¹æ ÅðÀå ¿äÃ» ÀÀ´ä
	GU_TIMEQUEST_ROOM_LEAVE_NFY,					// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ¹æ ÅðÀåÀ» ÆÄÆ¼¿ø¿¡°Ô ¾Ë¸²(ÆÄÆ¼Àå Á¦¿Ü)
	GU_TIMEQUEST_ROOM_SELECTION_NFY,				// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ÃßÃ·
	GU_TIMEQUEST_ROOM_TELEPORT_RES,					// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ½ÃÀÛ À§Ä¡·Î ÀÌµ¿ ÀÀ´ä
	GU_TIMEQUEST_START_NFY,							// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ½ÃÀÛ ÅëÁö
	GU_TIMEQUEST_START_EXCEPTION_NFY,				// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ¿ùµå¿¡ ÁøÀÔ ½ÇÆÐÇÔ(¼º°ø½Ã¿¡´Â Àü¼ÛµÇÁö ¾Ê´Â´Ù.)
	GU_TIMEQUEST_LEAVE_NFY,							// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ÅðÀå ÅëÁö
	GU_TIMEQUEST_COUNTDOWN_NFY,						// Å¸ÀÓ¸Ó½Å Äù½ºÆ® Ä«¿îÆ®´Ù¿î ÅëÁö
	GU_TIMEQUEST_REWARD_NFY,						// Å¸ÀÓ¸Ó½Å Äù½ºÆ® º¸»ó ÅëÁö
	GU_TIMEQUEST_INFORMATION_NFY,				// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ½ºÅ×ÀÌÁö Á¤º¸ ÅëÁö
	GU_TIMEQUEST_UPDATE_GAME_STATE,					// Å¸ÀÓ¸Ó½Å Äù½ºÆ® °ÔÀÓ »óÅÂ ¾÷µ¥ÀÌÆ®
	GU_TIMEQUEST_UPDATE_KILL_COUNT,					// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ÇÃ·¹ÀÌ¾î Å³ Ä«¿îÆ® ¾÷µ¥ÀÌÆ®
	GU_TIMEQUEST_UPDATE_COUPON_COUNT,				// Å¸ÀÓ¸Ó½Å Äù½ºÆ® ÄíÆùÁ¤º¸ ¾÷µ¥ÀÌÆ®
	GU_TIMEQUEST_UPDATE_TMQ_POINT,					// Å¸ÀÓ¸Ó½Å Äù½ºÆ® TMQ Æ÷ÀÎÆ® ¾÷µ¥ÀÌÆ®
	GU_TIMEQUEST_UPDATE_GAME_TIME,					// Å¸ÀÓ¸Ó½Å Äù½ºÆ® °ÔÀÓ ½Ã°£ ¾÷µ¥ÀÌÆ®

	GU_RANKBATTLE_INFO_RES,							// ±âº» Á¤º¸
	GU_RANKBATTLE_JOIN_RES,							// ½ÅÃ»
	GU_RANKBATTLE_JOIN_NFY,							// member ¿¡°Ô ½ÅÃ» ¾Ë¸²
	GU_RANKBATTLE_LEAVE_RES,						// Ãë¼Ò
	GU_RANKBATTLE_LEAVE_NFY,						// Ãë¼Ò ÆÄÆ¼¿ø ¾Ë¸²
	GU_RANKBATTLE_MATCH_START_NFY,					// °æ±â ½ÃÀÛ
	GU_RANKBATTLE_MATCH_CANCELED_NFY,				// °æ±â°¡ Ãë¼ÒµÊ

	GU_RANKBATTLE_ROOM_LIST_RES,					// RankBattle ¹æ ¸ñ·Ï ¿äÃ»
	GU_RANKBATTLE_ROOM_INFO_RES,					// RankBattle ¹æ Á¤º¸ ¿äÃ»
	GU_RANKBATTLE_ROOM_CREATE_RES,					// RankBattle ¹æ »ý¼º ¿äÃ»
	GU_RANKBATTLE_ROOM_CREATE_NFY,					// RankBattle ¹æÀÌ »ý¼ºµÇ¾úÀ½À» ÆÄÆ¼¿ø¿¡°Ô ¾Ë¸²
	GU_RANKBATTLE_ROOM_LEAVE_RES,					// RankBattle ¹æ »èÁ¦ ¿äÃ»
	GU_RANKBATTLE_ROOM_LEAVE_NFY,					// RankBattle ¹æÀÌ »èÁ¦µÇ¾úÀ½À» ÆÄÆ¼¿ø¿¡°Ô ¾Ë¸²
	GU_RANKBATTLE_ROOM_JOIN_INFO_NFY,				// Party¿¡ µé¾î°¬À» °æ¿ì RankBattle¿¡ ´ëÇÑ Âü¿© Á¤º¸¸¦ Àü¼Û
	GU_RANKBATTLE_ROOM_CHALLENGE_RES,				// RankBattle ´ë·Ã ¿äÃ»
	GU_RANKBATTLE_ROOM_CHALLENGE_NFY,				// RankBattle ´ë·Ã ¿äÃ» °á°ú¸¦ ÆÄÆ¼¿ø¿¡°Ô ¾Ë¸²
	GU_RANKBATTLE_ROOM_MATCH_READY_NFY,				// RankBattleÀÌ °ð ½ÃÀÛµÊÀ» ¾Ë¸²
	GU_RANKBATTLE_ROOM_MATCH_START_NFY,				// RankBattleÀÌ ½ÃÀÛµÊ - °æ±âÀåÀ¸·Î ÀÌµ¿
	GU_RANKBATTLE_ROOM_MATCH_CANCEL_RES,			// RankBattle ´ëÀüÀ» Ãë¼ÒÇÔ(°³ÀÎ)
	GU_RANKBATTLE_ROOM_MATCH_CANCELED_NFY,			// RankBattle ´ëÀüÀÌ Ãë¼ÒµÊ(owner ¿¡°Ô¸¸ Àü¼Û, ´Ù½Ã ´ë±â»óÅÂ·Î º¯°æ)
	GU_RANKBATTLE_BATTLE_STATE_UPDATE_NFY,			// RankBattle Battle State¸¦ ¾÷µ¥ÀÌÆ®(°æ±âÀåÀÇ »óÅÂ)
	GU_RANKBATTLE_BATTLE_TEAM_INFO_NFY,				// RankBattle Team Á¤º¸¸¦ ¾Ë¸²
	GU_RANKBATTLE_BATTLE_PLAYER_STATE_NFY,			// RankBattle PlayerÀÇ »óÅÂ ¾Ë¸²(Àå¿Ü, Á×À½µî)
	GU_RANKBATTLE_BATTLE_KILLSCORE_UPDATE_NFY,		// RankBattle KillScore ¾÷µ¥ÀÌÆ®
	GU_RANKBATTLE_BATTLE_STAGE_FINISH_NFY,			// RankBattle Stage Finish - Stage ¸¶Ä§
	GU_RANKBATTLE_BATTLE_MATCH_FINISH_NFY,			// RankBattle Battle Finish - °æ±â ¸¶Ä§
	GU_RANKBATTLE_BATTLE_END_NFY,					// RankBattleÀÌ ³¡³¯¶§ pc¿¡°Ô ¾Ë¸²(PC ¸¶´Ù BattleÀÌ ³¡³ª´Â ½ÃÁ¡ÀÌ ´Ù¸£¹Ç·Î)
	GU_RANKBATTLE_BATTLE_FORCED_LEAVE_NFY,			// RankBattle ¿¡¼­ °­Á¦ÀûÀ¸·Î WorldLeave µÊ(³Ê¹« ¿À·£ ·Îµù »óÅÂ µî)
	GU_RANKBATTLE_TOTAL_SCORE_UPDATE_NFY,			// °³ÀÎ ÀüÀû ¾÷µ¥ÀÌÆ®

	GU_DRAGONBALL_START_RES,						// Á¦´ÜÅ¬¸¯
	GU_DRAGONBALL_CHECK_RES,						// µå·¡°ïº¼ UI 7°³ ¹èÄ¡OK
	GU_DRAGONBALL_REWARD_RES,						// µå·¡°ïº¼ ´Ù ¸ðÀ½¿¡ ´ëÇÑ º¸»ó ¼±ÅÃ ¿äÃ»
	GU_DRAGONBALL_COLLECT_NFY,						// µå·¡°ïº¼ ½ºÄÉÁì Å¸ÀÓ ¿À¹öÅëº¸
	GU_DRAGONBALL_SCHEDULE_INFO,						// µå·¡°ïº¼ ¼öÁý±â°£ Á¤º¸

	GU_PRIVATESHOP_CREATE_RES,							// °³ÀÎ»óÁ¡À» »ý¼º [6/28/2007 SGpro]
	GU_PRIVATESHOP_CREATE_NFY,							// °³ÀÎ»óÁ¡ ¿¹¿Ü [1/31/2008 SGpro]
	GU_PRIVATESHOP_EXIT_RES,							// °³ÀÎ»óÁ¡À» ´Ý´Â´Ù[6/28/2007 SGpro]
	GU_PRIVATESHOP_OPEN_RES,							// °³ÀÎ»óÁ¡¿¡ »óÅÂ¸¦ OpenÀ¸·Î ÇØÁÖ¼¼¿ä[6/28/2007 SGpro]
	GU_PRIVATESHOP_OPEN_NFY,							// [7/31/2007 SGpro]
	GU_PRIVATESHOP_CLOSE_RES,							// °³ÀÎ»óÁ¡¿¡ »óÅÂ¸¦ CloseÀ¸·Î ÇØÁÖ¼¼¿ä[6/28/2007 SGpro]
	GU_PRIVATESHOP_CLOSE_NFY,							// [7/31/2007 SGpro]
	GU_PRIVATESHOP_ITEM_INSERT_RES,						// °³ÀÎ»óÁ¡¿¡ ¾ÆÀÌÅÛ Ãß°¡ ÀÀ´ä[6/29/2007 SGpro]
	GU_PRIVATESHOP_ITEM_UPDATE_RES,						// °³ÀÎ»óÁ¡¿¡ ¾ÆÀÌÅÛ ¼öÁ¤ ÀÀ´ä[6/29/2007 SGpro]
	GU_PRIVATESHOP_ITEM_DELETE_RES,						// °³ÀÎ»óÁ¡¿¡ ¾ÆÀÌÅÛ »èÁ¦ ÀÀ´ä[6/29/2007 SGpro]
	GU_PRIVATESHOP_ITEM_BUYING_RES,						// ¾ÆÀÌÅÛ ±¸¸Å ÀÀ´ä[6/29/2007 SGpro]
	GU_PRIVATESHOP_ITEM_BUYING_NFY,						// [7/31/2007 SGpro]
	GU_PRIVATESHOP_ENTER_RES,							// ¼Õ´Ô ÀÔÀå ÀÀ´ä[6/29/2007 SGpro]
	GU_PRIVATESHOP_LEAVE_RES,							// ¼Õ´Ô ÅðÀå ÀÀ´ä[6/29/2007 SGpro]
	GU_PRIVATESHOP_ITEM_DATA_INFO,						// ¾ÆÀÌÅÛ µ¥ÀÌÅ¸ [7/2/2007 SGpro]
	...
	GU_TUTORIAL_WAIT_NFY,								// Æ©Åä¸®¾ó ´ë±â ¾Ë¸² 
	GU_TUTORIAL_WAIT_CANCEL_RES,						// Æ©Åä¸®¾ó ´ë±â Ãë¼Ò ¿äÃ» ÀÀ´ä
	GU_TUTORIAL_PLAY_QUIT_RES,							// Æ©Åä¸®¾ó ÇÃ·¹ÀÌ Ãë¼Ò ¿äÃ» ÀÀ´ä
	...
	GU_BOT_BOTCAUTION_NFY,// Bot °æ°í [2/20/2008 SGpro]
	...
	GU_MATCH_MINORMATCH_TEAM_INFO_NFY,				// ¿¹¼± ÆÀ Á¤º¸
	GU_MATCH_MINORMATCH_PLAYER_STATE_NFY,			//
	GU_MATCH_MINORMATCH_UPDATE_SCORE_NFY,			// ¿¹¼± Score Update
	GU_MATCH_MINORMATCH_TEAM_SCORE_NFY,				// ¿¹¼± ÆÀ ½ºÄÚ¾î Á¤º¸, ³­ÀÔÀÚ¸¦ À§ÇÑ Á¤º¸
	GU_MATCH_MINORMATCH_SELECTION_NFY,				// ¿¹¼± µ¿Á¡ ¹ß»ý½Ã ÁÖ»çÀ§ ¿¬Ãâ
	GU_MATCH_MINORMATCH_STAGE_FINISH_NFY,			// ¿¹¼± stage finish ¾Ë¸²
	GU_MATCH_MINORMATCH_MATCH_FINISH_NFY,

	GU_MATCH_MAJORMATCH_STATE_UPDATE_NFY,			//
	GU_MATCH_MAJORMATCH_TEAM_INFO_NFY,				// º»¼± ÆÀ Á¤º¸
	GU_MATCH_MAJORMATCH_PLAYER_STATE_NFY,			//
	GU_MATCH_MAJORMATCH_UPDATE_SCORE_NFY,			// º»¼± Score Update
	GU_MATCH_MAJORMATCH_STAGE_FINISH_NFY,			// º»¼± stage finish ¾Ë¸²
	GU_MATCH_MAJORMATCH_MATCH_FINISH_NFY,			// º»¼± match finish ¾Ë¸²

	GU_MATCH_FINALMATCH_STATE_UPDATE_NFY,			//
	GU_MATCH_FINALMATCH_TEAM_INFO_NFY,				// °á¼± ÆÀ Á¤º¸
	GU_MATCH_FINALMATCH_PLAYER_STATE_NFY,			//
	GU_MATCH_FINALMATCH_UPDATE_SCORE_NFY,			// °á¼± Score Update
	GU_MATCH_FINALMATCH_STAGE_FINISH_NFY,			// °á¼± stage finish ¾Ë¸²
	GU_MATCH_FINALMATCH_MATCH_FINISH_NFY,			// °á¼± match finish ¾Ë¸²

	GU_MATCH_AWARDING_NFY,							// ½Ã»ó½Ä °á°ú

	GU_SKILL_CONFUSE_TARGET_NFY,					// Confuse »óÅÂÀÏ ¶§ÀÇ °ø°Ý ´ë»ó ¾Ë¸²
	GU_SKILL_TERROR_COURSE_CHANGE_NFY,				// Terror »óÅÂÀÏ ¶§ ¹æÇâ ÀüÈ¯ ¾Ë¸²

	GU_DICE_ROLL_RES,								// Action Skill ÁÖ»çÀ§ ±¼¸®±â
	GU_DICE_ROLLED_NFY,								// Action Skill ÁÖ»çÀ§ ±¼¸®±â

	GU_BUDOKAI_STATE_INFO_NFY,						// ÃµÇÏÁ¦ÀÏ¹«µµÈ¸ÀÇ ÇöÀç »óÅÂ¸¦ Àü¼Û
	GU_BUDOKAI_UPDATE_STATE_NFY,					// ÃµÇÏÁ¦ÀÏ¹«µµÈ¸ : main state update
	GU_BUDOKAI_UPDATE_MATCH_STATE_NFY,				// ÃµÇÏÁ¦ÀÏ¹«µµÈ¸ : match state update

	GU_BUDOKAI_JOIN_INDIVIDUAL_RES,					// °³ÀÎ µî·Ï
	GU_BUDOKAI_LEAVE_INDIVIDUAL_RES,				// °³ÀÎ Ãë¼Ò

	GU_BUDOKAI_JOIN_TEAM_INFO_RES,					// ÆÀ Æ÷ÀÎÆ®
	GU_BUDOKAI_JOIN_TEAM_RES,						// ÆÀ µî·Ï
	GU_BUDOKAI_JOIN_TEAM_NFY,						// ÆÀ µî·Ï ¾Ë¸²
	GU_BUDOKAI_LEAVE_TEAM_RES,						// ÆÀ µî·Ï Ãë¼Ò
	GU_BUDOKAI_LEAVE_TEAM_NFY,						// ÆÀ µî·Ï Ãë¼Ò ¾Ë¸²
	GU_BUDOKAI_LEAVE_TEAM_MEMBER_RES,				// ÆÀ ¸â¹ö Ãë¼Ò
	GU_BUDOKAI_LEAVE_TEAM_MEMBER_NFY,				// ÆÀ ¸â¹ö Ãë¼Ò ¾Ë¸²

	GU_BUDOKAI_JOIN_INFO_RES,						// Âü°¡ Á¤º¸
	GU_BUDOKAI_JOIN_STATE_RES,						// Âü°¡ »óÅÂ
	GU_BUDOKAI_JOIN_STATE_NFY,						// Âü°¡ »óÅÂ ¾Ë¸²
	GU_BUDOKAI_MUDOSA_INFO_RES,						// ¹«µµ»ç Á¤º¸
	GU_BUDOKAI_MUDOSA_TELEPORT_RES,					// ¹«µµ»ç ÅÚ·¹Æ÷Æ®
	GU_BUDOKAI_PROGRESS_MESSAGE_NFY,				// °æ±â ÁøÇà Á¤º¸ ¾Ë¸²(°øÁö)
	GU_BUDOKAI_SOCIAL_ACTION_NFY,
	GU_BUDOKAI_PRIZEWINNER_NAME_RES,				// ¿ì½ÂÀÚ / ÁØ¿ì½ÂÀÚ : °³ÀÎÀü
//	GU_BUDOKAI_PRIZEWINNER_TEAM_NAME_RES,			// ¿ì½ÂÀÚ / ÁØ¿ì½ÂÀÚ : ÆÀÀü

	GU_BUDOKAI_GM_BUDOKAI_SERVER_ENTER_RES,			// ÃµÇÏÁ¦ÀÏ¹«µµÈ¸ ¼­¹ö·Î ÅÚ·¹Æ÷Æ® ¿äÃ»
	GU_BUDOKAI_GM_BUDOKAI_SERVER_LEAVE_RES,			// ÃµÇÏÁ¦ÀÏ¹«µµÈ¸ ¼­¹ö¿¡¼­ ¿ø·¡ ¼­¹ö·Î ÀÌµ¿
	GU_BUDOKAI_GM_MATCH_PROGRESS_INFO_RES,			// ÇöÀç °æ±â ÁøÇà »óÈ² ¸®½ºÆ®
	GU_BUDOKAI_GM_MATCH_ARENA_ENTER_RES,			// °æ±âÀå µé¾î°¡±â
	GU_BUDOKAI_GM_MATCH_ARENA_LEAVE_RES,			// °æ±âÀå ³ª°¡±â

	GU_DISCONNECTED_NFY,

	GU_BOT_BOTCAUTION_HELPME_NFY,					// Help Me °æ°í [5/27/2008 SGpro]
	...
	GU_SHOP_EVENTITEM_BUY_RES,						// EVENT ITEM ±¸¸Å [7/11/2008 SGpro]
	GU_SHOP_EVENTITEM_END_RES,						// [7/15/2008 SGpro]

	GU_ITEM_REPLACE,								// ITEM ±³Ã¼ [7/11/2008 SGpro]

	GU_SHOP_GAMBLE_BUY_RES,						// EVENT ITEM ±¸¸Å [7/11/2008 SGpro]
	...
	GU_CHAR_MARKING_NFY, // ÄªÈ£ [9/10/2008 SGpro]

	GU_PARTY_CHARM_DICE_START_NFY,					// ÆÄÆ¼ ´ÙÀÌ½º UI ¶ç¿ì°í ½ÃÀÛÇÏ¶ó
	GU_PARTY_CHARM_DICE_ROLLED_NFY,					// ¼±ÅÃµÈ ´ÙÀÌ½º °á°ú ¹æ¼Û
	GU_PARTY_CHARM_DICE_ROLLED_RES,					// ¼±ÅÃµÈ ´ÙÀÌ½º °á°ú
	GU_PARTY_CHARM_DICE_END_NFY,					// ÆÄÆ¼ ´ÙÀÌ½º ¼±ÅÃ½Ã°£ ¿Ï·á ¹× ÃÑ°á°ú
	...
	GU_HOIPOIMIX_RECIPE_REG_NFY,					// ·¹½ÃÇÇµî·Ï
	GU_HOIPOIMIX_ITEM_CHECK_RES,					// ¸¸µé¾ÆÀÌÅÛ ¼±ÅÃ (ÇÊ¿äÇÑ ¾ÆÀÌÅÛ ¼ö·® Ã¼Å©)
	GU_HOIPOIMIX_ITEM_MAKE_RES,						// ¾ÆÀÌÅÛ ¸¸µé±â
	GU_HOIPOIMIX_ITEM_MAKE_EP_RES,					// ¾ÆÀÌÅÛ ¸¸µé±â Áß EP ³Ö±â
	...
	GU_HOIPOIMIX_ITEM_MAKE_EXP_NFY,					// È£ÀÌÆ÷ÀÌ ¹Í½º ·¹º§¾÷ÀÌ³ª °æÇèÄ¡ ¾÷µ¥ÀÌÆ®

	GU_CHAR_TARGET_LOST_NFY,
	GU_CHAR_GUARD_CRASHED_NFY,		// Guard°¡ Skill ability¿¡ ÀÇÇØ °­Á¦·Î ÇØÁ¦µÊ
	...
	GU_VEHICLE_START_NFY,			// Å» °Í ½ÃÀÛ À§Ä¡ ¾Ë¸²
	GU_VEHICLE_ENGINE_START_RES,			// Å» °Í ½Ãµ¿ ÄÔ RES
	GU_VEHICLE_ENGINE_START_NFY,			// Å» °Í ½Ãµ¿ ÄÔ ºê·Îµå Ä³½ºÆ®
	GU_VEHICLE_ENGINE_STOP_RES,
	GU_VEHICLE_ENGINE_STOP_NFY,
	GU_VEHICLE_FUEL_UPDATE_NFY,				// Å» °Í ¿¬·á »ç¿ë ¾÷µ¥ÀÌÆ®
	GU_VEHICLE_END_RES,						// Å» °Í »ç¿ë Á¾·á ¾Ë¸²
	GU_VEHICLE_END_NFY,
	GU_VEHICLE_STUNT_NFY,					// ½ºÆäÀÌ½º¹Ù ´©¸§(Å»°Í)

	/* ÀÌ¹ø ¸¶ÀÏ½ºÅæ¿¡´Â 1ÀÎ½Â ÀÛ¾÷¸¸ ÇÏ±â ¶§¹®¿¡ ÀÏ´Ü ÁÖ¼®Ã³¸® 2009.1.5 ½Â¿ø.
	GU_VEHICLE_PASSENGER_GETON_RES,			// Å» °Í ½Â°´ Å¾½Â RES
	GU_VEHICLE_PASSENGER_GETON_NFY,			// Å» °Í ½Â°´ Å¾½Â ºê·Îµå Ä³½ºÆ®
	GU_VEHICLE_ASK_REQ,						// Å» °Í ¿îÀüÀÚ¿¡°Ô Å¸µµ µÇ´ÂÁö ¹¯´Â´Ù
	GU_VEHICLE_PASSENGER_GETOFF_RES,		// Å» °Í ½Â°´ ³»¸² RES
	GU_VEHICLE_PASSENGER_GETOFF_NFY			// Å» °Í ½Â°´ ³»¸² ºê·Îµå Ä³½ºÆ®
	*/
	...
	GU_DOGI_CREATE_RES,								// µµº¹»ý¼º
	GU_DOGI_CHANGE_RES,								// µµº¹º¯°æ
	GU_DOGI_UPDATE_NFY,								// µµº¹º¯°æ¾Ë¸²
	...
	GU_DOJO_SCRAMBLE_RES,							// µµÀåÀïÅ»Àü ½ÅÃ»¿¡ ´ëÇÑ ÀÀ´ä
	GU_DOJO_SCRAMBLE_RESPONSE_RES,					// µµÀåÀïÅ»Àü ½ÅÃ»ÀÀ´ä Ã³¸®¿¡ ´ëÇÑ ÀÀ´ä
	...
	GU_BUDOKAI_PRIZEWINNER_TEAM_NAME_RES,			// ¿ì½ÂÀÚ / ÁØ¿ì½ÂÀÚ : ÆÀÀü
	GU_GMT_INFO_NFY,								// GMT ½Ã°£À» ¾Ë¸²
	GU_GMT_UPDATE_RES,							// GMT Àç¼³Á¤ ÀÀ´ä
	GU_GMT_CHANGED_NFY,								// GMT Àç¼³Á¤ °ªÀ» Àû¿ë ¾Ë¸²

	GU_UPDATE_CHAR_MAX_LP,
	GU_UPDATE_CHAR_MAX_EP,
	GU_UPDATE_CHAR_MAX_RP,
	GU_DESTROY_ALL_OBJECTS_NFY,
...
BEGIN_PROTOCOL(GU_CHAR_DIALOG)
	...
	WCHAR				awchText[NTL_MAX_LENGTH_OF_CHAT_MESSAGE_UNICODE + 1]; // ´ëÈ­³»¿ë
END_PROTOCOL()
//------------------------------------------------------------------
...
BEGIN_PROTOCOL(GU_CHAR_TELEPORT_RES)
	...
	// ÇöÀç ¿ùµå ¾È¿¡¼­ÀÇ ÀÌµ¿ÀÏ °æ¿ì¿¡´Â sWorldInfo µ¥ÀÌÅ¸¸¦ º¸³»Áö ¾Ê´Â´Ù.
...
BEGIN_PROTOCOL(GU_ITEM_PICK_RES)
	...
	// bByPartyHuntingÀÌ trueÀÌ¸é Å¬¶óÀÌ¾ðÆ®¿¡¼­ ¸Þ¼¼Áö¸¦ Ãâ·ÂÇÒ ÇÊ¿ä°¡ ¾ø´Ù.
	// (ÆÄÆ¼ »óÅÂ¿¡¼­ dropµÈ ¾ÆÀÌÅÛÀ» ¾ò´Â °æ¿ì¿¡´Â ´Ù¸¥ packet¿¡ ÀÇÇØ ¸Þ¼¼Áö°¡ Ãâ·ÂµÈ´Ù.)
...
BEGIN_PROTOCOL(GU_SYSTEM_DISPLAY_TEXT)
	...
	WCHAR			awchMessage[NTL_MAX_LENGTH_OF_CHAT_MESSAGE_UNICODE + 1]; // ³»¿ë
END_PROTOCOL()
//------------------------------------------------------------------
...
BEGIN_PROTOCOL(GU_TELEPORT_PROPOSAL_NFY)
	...
	WCHAR				wszSummonnerName[NTL_MAX_SIZE_CHAR_NAME_UNICODE + 1];	// °¡º¯
END_PROTOCOL()
//------------------------------------------------------------------
...
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(GU_HOIPOIMIX_ITEM_MACHINE_MAKE_RES)			// ¸Ó½Å ÇÊµå µî·Ï
	WORD				wResultCode;    
	BYTE				byPlace;
	BYTE				byPos;
END_PROTOCOL()
