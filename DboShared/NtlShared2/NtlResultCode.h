...
enum eRESULTCODE
{
	...
	AUTH_INVALID_CJI_KOR_COOKIE,						// 입력받은 쿠키 데이타의 형식이 잘못되었습니다.
	AUTH_IP_BLOCK,					// 블록된 IP 입니다. (로비에 나오는 메시지. 확인 버튼)

	AUTH_USER_KICKOUT_WAIT_PLZ,		// 이미 접속된 유져를 접속완료 하고 있습니다. 잠시 후 다시 시도 해주세요. 
	AUTH_USER_NOT_FOUNDER, // If user isn't founder and FoundersOnly is active on server. 
...
//	Character_NOT_AUTHENTICATED,
	...
	COMMUNITY_GUILD_INVITE_FAIL_FOR_BEING_SCRAMBLE,				// 길드가 도장전 상태에선 길드가입을 할 수 없습니다.
	//-----------------------------------------------------------------
	// Query ( 400 ~ 500 )
	//-----------------------------------------------------------------
	...
	// warning! current enum number is 898. -> 아이템 관련은 3000번대에서 새로 추가.
	// 여기에 추가하지 마세요~ 900이랑 겹쳐요~
	...
	GAME_SCOUTER_TARGET_FAIL_FOR_NPC,	 // NPC의 장비는 조사할 수 없습니다
...
//	Game_ONLY_CAPSULE_CAN_BE_PUT_THERE
	...
	GAME_GUILD_DOJO_DOGI_CHANGE_FUNCTION_NEED,				// 도장 도복 변경 설정 기능이 필요합니다 기능을 먼저 획득하십시요. 
	GAME_GUILD_DOGI_CHANGE_FUNCTION_NEED,					// 길드 도복 변경 설정 기능이 필요합니다 기능을 먼저 획득하십시요. 
	GAME_GUILD_DOJO_ALREADY_HAVE,							// 이미 도장을 소유하고 있어 불가능합니다. 또는 도장 소유는 한개뿐입니다
	//-----------------------------------------------------------------
	...
	GAME_SCOUTER_PC_INFO_JAMMING,							// 상대방의 아이템을 엿볼 수 없습니다.
	//-----------------------------------------------------------------
	// CASH 아이템 구매 관련. ( 3100 ~ )
	//-----------------------------------------------------------------
	CASHITEM_FAIL = 3100,			// 블랙 호이포이 스톤을 사용할 수 없습니다.
