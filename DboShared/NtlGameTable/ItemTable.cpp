...
bool CItemTable::SetTableData(void* pvTable, WCHAR * pwszSheetName, std::wstring * pstrDataName, BSTR bstrData)
{
	...
	if (0 == wcscmp(pwszSheetName, L"Table_Data_KOR"))
	{
		...
		{
			pItem->wEquip_Slot_Type_Bit_Flag = READ_BITFLAG(bstrData);
		}
		...
		{
			pItem->wWeight = READ_WORD(bstrData, pstrDataName->c_str(), 0);
		}
		...
		{
			pItem->byNeed_Max_Level = READ_BYTE(bstrData, pstrDataName->c_str(), 70);
		}
		...
		{
			pItem->bCanHaveOption = READ_BYTE(bstrData, pstrDataName->c_str());
		}
		...
		{
			pItem->bCanRenew = READ_BYTE(bstrData, pstrDataName->c_str());
		}
		...
		{
			pItem->dropLevel = READ_WORD(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Create_Enchant_Rate_Tblidx"))
		{
			pItem->CreateEnchanteRateTblidx = READ_DWORD(bstrData);
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Excellent_Tblidx"))
		{
			pItem->ExcellentTblidx = READ_DWORD(bstrData);
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Rare_Tblidx"))
		{
			pItem->RareTblidx = READ_DWORD(bstrData);
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Legendary_Tblidx"))
		{
			pItem->LegendaryTblidx = READ_DWORD(bstrData);
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Create_Superior_Able"))
		{
			pItem->CreateSuperiorAble = READ_BOOL(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Create_Excellent_Able"))
		{
			pItem->CreateExcellentAble = READ_BOOL(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Create_Rare_Able"))
		{
			pItem->CreateRareAble = READ_BOOL(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Create_Legendary_Able"))
		{
			pItem->CreateLegendaryAble = READ_BOOL(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"fAtk_Phy"))
		{
			pItem->fAtkPhy = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"fAtk_Eng"))
		{
			pItem->fAtkEng = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"fDef_Phy"))
		{
			pItem->fDefPhy = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"fDef_Eng"))
		{
			pItem->fDefEng = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Scouter_Parts_Type_2"))
		{
			pItem->ScouterPartsType2 = READ_BYTE(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Scouter_Parts_Type_3"))
		{
			pItem->ScouterPartsType3 = READ_BYTE(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Scouter_Parts_Type_4"))
		{
			pItem->ScouterPartsType4 = READ_BYTE(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"TMP_Category_Type"))
		{
			pItem->TMPCategoryType = READ_BYTE(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Disassamble_Bit_Flag"))
		{
			pItem->DisassembleBitFlag = (WORD)READ_BITFLAG(bstrData);
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Normal_Min"))
		{
			pItem->NormalMin = READ_BYTE(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Normal_Max"))
		{
			pItem->NormalMax = READ_BYTE(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Rank_Up_Min"))
		{
			pItem->RankupMin = READ_BYTE(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Rank_Up_Max"))
		{
			pItem->RankupMax = READ_BYTE(bstrData, pstrDataName->c_str());
		}
		else
		{
