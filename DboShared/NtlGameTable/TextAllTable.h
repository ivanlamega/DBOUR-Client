...
protected:
	...
	virtual bool				InitializeFromXmlDoc(CNtlXMLDoc* pXmlDoc, WCHAR* pwszFileName, bool bReload);
...
public:
	...
	//CTextTable* GetTitleCondTbl(VOID) { return m_pTextTable[DBO_TITLE_CONDITION]; }
	//CTextTable* GetTitleTbl(VOID) { return m_pTextTable[DBO_TITLE]; }
	//CTextTable* GetLocationTbl(VOID) { return m_pTextTable[DBO_LOCATION]; }
...
public:
	...
	virtual bool				LoadFromBinary(CNtlSerializer& serializer);
