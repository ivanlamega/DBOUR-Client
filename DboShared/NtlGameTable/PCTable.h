...
public:
	...
	char			szModel_Child[DBO_MAX_LENGTH_MODEL_NAME + 1];
	char			szModel_Adult[DBO_MAX_LENGTH_MODEL_NAME + 1];
	...
	float			fChild_Fly_Dash_Speed_Origin;
	float			fChild_Fly_Dash_Speed;
	float			fAdult_Fly_Dash_Speed_Origin;
	float			fAdult_Fly_Dash_Speed;

	float			fChild_Fly_Accel_Speed_Origin;
	float			fChild_Fly_Accel_Speed;
	float			fAdult_Fly_Accel_Speed_Origin;
	float			fAdult_Fly_Accel_Speed;
	//End Newer KR
