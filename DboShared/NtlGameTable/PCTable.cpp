...
bool CPCTable::AddTable(void * pvTable, bool bReload)
{
...
bool CPCTable::SetTableData(void* pvTable, WCHAR* pwszSheetName, std::wstring* pstrDataName, BSTR bstrData)
{
	...
	if (0 == wcscmp(pwszSheetName, L"Table_Data_KOR"))
	{
		...
		else if (0 == wcscmp(pstrDataName->c_str(), L"Weight_Limit"))
		{
			CheckNegativeInvalid(pstrDataName->c_str(), bstrData);
			//pPC->dwWeight_Limit = READ_DWORD( bstrData );
		}
		...
		else if (0 == wcscmp(pstrDataName->c_str(), L"Child_Fly_Speed_Origin"))
		{
			pPC->fChild_Fly_Speed_Origin = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Child_Fly_Speed"))
		{
			pPC->fChild_Fly_Speed = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Adult_Fly_Speed_Origin"))
		{
			pPC->fAdult_Fly_Speed_Origin = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Adult_Fly_Speed"))
		{
			pPC->fAdult_Fly_Speed = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Child_Fly_Dash_Speed_Origin"))
		{
			pPC->fChild_Fly_Dash_Speed_Origin = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Child_Fly_Dash_Speed"))
		{
			pPC->fChild_Fly_Dash_Speed = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Adult_Fly_Dash_Speed_Origin"))
		{
			pPC->fAdult_Fly_Dash_Speed_Origin = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Adult_Fly_Dash_Speed"))
		{
			pPC->fAdult_Fly_Dash_Speed = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Child_Fly_Accel_Speed_Origin"))
		{
			pPC->fChild_Fly_Accel_Speed_Origin = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Child_Fly_Accel_Speed"))
		{
			pPC->fChild_Fly_Accel_Speed = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Adult_Fly_Accel_Speed_Origin"))
		{
			pPC->fAdult_Fly_Accel_Speed_Origin = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
		else if (0 == wcscmp(pstrDataName->c_str(), L"Adult_Fly_Accel_Speed"))
		{
			pPC->fAdult_Fly_Accel_Speed = READ_FLOAT(bstrData, pstrDataName->c_str());
		}
...
bool CPCTable::LoadFromBinary(CNtlSerializer& serializer, bool bReload)
{
	if( false == bReload )
	{
		Reset();
